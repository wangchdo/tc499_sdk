...
MEMORY
{
    dsram5_local (w!xp): org = 0xd0000000, len = 112k
    dsram5 (w!xp): org = 0x20000000, len = 112k
    psram5 (w!xp): org = 0x20100000, len = 64K
    
    dsram4_local (w!xp): org = 0xd0000000, len = 112k
    dsram4 (w!xp): org = 0x30000000, len = 112k
    psram4 (w!xp): org = 0x30100000, len = 64K
    
    dsram3_local (w!xp): org = 0xd0000000, len = 112k
    dsram3 (w!xp): org = 0x40000000, len = 112k
    ...
    pfls2 (rx!p): org = 0x80800000, len = 4M
    pfls2_nc (rx!p): org = 0xa0800000, len = 4M
    
    pfls3 (rx!p): org = 0x80C00000, len = 4M
    pfls3_nc (rx!p): org = 0xa0C00000, len = 4M
    
    pfls4 (rx!p): org = 0x81000000, len = 4M
    pfls4_nc (rx!p): org = 0xa1000000, len = 4M
    
    pfls5 (rx!p): org = 0x81400000, len = 4M
    pfls5_nc (rx!p): org = 0xa1400000, len = 4M
    ...
    cpu2_dlmu (w!xp): org = 0x90100000, len = 384K
    cpu2_dlmu_nc (w!xp): org = 0xb0100000, len = 384K
    
    cpu3_dlmu (w!xp): org = 0x90160000, len = 256K
    cpu3_dlmu_nc (w!xp): org = 0xb0160000, len = 256K
    
    cpu4_dlmu (w!xp): org = 0x901A0000, len = 256K
    cpu4_dlmu_nc (w!xp): org = 0xb01a0000, len = 256K
    
    cpu5_dlmu (w!xp): org = 0x901E0000, len = 256K
    cpu5_dlmu_nc (w!xp): org = 0xb01e0000, len = 256K
    
    lmuram (w!xp): org = 0x90300000, len = 4M
    lmuram_nc (w!xp): org = 0xb0300000, len = 4M    
}
