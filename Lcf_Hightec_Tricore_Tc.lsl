/**********************************************************************************************************************
 * \file Lcf_Hightec_Tricore_Tc.lsl
...
MEMORY
{
    ...
    pfls5 (rx): org = 0x81400000, len = 4M
    pfls5_nc (rx): org = 0xa1400000, len = 4M
    ...
    lmuram (w!x): org = 0x90300000, len = 4M
    lmuram_nc (w!x): org = 0xb0300000, len = 4M      
}
...
SECTIONS
{
    ...
    _SMALL_DATA2_ = SIZEOF(.sdata2) ? ADDR(.sdata2) : (ADDR(.sdata2) & 0xF0000000) + 32k ;
...
SECTIONS
{
    ...
    _SMALL_DATA4_ = SIZEOF(.sdata4) ? ADDR(.sdata4) : (ADDR(.sdata4) & 0xF0000000) + 32k ;
    ...
    _SMALL_DATA3_ = SIZEOF(.sdata3) ? ADDR(.sdata3) : (ADDR(.sdata3) & 0xF0000000) + 32k ;
