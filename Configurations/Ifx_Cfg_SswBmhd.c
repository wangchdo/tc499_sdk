...
const Ifx_Ssw_Bmhd bmhd_0_orig = {
    ...
    .crc    = 0x442D2C9DU,           /* 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)               */
    .crcInv = 0xBBD2D362U,           /* 0x00C: .crcInv: Inverted Check Result for the BMI Header (offset 000H - 007H)   */
    .pw     = {
