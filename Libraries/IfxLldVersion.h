...
#define IFX_LLD_VERSION_GENERATION           2   /**< \brief Indicates the driver generation */
...
#define IFX_LLD_VERSION_REVISION            19   /**< \brief Informs about patches and/or documentation changes */
