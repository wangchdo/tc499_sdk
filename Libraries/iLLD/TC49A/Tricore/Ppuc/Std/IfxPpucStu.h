 ...
 * \return None
 */
IFX_INLINE void IfxPpucStu_setDescriptorBaseAddress(Ifx_PPUC *ppuc, uint32 address);

/** \brief Returns the next free channel that can be configured
 * \param ppuc PPUC module pointer
 * \return Returns the free channel number
 */
IFX_INLINE uint8 IfxPpucStu_getNextFreeChannel(Ifx_PPUC *ppuc);
 ...
 * \return None
 */
IFX_INLINE void IfxPpucStu_startTransfer(Ifx_PPUC *ppuc, uint8 numOfTransfers);
 ...
 */
IFX_INLINE boolean IfxPpucStu_getChannelEvent(Ifx_PPUC *ppuc, uint8 channelNum);
 ...
 * \return None
 */
IFX_INLINE void IfxPpucStu_clearChannelEvent(Ifx_PPUC *ppuc, uint8 channelNum);

/** \brief Clears the status of all the events
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucStu_clearAllEvents(Ifx_PPUC *ppuc);

/** \brief Returns the max number of entries configured per FIFO
 * \param ppuc PPUC Module pointer
 * \return Returns the max number of channels
 */
IFX_INLINE uint8 IfxPpucStu_getMaxChannels(Ifx_PPUC *ppuc);
 ...
 * \return None
 */
IFX_INLINE void IfxPpucStu_setMaxChannels(Ifx_PPUC *ppuc, uint8 maxChannels);
 ...
 */
IFX_INLINE boolean IfxPpucStu_isChannelInterruptDone(Ifx_PPUC *ppuc, uint8 channelNum);
 ...
 */
IFX_INLINE boolean IfxPpucStu_isChannelErrorInterrupt(Ifx_PPUC *ppuc, uint8 channelNum);
 ...
 * \return None
 */
IFX_EXTERN void IfxPpucStu_initChannel(Ifx_PPUC *ppuc, uint8 channelNum, uint32 stuDescriptor, IfxPpucStu_channelConfig *channelConfig);
...
IFX_INLINE void IfxPpucStu_setDescriptorBaseAddress(Ifx_PPUC *ppuc, uint32 address)
{
    PPUC_STU_BASE_L.U = address;
}


IFX_INLINE uint8 IfxPpucStu_getNextFreeChannel(Ifx_PPUC *ppuc)
{
    return (uint8)PPUC_STU_NEXT_FREE.U;
}


IFX_INLINE void IfxPpucStu_startTransfer(Ifx_PPUC *ppuc, uint8 numOfTransfers)
{
    PPUC_STU_NEXT_FREE_INC.U = numOfTransfers;
}
...
{
    /* Select the entry */
    PPUC_STU_ENTRY_SELECT.U = channelNum;
    /* Read the status register */
    return (boolean)((PPUC_STU_ENTRY_STAT.U & (1U << 2U)) >> 2U);
}
...
IFX_INLINE void IfxPpucStu_clearAllEvents(Ifx_PPUC *ppuc)
{
    PPUC_STU_EVENT.U = 0x80000000U;
}


IFX_INLINE uint8 IfxPpucStu_getMaxChannels(Ifx_PPUC *ppuc)
{
    return (uint8)(PPUC_STU_ENTRY_NUM.U);
}


IFX_INLINE void IfxPpucStu_setMaxChannels(Ifx_PPUC *ppuc, uint8 maxChannels)
{
    PPUC_STU_ENTRY_NUM.U = maxChannels;
}
...
IFX_INLINE boolean IfxPpucStu_isChannelInterruptDone(Ifx_PPUC *ppuc, uint8 channelNum)
{
    ...
    PPUC_STU_ENTRY_SELECT.U = channelNum;
    /* Read the status register */
    return (boolean)((PPUC_STU_ENTRY_STAT.U & (1U << 3U)) >> 3U);
}
...
IFX_INLINE boolean IfxPpucStu_isChannelErrorInterrupt(Ifx_PPUC *ppuc, uint8 channelNum)
{
    ...
    PPUC_STU_ENTRY_SELECT.U = channelNum;
    /* Read the status register */
    return (boolean)((PPUC_STU_ENTRY_STAT.U & (1U << 4U)) >> 4U);
}
