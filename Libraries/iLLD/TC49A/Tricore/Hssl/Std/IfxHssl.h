...
typedef enum
{
	IfxHssl_BaudrateStatus_valid                      = 0,  /**< \brief Indicates a valid Baudrate configuration is set in H/w */
	IfxHssl_BaudrateStatus_errorTxhd                  = 1,  /**< \brief Invalid Tx divider used in high speed mode. Refer INIT.B.TXHD */
	IfxHssl_BaudrateStatus_errorRxhd                  = 2,  /**< \brief Invalid Rx divider used in high speed mode. Refer INIT.B.RXHD */
	IfxHssl_BaudrateStatus_errorMtxspeed              = 3,  /**< \brief Invalid Master Tx speed mode  */
	IfxHssl_BaudrateStatus_errorMrxspeed              = 4,  /**< \brief Invalid Master Rx speed mode  */
	IfxHssl_BaudrateStatus_errorSscf                  = 5,  /**< \brief Invalid Master SysClk Frequency Divider value for output pad. Refer INIT.B.SSCF  */
	IfxHssl_BaudrateStatus_unSupportedRxMediumSpeed   = 6,  /**< \brief Unsupported Master Rx medium speed mode  */
	IfxHssl_BaudrateStatus_unSupportedSourceFrequency = 7,  /**< \brief Unsupported fSource/RefClock for HSSL  */
	IfxHssl_BaudrateStatus_unSupportedPll             = 8,  /**< \brief Used in High Speed mode. fHSCT/fPLL must be 800M, please check values of fSource, PDIV and NDIV. PDIV and NDIV are to be taken from CLOCK_PERPLLCON0 */
	IfxHssl_BaudrateStatus_unSupportedFSysClkOut      = 9,  /**< \brief Unsupported Master SysClk Output Frequency at output pad. Refer INIT.B.SSCF  */
...
/** \brief Initialise the AP Config
 * \param config pointer to AP Configuration structure
 * \return None
 */
IFX_EXTERN void IfxHssl_initHsslApConfig(IfxHssl_hsslApConfig *config);

/** \brief Initialise the AP
 * \param config pointer to AP Configuration structure
 * \return None
 */
