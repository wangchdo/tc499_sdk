...
typedef enum
{
    ...
    IfxCan_CreInterrupt_TxBuffer,                         /**< \brief CRE TX Buffer Interrupt */
...
typedef enum
{
    ...
    IfxCan_Interrupt_creTxBuffer,                         /**< \brief (Not for Absolute Indexing, kept to configure G2INTR) CRE TX Buffer Interrupt */
...
typedef enum
{
    ...
    IfxCan_InterruptGroup_txHBuf,   /**< \brief Interrupts of CRE Tx host buffer */
...
typedef struct
{
    ...
    boolean                     txBufferInterruptEnable;                              /**< \brief Interrupt Enable for Interrupts related to Tx Buffer */
    ...
    IfxCan_GroupInterruptConfig txHBuf;                                               /**< \brief Configuration for Tx Host Buffer interrupts */
...
typedef struct
{
    ...
    boolean                   txBufLastWriteMode;                     /**< \brief Last Write Mode for Tx Buffer */
    ...
    uint8                     txBufFixedDataLength;                   /**< \brief Fixed Data Length of messages written to Tx Buffer. Last Write mode must be set. */
...
typedef struct
{
    ...
    boolean                           timeStampEnabled;           /**< \brief Time Stamp is enabled */
} IfxCan_Filter;
