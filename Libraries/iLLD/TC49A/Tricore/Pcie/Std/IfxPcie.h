 ...
 */
#define IFXPCIE_GET_PHY_INDEX(pcieIndex)                      (IfxHsphy_PhyIndex_0)
...
typedef enum
{
    ...
    IfxPcie_ErrorEvent_rcError,    /**< \brief RC Error (Master) */
    IfxPcie_ErrorEvent_safCorr,    /**< \brief Correctable Error */
    IfxPcie_ErrorEvent_safUncorr,  /**< \brief Uncorrectable Error */
    IfxPcie_ErrorEvent_sysError,   /**< \brief System Error */
    ...
    IfxPcie_ErrorEvent_a2sData,    /**< \brief a2s bridge Data error */
    IfxPcie_ErrorEvent_a2sAddr,    /**< \brief a2s bridge address error */
    IfxPcie_ErrorEvent_s2aData,    /**< \brief s2a bridge Data error */
    IfxPcie_ErrorEvent_s2aAddr,    /**< \brief s2a bridge address error */
    IfxPcie_ErrorEvent_msterrm,    /**< \brief RASDP Error Mode at master AXI IF */
    IfxPcie_ErrorEvent_slverrm,    /**< \brief RASDP Error Mode at slave AXI IF */
...
typedef enum
{
    ...
    IfxPcie_TlpOrdering_idBased,      /**< \brief ID Based Ordering */
    IfxPcie_TlpOrdering_relaxedAndId  /**< \brief Relaxedn and ID Based Ordering */
} IfxPcie_TlpOrdering;
...
IFX_INLINE void IfxPcie_setDeviceMode(IfxPcie *pcieSFR, IfxPcie_DeviceMode mode)
{
    pcieSFR->DSP.LNK.DVCTYP.B.TYPE = (uint32)mode;
}


IFX_INLINE IfxPcie_DeviceMode IfxPcie_getDeviceMode(IfxPcie *pcieSFR)
{
    return (IfxPcie_DeviceMode)(pcieSFR->DSP.LNK.DVCTYP.B.TYPE);
}
