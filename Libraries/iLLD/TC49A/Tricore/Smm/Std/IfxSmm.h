...
typedef struct
{
    ...
    IfxApProt_ProtConfig protseConfig;        /**< \brief PROT SE related configuration */
    IfxApProt_ProtConfig protcseConfig;       /**< \brief PROT CSE related configuration */
    IfxApApu_ApuConfig   apuConfig;           /**< \brief APU Configurations */
    IfxApApu_ApuConfig   apucsConfig;         /**< \brief APU CS Configurations */
} IfxSmm_ApConfig;
...
/** \brief Initializes the PROTs with default value
 * \param config PROT and APU Config
 * \return None
 */
IFX_EXTERN void IfxSmm_initApConfig(IfxSmm_ApConfig *config);

/** \brief Initialize the PROT and APU
 * \param smm SMM module pointer
 * \param config PROT and APU config pointer
 * \return None
 */
IFX_EXTERN void IfxSmm_initAp(Ifx_SMM *smm, IfxSmm_ApConfig *config);
