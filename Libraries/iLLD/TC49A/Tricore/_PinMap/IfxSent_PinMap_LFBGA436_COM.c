/**
 * \file IfxSent_PinMap_LFBGA436_COM.c
 * \brief SENT  details
 *
...
#include "IfxSent_PinMap_LFBGA436_COM.h"
...
IfxSent_Sent_In IfxSent_SENT0A_P41_0_IN = {&MODULE_SENT1, (IfxSent_ChannelId)0, {&MODULE_P41, 0}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT0C_P10_9_IN = {&MODULE_SENT1, (IfxSent_ChannelId)0, {&MODULE_P10, 9}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT13C_P01_11_IN = {&MODULE_SENT0, (IfxSent_ChannelId)13, {&MODULE_P01, 11}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT14C_P02_12_IN = {&MODULE_SENT0, (IfxSent_ChannelId)14, {&MODULE_P02, 12}, Ifx_RxSel_c};

IfxSent_Sent_In IfxSent_SENT1A_P40_1_IN = {&MODULE_SENT0, (IfxSent_ChannelId)1, {&MODULE_P40, 1}, Ifx_RxSel_a};

IfxSent_Sent_In IfxSent_SENT1A_P41_1_IN = {&MODULE_SENT1, (IfxSent_ChannelId)1, {&MODULE_P41, 1}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT1C_P10_10_IN = {&MODULE_SENT1, (IfxSent_ChannelId)1, {&MODULE_P10, 10}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT2A_P41_2_IN = {&MODULE_SENT1, (IfxSent_ChannelId)2, {&MODULE_P41, 2}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT2C_P10_14_IN = {&MODULE_SENT1, (IfxSent_ChannelId)2, {&MODULE_P10, 14}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT3A_P41_3_IN = {&MODULE_SENT1, (IfxSent_ChannelId)3, {&MODULE_P41, 3}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT3C_P10_13_IN = {&MODULE_SENT1, (IfxSent_ChannelId)3, {&MODULE_P10, 13}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT4A_P41_4_IN = {&MODULE_SENT1, (IfxSent_ChannelId)4, {&MODULE_P41, 4}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT4C_P02_13_IN = {&MODULE_SENT0, (IfxSent_ChannelId)4, {&MODULE_P02, 13}, Ifx_RxSel_c};

IfxSent_Sent_In IfxSent_SENT4C_P10_11_IN = {&MODULE_SENT1, (IfxSent_ChannelId)4, {&MODULE_P10, 11}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT5A_P41_5_IN = {&MODULE_SENT1, (IfxSent_ChannelId)5, {&MODULE_P41, 5}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT6A_P41_6_IN = {&MODULE_SENT1, (IfxSent_ChannelId)6, {&MODULE_P41, 6}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT6C_P01_1_IN = {&MODULE_SENT0, (IfxSent_ChannelId)6, {&MODULE_P01, 1}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT7A_P41_7_IN = {&MODULE_SENT1, (IfxSent_ChannelId)7, {&MODULE_P41, 7}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT7C_P01_9_IN = {&MODULE_SENT0, (IfxSent_ChannelId)7, {&MODULE_P01, 9}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT8A_P41_8_IN = {&MODULE_SENT1, (IfxSent_ChannelId)8, {&MODULE_P41, 8}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT8C_P01_8_IN = {&MODULE_SENT0, (IfxSent_ChannelId)8, {&MODULE_P01, 8}, Ifx_RxSel_c};
...
IfxSent_Sent_In IfxSent_SENT9C_P01_10_IN = {&MODULE_SENT0, (IfxSent_ChannelId)9, {&MODULE_P01, 10}, Ifx_RxSel_c};
...
IFX_CONST IfxSent_Sent_In *IfxSent_Sent_In_pinTable[IFXSENT_PINMAP_NUM_MODULES][IFXSENT_PINMAP_NUM_CHANNELS][IFXSENT_PINMAP_SENT_IN_NUM_ITEMS] = {
    {
        ...
        },
        {
            ...
            &IfxSent_SENT13C_P01_11_IN,
            NULL_PTR,
        },
        {
            &IfxSent_SENT14A_P40_14_IN,
            &IfxSent_SENT14B_P02_2_IN,
            &IfxSent_SENT14C_P02_12_IN,
            NULL_PTR,
        },
    },
    {
        {
            &IfxSent_SENT0A_P41_0_IN,
            &IfxSent_SENT0B_P33_4_IN,
            &IfxSent_SENT0C_P10_9_IN,
            NULL_PTR,
        },
        {
            &IfxSent_SENT1A_P41_1_IN,
            &IfxSent_SENT1B_P33_3_IN,
            &IfxSent_SENT1C_P10_10_IN,
            NULL_PTR,
        },
        {
            &IfxSent_SENT2A_P41_2_IN,
            &IfxSent_SENT2B_P33_2_IN,
            &IfxSent_SENT2C_P10_14_IN,
            &IfxSent_SENT2D_P14_0_IN,
        },
        {
            &IfxSent_SENT3A_P41_3_IN,
            &IfxSent_SENT3B_P33_1_IN,
            &IfxSent_SENT3C_P10_13_IN,
            &IfxSent_SENT3D_P14_1_IN,
        },
        {
            &IfxSent_SENT4A_P41_4_IN,
            &IfxSent_SENT4B_P33_0_IN,
            &IfxSent_SENT4C_P10_11_IN,
            NULL_PTR,
        },
        {
            &IfxSent_SENT5A_P41_5_IN,
            &IfxSent_SENT5B_P02_9_IN,
            NULL_PTR,
            NULL_PTR,
        },
        {
            &IfxSent_SENT6A_P41_6_IN,
            &IfxSent_SENT6B_P02_10_IN,
            NULL_PTR,
            NULL_PTR,
        },
        {
            &IfxSent_SENT7A_P41_7_IN,
            &IfxSent_SENT7B_P02_11_IN,
            NULL_PTR,
            NULL_PTR,
        },
        {
            &IfxSent_SENT8A_P41_8_IN,
