/**
 * \file IfxMsc_PinMap_LFBGA436_EMS.h
 * \brief MSC  details
 * \ingroup IfxLld_Msc
 *
 ...
 * \ingroup IfxLld_Msc
 * \defgroup IfxLld_Msc__Pinmap Variables Default
 * \ingroup IfxLld_Msc_
 * \defgroup IfxLld_Msc__PinTables Default
 * \ingroup IfxLld_Msc_
 */

#ifndef IFXMSC_PINMAP_LFBGA436_EMS_H
#define IFXMSC_PINMAP_LFBGA436_EMS_H 1
...
/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc0_EN0_P11_11_OUT;
...
/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc0_EN1_P11_2_OUT;
 ...
 */
IFX_EXTERN IfxMsc_Fclp_Out IfxMsc0_FCLP_P11_6_OUT;
 ...
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc0_SDI0_P11_10_IN;
...
/** \brief Upstream assynchronous input signal
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc0_SDI3_P11_3_IN;
 ...
 */
IFX_EXTERN IfxMsc_Sop_Out  IfxMsc0_SOP_P11_9_OUT;
...
/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc1_EN0_P23_4_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc1_EN0_P32_4_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc1_EN1_P23_5_OUT;

/** \brief Shift-clock inverted part of the differential signal
 */
IFX_EXTERN IfxMsc_Fcln_Out IfxMsc1_FCLN_P22_0_OUT;

/** \brief Shift-clock direct part of the differential signal
 */
IFX_EXTERN IfxMsc_Fclp_Out IfxMsc1_FCLP_P22_1_OUT;

/** \brief Injection signal from port
 */
IFX_EXTERN IfxMsc_Inj_In   IfxMsc1_INJ0_P23_3_IN;

/** \brief Injection signal from port
 */
IFX_EXTERN IfxMsc_Inj_In   IfxMsc1_INJ1_P33_13_IN;

/** \brief Upstream assynchronous input signal
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc1_SDI0_P23_1_IN;

/** \brief Upstream assynchronous input signal
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc1_SDI1_P02_3_IN;

/** \brief Upstream assynchronous input signal
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc1_SDI2_P32_4_IN;

/** \brief Data output - inverted part of the differential signal
 */
IFX_EXTERN IfxMsc_Son_Out  IfxMsc1_SON_P22_2_OUT;

/** \brief Data output - direct part of the differential signal
 */
IFX_EXTERN IfxMsc_Sop_Out  IfxMsc1_SOP_P22_3_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc2_EN0_P13_4_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc2_EN0_P14_14_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc2_EN1_P14_13_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc2_EN2_P14_11_OUT;

/** \brief Shift-clock inverted part of the differential signal
 */
IFX_EXTERN IfxMsc_Fcln_Out IfxMsc2_FCLN_P13_4_OUT;

/** \brief Shift-clock direct part of the differential signal
 */
IFX_EXTERN IfxMsc_Fclp_Out IfxMsc2_FCLP_P13_5_OUT;

/** \brief Injection signal from port
 */
IFX_EXTERN IfxMsc_Inj_In   IfxMsc2_INJ0_P13_13_IN;

/** \brief Injection signal from port
 */
IFX_EXTERN IfxMsc_Inj_In   IfxMsc2_INJ1_P14_15_IN;

/** \brief Upstream assynchronous input signal
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc2_SDI0_P14_12_IN;

/** \brief Upstream assynchronous input signal
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc2_SDI1_P14_11_IN;

/** \brief Data output - inverted part of the differential signal
 */
IFX_EXTERN IfxMsc_Son_Out  IfxMsc2_SON_P13_6_OUT;

/** \brief Data output - direct part of the differential signal
 */
IFX_EXTERN IfxMsc_Sop_Out  IfxMsc2_SOP_P13_7_OUT;

/** \brief Data output - direct part of the differential signal
 */
IFX_EXTERN IfxMsc_Sop_Out  IfxMsc2_SOP_P14_11_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc3_EN0_P15_14_OUT;

/** \brief Chip Select
 */
IFX_EXTERN IfxMsc_En_Out   IfxMsc3_EN1_P15_15_OUT;

/** \brief Shift-clock inverted part of the differential signal
 */
IFX_EXTERN IfxMsc_Fcln_Out IfxMsc3_FCLN_P15_10_OUT;

/** \brief Shift-clock direct part of the differential signal
 */
IFX_EXTERN IfxMsc_Fclp_Out IfxMsc3_FCLP_P15_11_OUT;

/** \brief Injection signal from port
 */
IFX_EXTERN IfxMsc_Inj_In   IfxMsc3_INJ0_P13_11_IN;

/** \brief Injection signal from port
 */
IFX_EXTERN IfxMsc_Inj_In   IfxMsc3_INJ1_P14_15_IN;

/** \brief Upstream assynchronous input signal
 */
IFX_EXTERN IfxMsc_Sdi_In   IfxMsc3_SDI0_P13_10_IN;

/** \brief Data output - inverted part of the differential signal
 */
IFX_EXTERN IfxMsc_Son_Out  IfxMsc3_SON_P15_12_OUT;

/** \brief Data output - direct part of the differential signal
 */
IFX_EXTERN IfxMsc_Sop_Out  IfxMsc3_SOP_P15_13_OUT;
...
#endif /* IFXMSC_PINMAP_LFBGA436_EMS_H */
