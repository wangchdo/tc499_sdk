/**
 * \file IfxEray_PinMap_LFBGA436_EMS.c
 * \brief ERAY  details
 *
...
#include "IfxEray_PinMap_LFBGA436_EMS.h"
...
IfxEray_Rxd_In   IfxEray0_RXDA1_P11_9_IN = {&MODULE_ERAY0, (IfxEray_NodeId)0, {&MODULE_P11, 9}, Ifx_RxSel_b};
...
IfxEray_Rxd_In   IfxEray0_RXDB1_P11_10_IN = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P11, 10}, Ifx_RxSel_b};
...
IfxEray_Txd_Out  IfxEray0_TXDA_P11_3_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)0, {&MODULE_P11, 3}, IfxPort_OutputIdx_alt4};
...
IfxEray_Txd_Out  IfxEray0_TXDB_P11_12_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P11, 12}, IfxPort_OutputIdx_alt4};
...
IfxEray_Txen_Out IfxEray0_TXENA_P11_6_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)0, {&MODULE_P11, 6}, IfxPort_OutputIdx_alt4};
...
IfxEray_Txen_Out IfxEray0_TXENB_P11_11_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P11, 11}, IfxPort_OutputIdx_alt6};

IfxEray_Txen_Out IfxEray0_TXENB_P11_6_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P11, 6}, IfxPort_OutputIdx_alt2};
...
IfxEray_Rxd_In   IfxEray1_RXDA1_P01_1_IN = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P01, 1}, Ifx_RxSel_b};

IfxEray_Rxd_In   IfxEray1_RXDA2_P11_10_IN = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P11, 10}, Ifx_RxSel_c};

IfxEray_Rxd_In   IfxEray1_RXDB0_P14_7_IN = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P14, 7}, Ifx_RxSel_a};

IfxEray_Rxd_In   IfxEray1_RXDB1_P01_8_IN = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P01, 8}, Ifx_RxSel_b};

IfxEray_Txd_Out  IfxEray1_TXDA_P01_12_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P01, 12}, IfxPort_OutputIdx_alt6};

IfxEray_Txd_Out  IfxEray1_TXDA_P11_12_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P11, 12}, IfxPort_OutputIdx_alt7};

IfxEray_Txd_Out  IfxEray1_TXDA_P14_10_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P14, 10}, IfxPort_OutputIdx_alt7};

IfxEray_Txd_Out  IfxEray1_TXDB_P01_13_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P01, 13}, IfxPort_OutputIdx_alt6};

IfxEray_Txd_Out  IfxEray1_TXDB_P14_5_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P14, 5}, IfxPort_OutputIdx_alt7};

IfxEray_Txen_Out IfxEray1_TXENA_P01_14_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P01, 14}, IfxPort_OutputIdx_alt6};

IfxEray_Txen_Out IfxEray1_TXENA_P11_11_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P11, 11}, IfxPort_OutputIdx_alt7};

IfxEray_Txen_Out IfxEray1_TXENA_P14_9_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P14, 9}, IfxPort_OutputIdx_alt7};

IfxEray_Txen_Out IfxEray1_TXENB_P02_15_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P02, 15}, IfxPort_OutputIdx_alt6};
