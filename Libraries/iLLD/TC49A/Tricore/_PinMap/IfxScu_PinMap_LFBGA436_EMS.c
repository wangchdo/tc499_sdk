/**
 * \file IfxScu_PinMap_LFBGA436_EMS.c
 * \brief SCU  details
 *
...
#include "IfxScu_PinMap_LFBGA436_EMS.h"
...
IfxScu_Req_In IfxScu_REQ4G_P25_1_IN = {&MODULE_SCU, 4, {&MODULE_P25, 1}, Ifx_RxSel_g};

IfxScu_Req_In IfxScu_REQ5A_P15_8_IN = {&MODULE_SCU, 5, {&MODULE_P15, 8}, Ifx_RxSel_a};

IfxScu_Req_In IfxScu_REQ5E_P22_4_IN = {&MODULE_SCU, 5, {&MODULE_P22, 4}, Ifx_RxSel_e};
...
IfxScu_Req_In IfxScu_REQ6B_P11_10_IN = {&MODULE_SCU, 6, {&MODULE_P11, 10}, Ifx_RxSel_b};
...
IFX_CONST IfxScu_Req_In *IfxScu_Req_In_pinTable[IFXSCU_PINMAP_NUM_MODULES][IFXSCU_PINMAP_NUM_REQUESTS][IFXSCU_PINMAP_REQ_IN_NUM_ITEMS] = {
    {
        ...
        },
        {
            ...
            NULL_PTR,
            NULL_PTR,
            &IfxScu_REQ5E_P22_4_IN,
            NULL_PTR,
            &IfxScu_REQ5G_P02_8_IN,
        },
        {
            &IfxScu_REQ6A_P20_0_IN,
            &IfxScu_REQ6B_P11_10_IN,
            NULL_PTR,
            NULL_PTR,
            NULL_PTR,
