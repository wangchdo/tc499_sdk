/**
 * \file IfxGeth_PinMap_LFBGA436_EMS.c
 * \brief GETH  details
 *
...
IfxGeth_Col_In     IfxGeth0_COL_P11_15_IN = {&MODULE_GETH0, {&MODULE_P11, 15}, Ifx_RxSel_a};
...
IfxGeth_Crs_In     IfxGeth0_CRSA_P11_14_IN = {&MODULE_GETH0, {&MODULE_P11, 14}, Ifx_RxSel_a};

IfxGeth_Crs_In     IfxGeth0_CRSB_P11_11_IN = {&MODULE_GETH0, {&MODULE_P11, 11}, Ifx_RxSel_b};

IfxGeth_Crsdv_In   IfxGeth0_CRSDVA_P11_11_IN = {&MODULE_GETH0, {&MODULE_P11, 11}, Ifx_RxSel_a};

IfxGeth_Crsdv_In   IfxGeth0_CRSDVB_P11_14_IN = {&MODULE_GETH0, {&MODULE_P11, 14}, Ifx_RxSel_b};
...
IfxGeth_Mdc_Out    IfxGeth0_MDC0_P12_0_OUT = {&MODULE_GETH0, {&MODULE_P12, 0}, IfxPort_OutputIdx_alt8};
...
IfxGeth_Mdc_Out    IfxGeth0_MDC1_P12_0_OUT = {&MODULE_GETH0, {&MODULE_P12, 0}, IfxPort_OutputIdx_alt7};
...
IfxGeth_Mdio_InOut IfxGeth0_MDIO_P12_1_INOUT = {&MODULE_GETH0, {&MODULE_P12, 1}, Ifx_RxSel_c, IfxPort_OutputIdx_general};
...
IfxGeth_Refclk_In  IfxGeth0_REFCLKA_P11_12_IN = {&MODULE_GETH0, {&MODULE_P11, 12}, Ifx_RxSel_a};

IfxGeth_Refclk_In  IfxGeth0_REFCLKB_P21_4_IN = {&MODULE_GETH0, {&MODULE_P21, 4}, Ifx_RxSel_b};

IfxGeth_Refclk_In  IfxGeth0_REFCLKC_P12_0_IN = {&MODULE_GETH0, {&MODULE_P12, 0}, Ifx_RxSel_c};

IfxGeth_Rxclk_In   IfxGeth0_RXCLKA_P11_12_IN = {&MODULE_GETH0, {&MODULE_P11, 12}, Ifx_RxSel_a};

IfxGeth_Rxclk_In   IfxGeth0_RXCLKB_P21_4_IN = {&MODULE_GETH0, {&MODULE_P21, 4}, Ifx_RxSel_b};

IfxGeth_Rxclk_In   IfxGeth0_RXCLKC_P12_0_IN = {&MODULE_GETH0, {&MODULE_P12, 0}, Ifx_RxSel_c};

IfxGeth_Rxd_In     IfxGeth0_RXD0A_P11_10_IN = {&MODULE_GETH0, {&MODULE_P11, 10}, Ifx_RxSel_a};

IfxGeth_Rxd_In     IfxGeth0_RXD0C_P20_12_IN = {&MODULE_GETH0, {&MODULE_P20, 12}, Ifx_RxSel_c};

IfxGeth_Rxd_In     IfxGeth0_RXD1A_P11_9_IN = {&MODULE_GETH0, {&MODULE_P11, 9}, Ifx_RxSel_a};

IfxGeth_Rxd_In     IfxGeth0_RXD1C_P20_11_IN = {&MODULE_GETH0, {&MODULE_P20, 11}, Ifx_RxSel_c};

IfxGeth_Rxd_In     IfxGeth0_RXD2A_P11_8_IN = {&MODULE_GETH0, {&MODULE_P11, 8}, Ifx_RxSel_a};

IfxGeth_Rxd_In     IfxGeth0_RXD2C_P20_13_IN = {&MODULE_GETH0, {&MODULE_P20, 13}, Ifx_RxSel_c};

IfxGeth_Rxd_In     IfxGeth0_RXD3A_P11_7_IN = {&MODULE_GETH0, {&MODULE_P11, 7}, Ifx_RxSel_a};

IfxGeth_Rxd_In     IfxGeth0_RXD3C_P20_14_IN = {&MODULE_GETH0, {&MODULE_P20, 14}, Ifx_RxSel_c};

IfxGeth_Rxdv_In    IfxGeth0_RXDVA_P11_11_IN = {&MODULE_GETH0, {&MODULE_P11, 11}, Ifx_RxSel_a};

IfxGeth_Rxdv_In    IfxGeth0_RXDVB_P11_14_IN = {&MODULE_GETH0, {&MODULE_P11, 14}, Ifx_RxSel_b};

IfxGeth_Rxdv_In    IfxGeth0_RXDVD_P20_8_IN = {&MODULE_GETH0, {&MODULE_P20, 8}, Ifx_RxSel_d};

IfxGeth_Rxer_In    IfxGeth0_RXERA_P11_13_IN = {&MODULE_GETH0, {&MODULE_P11, 13}, Ifx_RxSel_a};
...
IfxGeth_Txclk_In   IfxGeth0_TXCLKA_P11_5_IN = {&MODULE_GETH0, {&MODULE_P11, 5}, Ifx_RxSel_a};

IfxGeth_Txclk_In   IfxGeth0_TXCLKB_P11_12_IN = {&MODULE_GETH0, {&MODULE_P11, 12}, Ifx_RxSel_b};

IfxGeth_Txclk_In   IfxGeth0_TXCLKD_P20_3_IN = {&MODULE_GETH0, {&MODULE_P20, 3}, Ifx_RxSel_d};

IfxGeth_Txd_Out    IfxGeth0_TXD_MII_P11_0_OUT = {&MODULE_GETH0, {&MODULE_P11, 0}, IfxPort_OutputIdx_alt8};

IfxGeth_Txd_Out    IfxGeth0_TXD_MII_P11_1_OUT = {&MODULE_GETH0, {&MODULE_P11, 1}, IfxPort_OutputIdx_alt8};

IfxGeth_Txd_Out    IfxGeth0_TXD_MII_P11_2_OUT = {&MODULE_GETH0, {&MODULE_P11, 2}, IfxPort_OutputIdx_alt8};

IfxGeth_Txd_Out    IfxGeth0_TXD_MII_P11_3_OUT = {&MODULE_GETH0, {&MODULE_P11, 3}, IfxPort_OutputIdx_alt8};
...
IfxGeth_Txd_Out    IfxGeth0_TXD_RMII_P11_2_OUT = {&MODULE_GETH0, {&MODULE_P11, 2}, IfxPort_OutputIdx_general};

IfxGeth_Txd_Out    IfxGeth0_TXD_RMII_P11_3_OUT = {&MODULE_GETH0, {&MODULE_P11, 3}, IfxPort_OutputIdx_general};
...
IfxGeth_Txen_Out   IfxGeth0_TXEN_MII_P11_6_OUT = {&MODULE_GETH0, {&MODULE_P11, 6}, IfxPort_OutputIdx_alt8};

IfxGeth_Txen_Out   IfxGeth0_TXEN_MII_P21_5_OUT = {&MODULE_GETH0, {&MODULE_P21, 5}, IfxPort_OutputIdx_alt12};

IfxGeth_Txen_Out   IfxGeth0_TXEN_RMII_P11_6_OUT = {&MODULE_GETH0, {&MODULE_P11, 6}, IfxPort_OutputIdx_general};

IfxGeth_Txen_Out   IfxGeth0_TXEN_RMII_P21_5_OUT = {&MODULE_GETH0, {&MODULE_P21, 5}, IfxPort_OutputIdx_alt13};

IfxGeth_Txer_Out   IfxGeth0_TXER_P11_4_OUT = {&MODULE_GETH0, {&MODULE_P11, 4}, IfxPort_OutputIdx_alt8};
...
IFX_CONST IfxGeth_Crs_In     *IfxGeth_Crs_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_CRS_IN_NUM_ITEMS] = {
    {
        &IfxGeth0_CRSA_P11_14_IN,
        &IfxGeth0_CRSB_P11_11_IN,
        NULL_PTR,
...
IFX_CONST IfxGeth_Crsdv_In   *IfxGeth_Crsdv_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_CRSDV_IN_NUM_ITEMS] = {
    {
        &IfxGeth0_CRSDVA_P11_11_IN,
        &IfxGeth0_CRSDVB_P11_14_IN,
        NULL_PTR,
...
IFX_CONST IfxGeth_Mdc_Out    *IfxGeth_Mdc_Out_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_MDC_OUT_NUM_ITEMS] = {
    {
        ...
        &IfxGeth0_MDC0_P12_0_OUT,
        &IfxGeth0_MDC1_P12_0_OUT,
...
IFX_CONST IfxGeth_Refclk_In  *IfxGeth_Refclk_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_REFCLK_IN_NUM_ITEMS] = {
    {
        &IfxGeth0_REFCLKA_P11_12_IN,
        &IfxGeth0_REFCLKB_P21_4_IN,
        &IfxGeth0_REFCLKC_P12_0_IN,
        NULL_PTR,
    },
};
...
IFX_CONST IfxGeth_Rxclk_In   *IfxGeth_Rxclk_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_RXCLK_IN_NUM_ITEMS] = {
    {
        &IfxGeth0_RXCLKA_P11_12_IN,
        &IfxGeth0_RXCLKB_P21_4_IN,
        &IfxGeth0_RXCLKC_P12_0_IN,
        NULL_PTR,
    },
};
...
IFX_CONST IfxGeth_Rxd_In     *IfxGeth_Rxd_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_RXD_IN_NUM_ITEMS] = {
    {
        &IfxGeth0_RXD3A_P11_7_IN,
        &IfxGeth0_RXD2A_P11_8_IN,
        &IfxGeth0_RXD1A_P11_9_IN,
        &IfxGeth0_RXD0A_P11_10_IN,
        NULL_PTR,
...
IFX_CONST IfxGeth_Rxdv_In    *IfxGeth_Rxdv_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_RXDV_IN_NUM_ITEMS] = {
    {
        &IfxGeth0_RXDVA_P11_11_IN,
        &IfxGeth0_RXDVB_P11_14_IN,
        NULL_PTR,
...
IFX_CONST IfxGeth_Txclk_In   *IfxGeth_Txclk_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_TXCLK_IN_NUM_ITEMS] = {
    {
        &IfxGeth0_TXCLKA_P11_5_IN,
        &IfxGeth0_TXCLKB_P11_12_IN,
        NULL_PTR,
...
IFX_CONST IfxGeth_Txd_Out    *IfxGeth_Txd_Out_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_TXD_OUT_NUM_ITEMS] = {
    {
        &IfxGeth0_TXD_MII_P11_0_OUT,
        &IfxGeth0_TXD_MII_P11_1_OUT,
        &IfxGeth0_TXD_MII_P11_2_OUT,
        &IfxGeth0_TXD_RMII_P11_2_OUT,
        &IfxGeth0_TXD_MII_P11_3_OUT,
        &IfxGeth0_TXD_RMII_P11_3_OUT,
...
IFX_CONST IfxGeth_Txen_Out   *IfxGeth_Txen_Out_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_TXEN_OUT_NUM_ITEMS] = {
    {
        &IfxGeth0_TXEN_MII_P11_6_OUT,
        &IfxGeth0_TXEN_RMII_P11_6_OUT,
