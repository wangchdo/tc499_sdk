/**
 * \file IfxPsi5_PinMap_LFBGA436_COM.h
 * \brief PSI5  details
 * \ingroup IfxLld_Psi5
 *
 ...
 * \ingroup IfxLld_Psi5
 * \defgroup IfxLld_Psi5__Pinmap Variables Default
 * \ingroup IfxLld_Psi5_
 * \defgroup IfxLld_Psi5__PinTables Default
 * \ingroup IfxLld_Psi5_
 */

#ifndef IFXPSI5_PINMAP_LFBGA436_COM_H
#define IFXPSI5_PINMAP_LFBGA436_COM_H 1
...
/** \brief RXD inputs (receive data) channel 2
 */
IFX_EXTERN IfxPsi5_Rx_In  IfxPsi5_RX2A_P00_5_IN;

/** \brief RXD inputs (receive data) channel 2
 */
IFX_EXTERN IfxPsi5_Rx_In  IfxPsi5_RX2B_P02_7_IN;

/** \brief RXD inputs (receive data) channel 2
 */
IFX_EXTERN IfxPsi5_Rx_In  IfxPsi5_RX2C_P33_5_IN;

/** \brief RXD inputs (receive data) channel 3
 */
IFX_EXTERN IfxPsi5_Rx_In  IfxPsi5_RX3A_P13_10_IN;

/** \brief RXD inputs (receive data) channel 3
 */
IFX_EXTERN IfxPsi5_Rx_In  IfxPsi5_RX3B_P13_13_IN;

/** \brief RXD inputs (receive data) channel 3
 */
IFX_EXTERN IfxPsi5_Rx_In  IfxPsi5_RX3C_P10_6_IN;
...
/** \brief TXD outputs (send data)
 */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX2_P00_6_OUT;

/** \brief TXD outputs (send data)
 */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX2_P02_8_OUT;

/** \brief TXD outputs (send data)
 */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX2_P33_6_OUT;

/** \brief TXD outputs (send data)
 */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX3_P10_5_OUT;

/** \brief TXD outputs (send data)
 */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX3_P13_11_OUT;

/** \brief TXD outputs (send data)
 */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX3_P13_15_OUT;
...
#endif /* IFXPSI5_PINMAP_LFBGA436_COM_H */
