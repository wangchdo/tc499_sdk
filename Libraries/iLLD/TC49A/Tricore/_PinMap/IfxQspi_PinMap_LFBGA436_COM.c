/**
 * \file IfxQspi_PinMap_LFBGA436_COM.c
 * \brief QSPI  details
 *
...
#include "IfxQspi_PinMap_LFBGA436_COM.h"
...
IfxQspi_Mrst_In  IfxQspi1_MRSTA_F_P10_1_IN = {&MODULE_QSPI1, {&MODULE_P10, 1}, Ifx_RxSel_a};
...
IfxQspi_Mtsr_Out IfxQspi1_MTSR_F_P10_1_OUT = {&MODULE_QSPI1, {&MODULE_P10, 1}, IfxPort_OutputIdx_alt2};

IfxQspi_Mtsr_Out IfxQspi1_MTSR_F_P10_3_OUT = {&MODULE_QSPI1, {&MODULE_P10, 3}, IfxPort_OutputIdx_alt3};

IfxQspi_Mtsr_Out IfxQspi1_MTSR_F_P10_4_OUT = {&MODULE_QSPI1, {&MODULE_P10, 4}, IfxPort_OutputIdx_alt4};
...
IfxQspi_Slso_Out IfxQspi1_SLSO10_F_P10_0_OUT = {&MODULE_QSPI1, 10, {&MODULE_P10, 0}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slso_Out IfxQspi1_SLSO8_F_P10_4_OUT = {&MODULE_QSPI1, 8, {&MODULE_P10, 4}, IfxPort_OutputIdx_alt3};

IfxQspi_Slso_Out IfxQspi1_SLSO9_F_P10_5_OUT = {&MODULE_QSPI1, 9, {&MODULE_P10, 5}, IfxPort_OutputIdx_alt4};
...
IfxQspi_Mrst_In  IfxQspi3_MRSTE_P17_0_IN = {&MODULE_QSPI3, {&MODULE_P17, 0}, Ifx_RxSel_e};
...
IfxQspi_Slso_Out IfxQspi3_SLSO11_P02_12_OUT = {&MODULE_QSPI3, 11, {&MODULE_P02, 12}, IfxPort_OutputIdx_alt2};

IfxQspi_Slso_Out IfxQspi3_SLSO12_P02_15_OUT = {&MODULE_QSPI3, 12, {&MODULE_P02, 15}, IfxPort_OutputIdx_alt2};

IfxQspi_Slso_Out IfxQspi3_SLSO13_P17_1_OUT = {&MODULE_QSPI3, 13, {&MODULE_P17, 1}, IfxPort_OutputIdx_alt12};
...
IfxQspi_Slso_Out IfxQspi3_SLSO2_F_P02_1_OUT = {&MODULE_QSPI3, 2, {&MODULE_P02, 1}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slso_Out IfxQspi3_SLSO4_F_P02_3_OUT = {&MODULE_QSPI3, 4, {&MODULE_P02, 3}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slso_Out IfxQspi4_SLSO3_F_P22_2_OUT = {&MODULE_QSPI4, 3, {&MODULE_P22, 2}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slso_Out IfxQspi5_SLSO10_F_P33_7_OUT = {&MODULE_QSPI5, 10, {&MODULE_P33, 7}, IfxPort_OutputIdx_alt7};

IfxQspi_Slso_Out IfxQspi5_SLSO11_F_P33_8_OUT = {&MODULE_QSPI5, 11, {&MODULE_P33, 8}, IfxPort_OutputIdx_alt7};

IfxQspi_Slso_Out IfxQspi5_SLSO12_F_P33_9_OUT = {&MODULE_QSPI5, 12, {&MODULE_P33, 9}, IfxPort_OutputIdx_alt7};

IfxQspi_Slso_Out IfxQspi5_SLSO13_F_P33_10_OUT = {&MODULE_QSPI5, 13, {&MODULE_P33, 10}, IfxPort_OutputIdx_alt7};
...
IfxQspi_Slso_Out IfxQspi5_SLSO4_P13_14_OUT = {&MODULE_QSPI5, 4, {&MODULE_P13, 14}, IfxPort_OutputIdx_alt8};
...
IfxQspi_Mrst_In  IfxQspi6_MRSTA_F_P23_6_IN = {&MODULE_QSPI6, {&MODULE_P23, 6}, Ifx_RxSel_a};

IfxQspi_Mrst_In  IfxQspi6_MRSTB_P25_1_IN = {&MODULE_QSPI6, {&MODULE_P25, 1}, Ifx_RxSel_b};

IfxQspi_Mrst_In  IfxQspi6_MRSTD_P25_0_IN = {&MODULE_QSPI6, {&MODULE_P25, 0}, Ifx_RxSel_d};

IfxQspi_Mrst_In  IfxQspi6_MRSTE_F_P23_2_IN = {&MODULE_QSPI6, {&MODULE_P23, 2}, Ifx_RxSel_e};

IfxQspi_Mrst_Out IfxQspi6_MRST_P23_6_OUT = {&MODULE_QSPI6, {&MODULE_P23, 6}, IfxPort_OutputIdx_alt8};

IfxQspi_Mtsr_In  IfxQspi6_MTSRB_P25_4_IN = {&MODULE_QSPI6, {&MODULE_P25, 4}, Ifx_RxSel_b};

IfxQspi_Mtsr_Out IfxQspi6_MTSR_F_P23_1_OUT = {&MODULE_QSPI6, {&MODULE_P23, 1}, IfxPort_OutputIdx_alt8};

IfxQspi_Mtsr_Out IfxQspi6_MTSR_P25_3_OUT = {&MODULE_QSPI6, {&MODULE_P25, 3}, IfxPort_OutputIdx_alt8};

IfxQspi_Sclk_In  IfxQspi6_SCLKA_P23_7_IN = {&MODULE_QSPI6, {&MODULE_P23, 7}, Ifx_RxSel_a};

IfxQspi_Sclk_In  IfxQspi6_SCLKB_P25_2_IN = {&MODULE_QSPI6, {&MODULE_P25, 2}, Ifx_RxSel_b};

IfxQspi_Sclk_Out IfxQspi6_SCLK_F_P23_3_OUT = {&MODULE_QSPI6, {&MODULE_P23, 3}, IfxPort_OutputIdx_alt8};

IfxQspi_Sclk_Out IfxQspi6_SCLK_P23_7_OUT = {&MODULE_QSPI6, {&MODULE_P23, 7}, IfxPort_OutputIdx_alt8};

IfxQspi_Sclk_Out IfxQspi6_SCLK_P25_2_OUT = {&MODULE_QSPI6, {&MODULE_P25, 2}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi6_SLSO0_F_P23_3_OUT = {&MODULE_QSPI6, 0, {&MODULE_P23, 3}, IfxPort_OutputIdx_alt7};

IfxQspi_Slso_Out IfxQspi6_SLSO10_P33_9_OUT = {&MODULE_QSPI6, 10, {&MODULE_P33, 9}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi6_SLSO11_P25_4_OUT = {&MODULE_QSPI6, 11, {&MODULE_P25, 4}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi6_SLSO12_P25_5_OUT = {&MODULE_QSPI6, 12, {&MODULE_P25, 5}, IfxPort_OutputIdx_alt8};
...
IfxQspi_Slso_Out IfxQspi6_SLSO3_F_P23_2_OUT = {&MODULE_QSPI6, 3, {&MODULE_P23, 2}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi6_SLSO8_P25_7_OUT = {&MODULE_QSPI6, 8, {&MODULE_P25, 7}, IfxPort_OutputIdx_alt8};

IfxQspi_Mrst_In  IfxQspi7_MRSTA_P14_8_IN = {&MODULE_QSPI7, {&MODULE_P14, 8}, Ifx_RxSel_a};

IfxQspi_Mrst_In  IfxQspi7_MRSTB_P10_0_IN = {&MODULE_QSPI7, {&MODULE_P10, 0}, Ifx_RxSel_b};
...
IfxQspi_Mtsr_In  IfxQspi7_MTSRB_P16_7_IN = {&MODULE_QSPI7, {&MODULE_P16, 7}, Ifx_RxSel_b};
...
IfxQspi_Mtsr_Out IfxQspi7_MTSR_P10_4_OUT = {&MODULE_QSPI7, {&MODULE_P10, 4}, IfxPort_OutputIdx_alt8};

IfxQspi_Mtsr_Out IfxQspi7_MTSR_P13_6_OUT = {&MODULE_QSPI7, {&MODULE_P13, 6}, IfxPort_OutputIdx_alt8};

IfxQspi_Sclk_In  IfxQspi7_SCLKA_P13_10_IN = {&MODULE_QSPI7, {&MODULE_P13, 10}, Ifx_RxSel_a};

IfxQspi_Sclk_In  IfxQspi7_SCLKB_P16_1_IN = {&MODULE_QSPI7, {&MODULE_P16, 1}, Ifx_RxSel_b};
...
IfxQspi_Slsi_In  IfxQspi7_SLSIA_P16_6_IN = {&MODULE_QSPI7, {&MODULE_P16, 6}, Ifx_RxSel_a};

IfxQspi_Slso_Out IfxQspi7_SLSO0_P10_0_OUT = {&MODULE_QSPI7, 0, {&MODULE_P10, 0}, IfxPort_OutputIdx_alt8};
...
IfxQspi_Slso_Out IfxQspi7_SLSO1_P10_1_OUT = {&MODULE_QSPI7, 1, {&MODULE_P10, 1}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi7_SLSO2_P10_2_OUT = {&MODULE_QSPI7, 2, {&MODULE_P10, 2}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi7_SLSO3_P14_13_OUT = {&MODULE_QSPI7, 3, {&MODULE_P14, 13}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi7_SLSO4_P14_12_OUT = {&MODULE_QSPI7, 4, {&MODULE_P14, 12}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi7_SLSO5_F_P16_10_OUT = {&MODULE_QSPI7, 5, {&MODULE_P16, 10}, IfxPort_OutputIdx_alt6};

IfxQspi_Slso_Out IfxQspi7_SLSO6_P14_14_OUT = {&MODULE_QSPI7, 6, {&MODULE_P14, 14}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi7_SLSO7_P14_15_OUT = {&MODULE_QSPI7, 7, {&MODULE_P14, 15}, IfxPort_OutputIdx_alt8};

IfxQspi_Slso_Out IfxQspi7_SLSO8_F_P16_4_OUT = {&MODULE_QSPI7, 8, {&MODULE_P16, 4}, IfxPort_OutputIdx_alt6};

IfxQspi_Slso_Out IfxQspi7_SLSO9_F_P15_10_OUT = {&MODULE_QSPI7, 9, {&MODULE_P15, 10}, IfxPort_OutputIdx_alt7};
...
IFX_CONST IfxQspi_Mrst_In  *IfxQspi_Mrst_In_pinTable[IFXQSPI_PINMAP_NUM_MODULES][IFXQSPI_PINMAP_MRST_IN_NUM_ITEMS] = {
    ...
    {
        &IfxQspi6_MRSTA_F_P23_6_IN,
        &IfxQspi6_MRSTB_P25_1_IN,
        NULL_PTR,
        &IfxQspi6_MRSTD_P25_0_IN,
        &IfxQspi6_MRSTE_F_P23_2_IN,
        NULL_PTR,
        NULL_PTR,
    },
    {
        &IfxQspi7_MRSTA_P14_8_IN,
        &IfxQspi7_MRSTB_P10_0_IN,
        NULL_PTR,
...
IFX_CONST IfxQspi_Mtsr_In  *IfxQspi_Mtsr_In_pinTable[IFXQSPI_PINMAP_NUM_MODULES][IFXQSPI_PINMAP_MTSR_IN_NUM_ITEMS] = {
    ...
    {
        NULL_PTR,
        &IfxQspi6_MTSRB_P25_4_IN,
        NULL_PTR,
        NULL_PTR,
    },
    {
        &IfxQspi7_MTSRA_P14_7_IN,
        &IfxQspi7_MTSRB_P16_7_IN,
        NULL_PTR,
        NULL_PTR,
    },
};
...
IFX_CONST IfxQspi_Mtsr_Out *IfxQspi_Mtsr_Out_pinTable[IFXQSPI_PINMAP_NUM_MODULES][IFXQSPI_PINMAP_MTSR_OUT_NUM_ITEMS] = {
    ...
    {
        &IfxQspi1_MTSR_F_P10_1_OUT,
        &IfxQspi1_MTSR_F_P10_3_OUT,
        &IfxQspi1_MTSR_F_P10_4_OUT,
        NULL_PTR,
        NULL_PTR,
        NULL_PTR,
    },
    ...
    {
        &IfxQspi7_MTSR_P10_4_OUT,
        &IfxQspi7_MTSR_P13_6_OUT,
...
IFX_CONST IfxQspi_Sclk_In  *IfxQspi_Sclk_In_pinTable[IFXQSPI_PINMAP_NUM_MODULES][IFXQSPI_PINMAP_SCLK_IN_NUM_ITEMS] = {
    ...
    {
        &IfxQspi6_SCLKA_P23_7_IN,
        &IfxQspi6_SCLKB_P25_2_IN,
        NULL_PTR,
        NULL_PTR,
        NULL_PTR,
    },
    {
        &IfxQspi7_SCLKA_P13_10_IN,
        &IfxQspi7_SCLKB_P16_1_IN,
        NULL_PTR,
        NULL_PTR,
        NULL_PTR,
    },
...
IFX_CONST IfxQspi_Sclk_Out *IfxQspi_Sclk_Out_pinTable[IFXQSPI_PINMAP_NUM_MODULES][IFXQSPI_PINMAP_SCLK_OUT_NUM_ITEMS] = {
    ...
    {
        &IfxQspi6_SCLK_F_P23_3_OUT,
        &IfxQspi6_SCLK_P23_7_OUT,
        &IfxQspi6_SCLK_P25_2_OUT,
        NULL_PTR,
        NULL_PTR,
        NULL_PTR,
        NULL_PTR,
...
IFX_CONST IfxQspi_Slso_Out *IfxQspi_Slso_Out_pinTable[IFXQSPI_PINMAP_NUM_MODULES][IFXQSPI_PINMAP_NUM_SLAVESELECTS][IFXQSPI_PINMAP_SLSO_OUT_NUM_ITEMS] = {
    ...
    },
    {
        ...
        {
            &IfxQspi1_SLSO8_F_P10_4_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi1_SLSO9_F_P10_5_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi1_SLSO10_F_P10_0_OUT,
            NULL_PTR,
        },
        {
            NULL_PTR,
    ...
    },
    {
        ...
        {
            &IfxQspi3_SLSO11_P02_12_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi3_SLSO12_P02_15_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi3_SLSO13_P17_1_OUT,
            NULL_PTR,
        },
        {
    ...
    },
    {
        ...
        {
            &IfxQspi5_SLSO12_F_P33_9_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi5_SLSO13_F_P33_10_OUT,
            NULL_PTR,
        },
        {
            NULL_PTR,
    ...
    },
    {
        ...
        {
            &IfxQspi6_SLSO11_P25_4_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi6_SLSO12_P25_5_OUT,
            NULL_PTR,
        },
        {
    ...
    {
        {
            &IfxQspi7_SLSO0_P10_0_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi7_SLSO1_P10_1_OUT,
            NULL_PTR,
        },
        {
        ...
        {
            &IfxQspi7_SLSO3_P14_13_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi7_SLSO4_P14_12_OUT,
            NULL_PTR,
        },
        {
        ...
        {
            &IfxQspi7_SLSO6_P14_14_OUT,
            NULL_PTR,
        },
        {
            &IfxQspi7_SLSO7_P14_15_OUT,
            NULL_PTR,
        },
        {
