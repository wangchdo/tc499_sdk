/**
 * \file IfxPsi5_PinMap_LFBGA436_COM.c
 * \brief PSI5  details
 *
...
#include "IfxPsi5_PinMap_LFBGA436_COM.h"
...
IfxPsi5_Rx_In  IfxPsi5_RX2A_P00_5_IN = {&MODULE_PSI5, (IfxPsi5_ChannelId)2, {&MODULE_P00, 5}, Ifx_RxSel_a};

IfxPsi5_Rx_In  IfxPsi5_RX2B_P02_7_IN = {&MODULE_PSI5, (IfxPsi5_ChannelId)2, {&MODULE_P02, 7}, Ifx_RxSel_b};

IfxPsi5_Rx_In  IfxPsi5_RX2C_P33_5_IN = {&MODULE_PSI5, (IfxPsi5_ChannelId)2, {&MODULE_P33, 5}, Ifx_RxSel_c};

IfxPsi5_Rx_In  IfxPsi5_RX3A_P13_10_IN = {&MODULE_PSI5, (IfxPsi5_ChannelId)3, {&MODULE_P13, 10}, Ifx_RxSel_a};

IfxPsi5_Rx_In  IfxPsi5_RX3B_P13_13_IN = {&MODULE_PSI5, (IfxPsi5_ChannelId)3, {&MODULE_P13, 13}, Ifx_RxSel_b};

IfxPsi5_Rx_In  IfxPsi5_RX3C_P10_6_IN = {&MODULE_PSI5, (IfxPsi5_ChannelId)3, {&MODULE_P10, 6}, Ifx_RxSel_c};
...
IfxPsi5_Tx_Out IfxPsi5_TX2_P00_6_OUT = {&MODULE_PSI5, (IfxPsi5_ChannelId)2, {&MODULE_P00, 6}, IfxPort_OutputIdx_alt4};

IfxPsi5_Tx_Out IfxPsi5_TX2_P02_8_OUT = {&MODULE_PSI5, (IfxPsi5_ChannelId)2, {&MODULE_P02, 8}, IfxPort_OutputIdx_alt4};

IfxPsi5_Tx_Out IfxPsi5_TX2_P33_6_OUT = {&MODULE_PSI5, (IfxPsi5_ChannelId)2, {&MODULE_P33, 6}, IfxPort_OutputIdx_alt4};

IfxPsi5_Tx_Out IfxPsi5_TX3_P10_5_OUT = {&MODULE_PSI5, (IfxPsi5_ChannelId)3, {&MODULE_P10, 5}, IfxPort_OutputIdx_alt7};

IfxPsi5_Tx_Out IfxPsi5_TX3_P13_11_OUT = {&MODULE_PSI5, (IfxPsi5_ChannelId)3, {&MODULE_P13, 11}, IfxPort_OutputIdx_alt4};

IfxPsi5_Tx_Out IfxPsi5_TX3_P13_15_OUT = {&MODULE_PSI5, (IfxPsi5_ChannelId)3, {&MODULE_P13, 15}, IfxPort_OutputIdx_alt4};
