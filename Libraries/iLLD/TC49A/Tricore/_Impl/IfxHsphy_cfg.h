 ...
 */
#define IFXHSPHY_NUM_CHANNELS (2)

/** \brief Number of Modules
 */
#define IFXHSPHY_NUM_MODULES  (1)

/** \brief Numer of PHYS inside a single HPSHY
 */
#define IFXHSPHY_NUM_OF_PHY   (2)

/******************************************************************************/
/*-------------------------------Enumerations---------------------------------*/
/******************************************************************************/

/** \brief List of the available HSPHY Resources
 */
typedef enum
{
    IfxHsphy_Index_none = -1,  /**< \brief Not Selected */
    IfxHsphy_Index_0    = 0    /**< \brief HSPHY index 0 */
} IfxHsphy_Index;
