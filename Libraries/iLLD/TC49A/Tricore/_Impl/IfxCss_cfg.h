...
#define IFXCSS_CHANNEL0_FIFOSIZE_BYTES           ((uint32)(512))

#define IFXCSS_CHANNEL1TO2_FIFOSIZE_BYTES        ((uint32)(1536))

#define IFXCSS_CHANNEL3TO20_FIFOSIZE_BYTES       ((uint32)(256))

/** \brief TODO: put infndef here, also do a calculation in functions
 */
#define IFXCSS_CHANNEL_FIFOSIZE_BYTES            ((uint32)(256))

/** \brief Channel 0 Input FIFO Size in Bytes
 */
#define IFXCSS_CHANNEL0_INPUTFIFOSIZE_BYTES      ((uint16)(512))

/** \brief Channel 1-2 Input FIFO Size in Bytes
 */
#define IFXCSS_CHANNEL1TO2_INPUTFIFOSIZE_BYTES   ((uint16)(1536))

/** \brief Channel 3-20 Input FIFO Size in Bytes
 */
#define IFXCSS_CHANNEL3TO20_INPUTFIFOSIZE_BYTES  ((uint16)(256))
