...
/** \brief Number of TMADC available in the device 
 */
#define IFXCONVERTER_NUM_TMADC (9)

/** \brief number of channels in one TMADC module 
 */
#define IFXCONVERTER_NUM_TMADC_CHANNELS (16)
