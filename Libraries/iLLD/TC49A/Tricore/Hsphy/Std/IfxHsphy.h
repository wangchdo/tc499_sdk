...
typedef enum
{
    ...
    IfxHsphy_PhyIndex_1,        /**< \brief PHY index 1  */
    IfxHsphy_PhyIndex_max       /**< \brief Max index for PHY */
} IfxHsphy_PhyIndex;
...
typedef enum
{
    ...
    IfxHsphy_SgmiiSpeed_max  = 4   /**< \brief max SGMII speed selection */
} IfxHsphy_SgmiiSpeed;
...
typedef enum
{
    ...
    IfxHsphy_TrgtDeviceSpeed_0P1G  = 1,  /**< \brief Target device speed selection for 100M mode */
...
typedef enum
{
    IfxHsphy_XpcsIndex_0 = 0,    /**< \brief "XPCS index "+str(x)  */
    IfxHsphy_XpcsIndex_1,        /**< \brief "XPCS index "+str(x)  */
    IfxHsphy_XpcsIndex_max       /**< \brief Max value of XPCS index */
} IfxHsphy_XpcsIndex;
...
typedef struct
{
    ...
    IfxGeth_Mdio_InOut *mdio0;        /**< \brief mdio pin reference for rmii for MAC0 */
    IfxGeth_Mdio_InOut *mdio1;        /**< \brief mdio pin reference for rmii for MAC1 */
...
typedef struct
{
    ...
    IfxGeth_Mdio_InOut *mdio0;       /**< \brief mdio pin reference for mii for MAC0 */
    IfxGeth_Mdio_InOut *mdio1;       /**< \brief mdio pin reference for mii for MAC1 */
...
typedef struct
{
    ...
    IfxGeth_Mdio_InOut *mdio0;         /**< \brief mdio pin reference for rgmii for MAC0 */
    IfxGeth_Mdio_InOut *mdio1;         /**< \brief mdio pin reference for rgmii for MAC1 */
 ...
 * \return returns True if time out error occurs
 */
IFX_EXTERN boolean IfxHsphy_resetXpcs(Ifx_HSPHY *hsphyRegPtr, IfxHsphy_GethXpcsParams *xpcs);
 ...
 */
IFX_EXTERN IfxHsphy_Geth_SgmiiSpeedConfigStatus IfxHsphy_Geth_setSgmiiSpeedMode(Ifx_HSPHY *hsphyRegPtr, IfxHsphy_TrgtDeviceSpeed trgtSpeed, IfxHsphy_GethXpcsParams *xpcs);
 ...
 * \return returns True if time out error occurs
 */
IFX_EXTERN boolean IfxHsphy_Geth_setUsxgmiiSpeedMode(Ifx_HSPHY *hsphyRegPtr, IfxHsphy_TrgtDeviceSpeed trgtSpeed, IfxHsphy_GethXpcsParams *xpcs);
...
/** \brief configures rgmii pins
 * \param hsphyRegPtr hsphy register pointer
 * \param config rgmii config
 * \return None
 */
IFX_EXTERN void IfxHsphy_Geth_setRgmiiPins(Ifx_HSPHY *hsphyRegPtr, IfxHsphy_Geth_RgmiiCfg *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxHsphy_Geth_setMiiPins(Ifx_HSPHY *hsphyRegPtr, IfxHsphy_Geth_MiiCfg *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxHsphy_Geth_setRmiiPins(Ifx_HSPHY *hsphyRegPtr, IfxHsphy_Geth_RmiiCfg *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxHsphy_Geth_setupRmiiInputPins(Ifx_HSPHY *hsphyRegPtr, const IfxHsphy_Geth_RmiiPins *rmiiPins);
 ...
 * \return None
 */
IFX_EXTERN void IfxHsphy_Geth_setupRgmiiInputPins(Ifx_HSPHY *hsphyRegPtr, const IfxHsphy_Geth_RgmiiPins *rgmiiPins);
 ...
 * \return None
 */
IFX_EXTERN void IfxHsphy_Geth_setupMiiInputPins(Ifx_HSPHY *hsphyRegPtr, const IfxHsphy_Geth_MiiPins *miiPins);
...
/** \brief Set the Pin Controller Selection.
 * \param port Pointer to the base of specified port's SFRs
 * \param pinIndex Specifies the pin for which the mode has to be set.
 * \return None
 */
IFX_EXTERN void IfxHsphy_setPinControllerSelection(Ifx_P *port, uint8 pinIndex);

/** \brief Set the Pin Controller Selection.
 * \param port Pointer to the base of specified port's SFRs
 * \param pinIndex Specifies the pin for which the mode has to be reset.
 * \return None
 */
IFX_EXTERN void IfxHsphy_resetPinControllerSelection(Ifx_P *port, uint8 pinIndex);
