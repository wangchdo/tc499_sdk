...
/** \addtogroup IfxLld_Smu_Std_Data Structures
 * \{ */
typedef struct
{
    IfxApProt_ProtConfig protseConfig;       /**< \brief PROT SE Config. */
    IfxApApu_ApuConfig   apuConfig;          /**< \brief APU Config. */
} IfxSmu_safetyApConfig;

/** \brief Secure AP Configuration
 */
typedef struct
{
    IfxApProt_ProtConfig protseConfig;       /**< \brief PROT SE Config */
    IfxApApu_ApuConfig   apuConfig;          /**< \brief AP Config */
} IfxSmu_secureApConfig;

typedef struct
{
    IfxApProt_ProtConfig protseConfig;       /**< \brief PROT SE Config. */
    IfxApApu_ApuConfig   apuConfig;          /**< \brief APU Config. */
} IfxSmu_sharedApConfig;
...
/** \brief Initialize the PROTs and APUs with default configuration for SMU module.
 * \return None
 */
IFX_EXTERN void IfxSmu_initSafetyApConfig(IfxSmu_safetyApConfig *config);

/** \brief Initialize the PORTs and APU for SMU Safety module.
 * \return None
 */
IFX_EXTERN void IfxSmu_initSafetyAp(Ifx_SMU_SAFE *smu, IfxSmu_safetyApConfig *config);
...
/** \brief Initialize the Secure AP with default values
 * \param config Secure AP Config pointer
 * \return None
 */
IFX_EXTERN void IfxSmu_initSecureApConfig(IfxSmu_secureApConfig *config);

/** \brief Initialze the Secure AP
 * \param smu SMU moudle pointer
 * \param config Secure AP config pointer
 * \return None
 */
IFX_EXTERN void IfxSmu_initSecureAp(Ifx_SMU *smu, IfxSmu_secureApConfig *config);
...
/** \brief Initialize the PORTs and APU for SMU Security module.
 * \return None
 */
IFX_EXTERN void IfxSmu_initSharedAp(Ifx_SMU *smu, IfxSmu_sharedApConfig *config);

/**
 * \return None
 */
IFX_EXTERN void IfxSmu_initSharedApConfig(IfxSmu_sharedApConfig *config);
