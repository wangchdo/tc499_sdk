...
/** \addtogroup IfxLld_Smu_Std_Stdby_Structures
 * \{ */
/** \brief Acces Protection Config.
 */
typedef struct
{
    IfxApProt_ProtConfig proteConfig;        /**< \brief STDBY PROTE Config */
    IfxApProt_ProtConfig protseConfig;       /**< \brief STDBY PROTSE Config */
    IfxApApu_ApuConfig   apuConfig;          /**< \brief STDBY APU Config */
} IfxSmuStdby_ApConfig;
...
/** \brief initialize the AP Config
 * \param config Config Pointer to AP
 * \return None
 */
IFX_EXTERN void IfxSmuStdby_initApConfig(IfxSmuStdby_ApConfig *config);

/** \brief Initialize the AP
 * \param stdbysmu Pointer to stdbysmu register
 * \param config Config pointer to AP
 * \return None
 */
IFX_EXTERN void IfxSmuStdby_initAp(Ifx_SMU_STDBY *stdbysmu, IfxSmuStdby_ApConfig *config);
