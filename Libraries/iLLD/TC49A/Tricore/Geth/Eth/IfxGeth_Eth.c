...
void IfxGeth_Eth_configureMTL(IfxGeth_Eth *geth, IfxGeth_PortIndex portIndex, IfxGeth_Eth_MtlConfig *mtlConfig)
{
    ...
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q0DDMACH = 0;                                                        /* Channel is as per Q0MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q0MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_0].rxDmaChannelMap; /* Mapping of RXC0 to DMA Channel */

    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q1DDMACH = 0;                                                        /* Channel is as per Q1MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q1MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_1].rxDmaChannelMap; /* Mapping of RXC1 to DMA Channel */

    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q2DDMACH = 0;                                                        /* Channel is as per Q2MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q2MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_2].rxDmaChannelMap; /* Mapping of RXC2 to DMA Channel */

    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q3DDMACH = 0;                                                        /* Channel is as per Q3MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP0.B.Q3MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_3].rxDmaChannelMap; /* Mapping of RXC3 to DMA Channel */

    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q4DDMACH = 0;                                                        /* Channel is as per Q4MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q4MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_4].rxDmaChannelMap; /* Mapping of RXC4 to DMA Channel */

    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q5DDMACH = 0;                                                        /* Channel is as per Q5MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q5MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_5].rxDmaChannelMap; /* Mapping of RXC5 to DMA Channel */

    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q6DDMACH = 0;                                                        /* Channel is as per Q6MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q6MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_6].rxDmaChannelMap; /* Mapping of RXC6 to DMA Channel */

    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q7DDMACH = 0;                                                        /* Channel is as per Q7MDMACH */
    gethSFR->PORT[portIndex].MTL.RXQ_DMA_MAP1.B.Q7MDMACH = mtlConfig->rxQueue[IfxGeth_RxMtlQueue_7].rxDmaChannelMap; /* Mapping of RXC7 to DMA Channel */
...
void IfxGeth_Eth_configureDMA(IfxGeth_Eth *geth, IfxGeth_Eth_DmaConfig *dmaConfig)
{
    ...
    gethSFR->DMA.SYSBUS_MODE.B.UNDEF = dmaConfig->undefinedBurstLength;
    ...
    if (dmaConfig->burstLength != IfxGeth_DmaBurstLength_unset)
    {
        ...
        {
            gethSFR->DMA.SYSBUS_MODE.B.UNDEF = 0;
            break;
        }
...
void IfxGeth_Eth_flexibleHeaderInit(IfxGeth_Eth *geth, IfxGeth_PortIndex portIndex, IfxGeth_Eth_FlexHeaderConfig *config)
{
    ...
    if (config->txEnable && config->pauseHeaderEnable)
    {
        ...
        geth->gethSFR->PORT[portIndex].CORE.MAC_FLEX_HDR_HIGH.U = (config->staticHeader >> 32);
    }
