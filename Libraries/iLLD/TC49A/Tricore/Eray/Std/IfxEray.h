...
/** \brief Returns the Macrotick value
 * \param eray pointer to ERAY module registers.
 * \return MacroTick Value
 */
IFX_INLINE uint16 IfxEray_getMacroTickValue(Ifx_ERAY *eray);
...
/** \brief Initialize the PROT and APU with default values
 * \param config AP config pointer
 * \return None
 */
IFX_EXTERN void IfxEray_initApConfig(IfxEray_ApConfig *config);

/** \brief Initialize the PROT and APU
 * \param eray ERAY module pointer
 * \param config AP config pointer
 * \return None
 */
IFX_EXTERN void IfxEray_initAp(Ifx_ERAY *eray, IfxEray_ApConfig *config);

/** \brief Configures access to all masters to all the Erays in the device
 * \param apConfig config pointer to configuration structure.
 * \return None
 */
IFX_EXTERN void IfxEray_configureAccessToErays(IfxApApu_ApuConfig *apConfig);
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getInputBufferBusySrcPtr(Ifx_ERAY *eray)
{
    ...
    {
        return &MODULE_SRC.ERAY[0].IBUSY;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].IBUSY;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getInterruptLine0SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].INT0;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].INT0;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getInterruptLine1SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].INT1;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].INT1;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getMessageBufferStatus0SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].MBSC0;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].MBSC0;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getMessageBufferStatus1SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].MBSC1;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].MBSC1;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getNewDataInterrupt0SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].NDAT0;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].NDAT0;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getNewDataInterrupt1SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].NDAT1;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].NDAT1;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getOutputBufferBusySrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].OBUSY;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].OBUSY;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getTimerInterrupt0SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].TINT0;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].TINT0;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxEray_getTimerInterrupt1SrcPtr(Ifx_ERAY *eray)
{
    if (eray == &MODULE_ERAY0)
    {
        return &MODULE_SRC.ERAY[0].TINT1;
    }
    else
    {
        return &MODULE_SRC.ERAY[1].TINT1;
    }
}
...
IFX_INLINE uint16 IfxEray_getMacroTickValue(Ifx_ERAY *eray)
{
    return (uint16)eray->MTCCV.B.MTV;
}
