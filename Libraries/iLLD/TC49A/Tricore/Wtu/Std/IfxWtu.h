...
/** \brief CPU PROT and APU Config
 */
typedef struct
{
    IfxApProt_ProtConfig cpuProtseConfig;       /**< \brief CPU PROT SE Config */
    IfxApApu_ApuConfig   cpuApuConfig;          /**< \brief CPU APU Config */
} IfxWtu_cpuApConfig;

/** \brief System PROT and APU Config
 */
typedef struct
{
    IfxApProt_ProtConfig secureProtseConfig;       /**< \brief Secure PROT SE Config */
    IfxApApu_ApuConfig   secureApuConfig;          /**< \brief Secure APU Config */
} IfxWtu_secureApConfig;

/** \brief System PROT and APU Config
 */
typedef struct
{
    IfxApProt_ProtConfig systemProtseConfig;       /**< \brief System PROT SE Config */
    IfxApApu_ApuConfig   systemApuConfig;          /**< \brief System APU Config */
} IfxWtu_systemApConfig;
...
/** \brief Intialize the AP Config with default values
 * \param config Pointer to AP config
 * \return None
 */
IFX_EXTERN void IfxWtu_initCpuApConfig(IfxWtu_cpuApConfig *config);

/** \brief Initialize the PROT and APUs
 * \param wtu WTU module pointer
 * \param config Pointer to AP configurations
 * \param cpuId CPU WDT number for which the PROT and APU is to be configured
 * \return None
 */
IFX_EXTERN void IfxWtu_initCpuAp(Ifx_WTU *wtu, IfxWtu_cpuApConfig *config, uint8 cpuId);

/** \brief Intialize the AP Config with default values
 * \param config Pointer to AP config
 * \return None
 */
IFX_EXTERN void IfxWtu_initSystemApConfig(IfxWtu_systemApConfig *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxWtu_initSystemAp(Ifx_WTU *wtu, IfxWtu_systemApConfig *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxWtu_initSecureAp(Ifx_WTU *wtu, IfxWtu_secureApConfig *config);

/** \brief Intialize the AP Config with default values
 * \param config Pointer to AP config
 * \return None
 */
IFX_EXTERN void IfxWtu_initSecureApConfig(IfxWtu_secureApConfig *config);
