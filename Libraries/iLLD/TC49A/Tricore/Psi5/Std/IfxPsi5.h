...
typedef enum
{
    IfxPsi5_ExternalTrigger_0 = 0,      /**< \brief External trigger  0  */
    IfxPsi5_ExternalTrigger_1,          /**< \brief External trigger  1  */
    IfxPsi5_ExternalTrigger_2,          /**< \brief External trigger  2  */
    IfxPsi5_ExternalTrigger_3,          /**< \brief External trigger  3  */
    IfxPsi5_ExternalTrigger_4,          /**< \brief External trigger  4  */
    IfxPsi5_ExternalTrigger_5           /**< \brief External trigger  5  */
} IfxPsi5_ExternalTrigger;

/** \brief MODULE_PSI5.PGCx.ETE, External line is selected by ETE
 */
typedef enum
{
    IfxPsi5_ExternalTriggerLine_disabled = 0,  /**< \brief External Trigger Line Disabled */
    IfxPsi5_ExternalTriggerLine_enabled  = 1   /**< \brief External Trigger Line Enabled */
} IfxPsi5_ExternalTriggerLine;

/** \brief MODULE_PSI5.PGCx.BYP, External Trigger Bypass Control
 */
typedef enum
{
    IfxPsi5_Externaltrigger_Bypass_disabled = 0,  /**< \brief External Trigger Bypass Disabled */
    IfxPsi5_Externaltrigger_Bypass_enabled  = 1   /**< \brief External Trigger Bypass Enabled */
} IfxPsi5_Externaltrigger_Bypass;
...
/** \brief MODULE_PSI5.PGCx.PTE, Periodic Trigger Select by PTE
 */
typedef enum
{
    IfxPsi5_PeriodicTrigger_disabled = 0,  /**< \brief Periodic Trigger Disabled */
    IfxPsi5_PeriodicTrigger_enabled  = 1   /**< \brief Periodic Trigger Enabled */
} IfxPsi5_PeriodicTrigger;
...
/** \brief MODULE_PSI5.FDRT.TRIGSEL, MODULE_PSI5.TSRA.TRIGSEL, MODULE_PSI5.TSRB.TRIGSEL,
 * MODULE_PSI5.TSRC.TRIGSEL, MODULE_PSI5.PCGx.TRIGSEL(x = 0,1,2,3), Trigger Source Selection bit for Trigger select
 */
typedef enum
{
    IfxPsi5_TriggerSelect_gtmTrigger  = 0, /**< \brief GTM Triggered */
    IfxPsi5_TriggerSelect_eGtmTrigger = 1  /**< \brief eGTM Triggered */
} IfxPsi5_TriggerSelect;
...
/** \brief resets PSI5 kernel
 * \param config pointer to PSI5 registers
 * \return None
 */
IFX_EXTERN void IfxPsi5_initApConfig(IfxPsi5_ApConfig *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxPsi5_initAp(Ifx_PSI5 *psi5, IfxPsi5_ApConfig *config);
 ...
 * \param psi5 pointer to PSI5 registers
 * \param channel Channel Id of PSI5 channel
 * \param enable choice (enable/disable)
 * \return None
 */
IFX_INLINE void IfxPsi5_enableExternalTrigger(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, boolean enable);

/** \brief Enable the External Trigger Bypass
 * \param psi5 pointer to PSI5 registers
 * \param channel Channel Id of PSI5 channel
 * \param enable choice (enable/disable)
 * \return None
 */
IFX_INLINE void IfxPsi5_enableExternalTriggerBypass(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, boolean enable);

/** \brief External Time Base Select
 * \param psi5 pointer to PSI5 registers
 * \param channel Channel Id of PSI5 channel
 * \param triggerline External Trigger Line
 * \return None
 */
IFX_INLINE void IfxPsi5_externalTimebaseSelect(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, IfxPsi5_ExternalTrigger triggerline);

/** \brief Sets the Trigger Source for Pulse Generation (GTM/eGTM)
 * \param psi5 pointer to PSI5 registers
 * \param channel Channel Id of PSI5 channel
 * \param triggersource External Trigger select (GTM/eGTM)
 * \return None
 */
IFX_INLINE void IfxPsi5_setPulseGenerationTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, IfxPsi5_TriggerSelect triggersource);

/** \brief Sets the Trigger Source for Fractional Divider (GTM/eGTM)
 * \param psi5 pointer to PSI5 registers
 * \param triggersource External Trigger select (GTM/eGTM)
 * \return None
 */
IFX_INLINE void IfxPsi5_setFractionalDividerTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource);

/** \brief External trigger line that clears the global time stamp
 * \param psi5 pointer to PSI5 registers
 * \param triggerline External Trigger Line
 * \return None
 */
IFX_INLINE void IfxPsi5_externalTimestampClearSourceSelect(Ifx_PSI5 *psi5, IfxPsi5_ExternalTrigger triggerline);

/** \brief Enables the external trigger line selected by ECS to clear the global time stamp counter A
 * \param psi5 pointer to PSI5 registers
 * \param enable choice (enable/disable)
 * \return None
 */
IFX_INLINE void IfxPsi5_enableExternalTimestampClearA(Ifx_PSI5 *psi5, boolean enable);
 ...
 * \return None
 */
IFX_INLINE void IfxPsi5_enableExternalTimestampClearB(Ifx_PSI5 *psi5, boolean enable);

/** \brief Enables the external trigger line selected by ECS to clear the global time stamp counter C
 * \param psi5 pointer to PSI5 registers
 * \param enable choice (enable/disable)
 * \return None
 */
IFX_INLINE void IfxPsi5_enableExternalTimestampClearC(Ifx_PSI5 *psi5, boolean enable);

/** \brief Sets the Trigger Source for Time Stamp A (GTM/eGTM)
 * \param psi5 pointer to PSI5 registers
 * \param triggersource External Trigger select (GTM/eGTM)
 * \return None
 */
IFX_INLINE void IfxPsi5_setTimestampATriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource);
 ...
 * \return None
 */
IFX_INLINE void IfxPsi5_setTimestampBTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource);

/** \brief Sets the Trigger Source for Time Stamp C (GTM/eGTM)
 * \param psi5 pointer to PSI5 registers
 * \param triggersource External Trigger select (GTM/eGTM)
 * \return None
 */
IFX_INLINE void IfxPsi5_setTimestampCTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource);
...
/** \brief Configures access to all masters to all the PSI5 in the device
 * \param apConfig config pointer to configuration structure.
 * \return None
 */
IFX_EXTERN void IfxPsi5_configureAccessToPsi5(IfxApApu_ApuConfig *apConfig);
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxPsi5_getSrcPointer(Ifx_PSI5 *psi5, IfxPsi5_InterruptServiceRequest intRequest)
{
    ...
    return &MODULE_SRC.PSI5.SR[intRequest];
}
...
IFX_INLINE void IfxPsi5_enableExternalTrigger(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, boolean enable)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->CH[channel].PGC.B.ETE = enable ? 1 : 0;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
...
IFX_INLINE void IfxPsi5_enableExternalTriggerBypass(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, boolean enable)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->CH[channel].PGC.B.BYP = enable ? 1 : 0;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
...
IFX_INLINE void IfxPsi5_externalTimebaseSelect(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, IfxPsi5_ExternalTrigger triggerline)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->CH[channel].PGC.B.ETB = triggerline;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
...
IFX_INLINE void IfxPsi5_setPulseGenerationTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, IfxPsi5_TriggerSelect triggersource)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->CH[channel].PGC.B.TRIGSEL = triggersource;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
...
IFX_INLINE void IfxPsi5_setFractionalDividerTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->FDRT.B.TRIGSEL = triggersource;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
...
IFX_INLINE void IfxPsi5_setTimestampATriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->TSRA.B.TRIGSEL = triggersource;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
...
IFX_INLINE void IfxPsi5_setTimestampBTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->TSRB.B.TRIGSEL = triggersource;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
...
IFX_INLINE void IfxPsi5_setTimestampCTriggerSource(Ifx_PSI5 *psi5, IfxPsi5_TriggerSelect triggersource)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_config);
#endif
    psi5->TSRC.B.TRIGSEL = triggersource;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&psi5->PROTE, IfxApProt_State_run);
#endif
}
