...
typedef struct
{
    ...
    IfxPsi5_ExternalTrigger externalTimeBaseSelect;           /**< \brief Specifies the clock source for CTV in the case of external */
    ...
    IfxPsi5_ExternalTrigger externalTriggerSelect;            /**< \brief Specifies the trigger source in case of external triggerring */
    uint32                  blankoutTime;                     /**< \brief Specifies the duration of blank out period */
    IfxPsi5_TriggerSelect   triggersource;                    /**< \brief Specifies the External Trigger Source GTM/eGTM */
...
typedef struct
{
    IfxPsi5_ExternalTrigger externalTimeBaseSelect;       /**< \brief Specifies the clock base for counter CTS in the case of external */
