 ...
 */
IFX_EXTERN boolean IfxXspi_Spi_write_address_data(IfxXspi_Spi_ReadWriteConfig *config, uint32 address, uint16 data);

/** \brief API to read the data received from xSPI flash device
 * \param config configuration structure of the transfer module
 * \return Returns write status
 */
IFX_EXTERN boolean IfxXspi_Spi_read_address_data(IfxXspi_Spi_ReadWriteConfig *config, uint32 address, uint32 *data);
