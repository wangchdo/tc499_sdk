 ...
 *     dreConfig.numberOfCanInputBuffers = 1; //Size is 1
 *     dreConfig.inputDataSize = IfxDre_DataFieldSize_8; //8 bytes of data
 *
 *     //Configuring COBUF
 *     dreConfig.canOutputBufferStartAddress = 0x180;
 *     dreConfig.numberOfCanOutputBuffers = 1; //Size is 1
 *     dreConfig.outputDataSize = IfxDre_DataFieldSize_8; //8 bytes of data
 *
 ...
 *     dreConfig.ethernetOutputBuffer0.timer.clock            = IfxDre_TriggerClock_fSRI; //To use, set triggerMode to IfxDre_TriggerMode_timeTriggered.
...
{
    Ifx_DRE                       *dre;                               /**< \brief Specifies the pointer to the DRE registers */
    uint16                         canInputBufferStartAddress;        /**< \brief 64 bit aligned Start address offset from the DRE RAM Base address */
    uint8                          numberOfCanInputBuffers;           /**< \brief Number of buffers (0-32). 0: None, 32: Max 32 buffers. IFX_CFG_TC49A_DELTA: Only valid config option is 32 */
    IfxDre_DataFieldSize           inputDataSize;                     /**< \brief Size of Can Input Data Size, IFX_CFG_TC49A_DELTA: Only valid config option is 64 bytes of data field */
    uint16                         canOutputBufferStartAddress;       /**< \brief 64 bit aligned Start address offset from the DRE RAM Base address */
    uint8                          numberOfCanOutputBuffers;          /**< \brief Number of buffers (0-64). 0: None, 64: Max 64 buffers. IFX_CFG_TC49A_DELTA: Only valid config option is 64 */
    IfxDre_DataFieldSize           outputDataSize;                    /**< \brief Size of Can Output Data Size, IFX_CFG_TC49A_DELTA: Only valid config option is 64 bytes of data field */
    IfxDre_RoutingTableConfig      rt0Config;                         /**< \brief Configuration for Routing Table 0 */
    IfxDre_RoutingTableConfig      rt1Config;                         /**< \brief Configuration for Routing Table 1, IFX_CFG_TC49A_DELTA H/W Descoped Feature */
    IfxDre_RoutingTableConfig      rt2Config;                         /**< \brief Configuration for Routing Table 2, IFX_CFG_TC49A_DELTA H/W Descoped Feature */
    IfxDre_RoutingTableConfig      rt3Config;                         /**< \brief Configuration for Routing Table 3, IFX_CFG_TC49A_DELTA H/W Descoped Feature */
...
typedef struct
{
    ...
    IfxCan_DestinationId sourceId;             /**< \brief Source ID */
    IfxDre_FilterMode    filterMode;           /**< \brief DRE Filter Mode, IFX_CFG_TC49A_DELTA H/W Descoped Feature: This field is ignored and by default only classic filter is supported. */
    uint16               canId1;               /**< \brief CAN Filter ID 1 */
    uint16               canId2;               /**< \brief CAN Filter ID 2 */
    uint8                xtdShiftLength;       /**< \brief Shift length for Extended messages, IFX_CFG_TC49A_DELTA H/W Descoped Feature, To do: Recheck needed, RTL is implemented and Verification is pending */
 ...
 * A coding example can be found in \ref IfxDre_Dre_Usage
