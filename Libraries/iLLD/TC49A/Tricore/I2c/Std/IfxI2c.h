...
/** \brief Calculates the desired baudrate
 * \param config pointer to i2c registers
 * \return None
 */
 ...
 * \return status
 *
 * A coding example can be found in \ref IfxLld_I2c_I2c_Usage using the interface API IfxI2c_I2c_read
 *
 */
 ...
 * \return status
 *
 * A coding example can be found in \ref IfxLld_I2c_I2c_Usage using the interface API IfxI2c_I2c_write
 *
 */
