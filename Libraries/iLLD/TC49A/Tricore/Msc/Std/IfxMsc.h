...
typedef enum
{
    ...
    IfxMsc_CommandFrameLength_1 = 1,      /**< \brief SRL[0:0] Shifted */
...
/** \brief Interrupt Control Register - Command Frame Slow Channel X/Y Interrupt Enable
 * Definition in Ifx_MSC.ICR.B.CSXIE and Ifx_MSC.ICR.B.CSYIE
 */
typedef enum
{
    IfxMsc_CommandFrameSlowChannelInterrupt_disabled = 0,  /**< \brief Interrupt generation disabled */
    IfxMsc_CommandFrameSlowChannelInterrupt_enabled  = 1   /**< \brief Interrupt generation enabled */
} IfxMsc_CommandFrameSlowChannelInterrupt;

/** \brief Interrupt Control Register - Command Frame Slow Channel X Interrupt Pointer
 * Definition in Ifx_MSC.ICR.B.CSXIP
 */
typedef enum
{
    IfxMsc_CommandFrameSlowChannelXInterruptNode_SR0 = 0,  /**< \brief Service request output SR0 selected */
    IfxMsc_CommandFrameSlowChannelXInterruptNode_SR1 = 1,  /**< \brief Service request output SR1 selected */
    IfxMsc_CommandFrameSlowChannelXInterruptNode_SR2 = 2,  /**< \brief Service request output SR2 selected */
    IfxMsc_CommandFrameSlowChannelXInterruptNode_SR3 = 3   /**< \brief Service request output SR3 selected */
} IfxMsc_CommandFrameSlowChannelXInterruptNode;

/** \brief Interrupt Control Register - Command Frame Slow Channel Y Interrupt Pointer
 * Definition in Ifx_MSC.ICR.B.CSYIP
 */
typedef enum
{
    IfxMsc_CommandFrameSlowChannelYInterruptNode_SR0 = 0,  /**< \brief Service request output SR0 selected */
    IfxMsc_CommandFrameSlowChannelYInterruptNode_SR1 = 1,  /**< \brief Service request output SR1 selected */
    IfxMsc_CommandFrameSlowChannelYInterruptNode_SR2 = 2,  /**< \brief Service request output SR2 selected */
    IfxMsc_CommandFrameSlowChannelYInterruptNode_SR3 = 3   /**< \brief Service request output SR3 selected */
} IfxMsc_CommandFrameSlowChannelYInterruptNode;

/** \brief Stop bits length for Command Frame of SLow Channel Frame
 * Definition in Ifx_MSC.SSC.B.CFSTOPX/Y
 */
typedef enum
{
    IfxMsc_CommandFrameStopBitLength_none = 0,  /**< \brief no stop bits */
    IfxMsc_CommandFrameStopBitLength_1    = 1,  /**< \brief 1 Stop Bit */
    IfxMsc_CommandFrameStopBitLength_2    = 2   /**< \brief 2 Stop Bit */
} IfxMsc_CommandFrameStopBitLength;
...
/** \brief Enable configuration adjustment of 0, 1 or 2 steps of 1/2 clock time-period at assertion/deassertion.
 */
typedef enum
{
    IfxMsc_EnableClockAdjustment_default = 0,  /**< \brief Default Configuration */
    IfxMsc_EnableClockAdjustment_type1   = 1,  /**< \brief 1 Step of 1/2 clock period before edge adjustment */
    IfxMsc_EnableClockAdjustment_type2   = 2,  /**< \brief 2 Steps of 1/2 clock period before edge adjustment */
    IfxMsc_EnableClockAdjustment_type3   = 3,  /**< \brief 1 Step of 1/2 clock period after edge adjustment */
    IfxMsc_EnableClockAdjustment_type4   = 4   /**< \brief 2 Steps of 1/2 clock period after edge adjustment */
} IfxMsc_EnableClockAdjustment;
...
/** \brief Enable Manchester Code\n
 * Definition in Ifx_MSC.SSC.B.MCT
 */
typedef enum
{
    IfxMsc_ManchesterCode_disabled = 0,  /**< \brief Manchester Code is disabled */
    IfxMsc_ManchesterCode_enabled  = 1   /**< \brief Manchester Code is enabled */
} IfxMsc_ManchesterCode;
...
/** \brief Number of Bits shifted at command frames
 * Definition in Ifx_MSC.SSC.B.CFLX/Y
 */
typedef enum
{
    IfxMsc_SlowChannelCommandFrameLength_0  = 0,   /**< \brief No bit shifted */
    IfxMsc_SlowChannelCommandFrameLength_1  = 1,   /**< \brief 1 bit Shifted */
    IfxMsc_SlowChannelCommandFrameLength_2  = 2,   /**< \brief 2 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_3  = 3,   /**< \brief 3 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_4  = 4,   /**< \brief 4 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_5  = 5,   /**< \brief 5 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_6  = 6,   /**< \brief 6 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_7  = 7,   /**< \brief 7 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_8  = 8,   /**< \brief 8 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_9  = 9,   /**< \brief 9 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_10 = 10,  /**< \brief 10 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_11 = 11,  /**< \brief 11 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_12 = 12,  /**< \brief 12 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_13 = 13,  /**< \brief 13 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_14 = 14,  /**< \brief 14 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_15 = 15,  /**< \brief 15 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_16 = 16,  /**< \brief 16 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_17 = 17,  /**< \brief 17 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_18 = 18,  /**< \brief 18 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_19 = 19,  /**< \brief 19 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_20 = 20,  /**< \brief 20 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_21 = 21,  /**< \brief 21 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_22 = 22,  /**< \brief 22 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_23 = 23,  /**< \brief 23 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_24 = 24,  /**< \brief 24 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_25 = 25,  /**< \brief 25 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_26 = 26,  /**< \brief 26 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_27 = 27,  /**< \brief 27 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_28 = 28,  /**< \brief 28 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_29 = 29,  /**< \brief 29 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_30 = 30,  /**< \brief 30 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_31 = 31,  /**< \brief 31 bits Shifted */
    IfxMsc_SlowChannelCommandFrameLength_32 = 32   /**< \brief 32 bits Shifted */
} IfxMsc_SlowChannelCommandFrameLength;

/** \brief Length of Slow Channel Frame\n
 * Definition in Ifx_MSC.SSC.B.SCL0/1
 */
typedef enum
{
    IfxMsc_SlowChannelLength_0  = 0,  /**< \brief Length is 0 */
    IfxMsc_SlowChannelLength_1  = 1,  /**< \brief Length is 1 */
    IfxMsc_SlowChannelLength_2  = 2,  /**< \brief Length is 2 */
    IfxMsc_SlowChannelLength_4  = 3,  /**< \brief Length is 4 */
    IfxMsc_SlowChannelLength_8  = 4,  /**< \brief Length is 8 */
    IfxMsc_SlowChannelLength_16 = 5,  /**< \brief Length is 16 */
    IfxMsc_SlowChannelLength_32 = 6   /**< \brief Length is 32 */
} IfxMsc_SlowChannelLength;

/** \brief Parity of SLow Channel Frame\n
 * Definition in Ifx_MSC.SSC.B.PC0/1
 */
typedef enum
{
    IfxMsc_SlowChannelParity_parityOff  = 0,  /**< \brief Parity is OFF */
    IfxMsc_SlowChannelParity_evenParity = 1,  /**< \brief Even Parity is ON */
    IfxMsc_SlowChannelParity_oddParity  = 2   /**< \brief Odd Parity is ON */
} IfxMsc_SlowChannelParity;
...
/** \brief Interrupt Control Register - Time Frame Manchester Code Interrupt Enable
 * Definition in Ifx_MSC.ICR.B.TFMIE
 */
typedef enum
{
    IfxMsc_TimeFrameManchesterCodeInterrupt_disabled = 0,  /**< \brief Interrupt generation disabled */
    IfxMsc_TimeFrameManchesterCodeInterrupt_enabled  = 1   /**< \brief Interrupt generation enabled */
} IfxMsc_TimeFrameManchesterCodeInterrupt;

/** \brief Interrupt Control Register - Time Frame Manchester Code Interrupt Pointer
 * Definition in Ifx_MSC.ICR.B.TFMIP
 */
typedef enum
{
    IfxMsc_TimeFrameManchesterCodeInterruptNode_SR0 = 0,  /**< \brief Service request output SR0 selected */
    IfxMsc_TimeFrameManchesterCodeInterruptNode_SR1 = 1,  /**< \brief Service request output SR1 selected */
    IfxMsc_TimeFrameManchesterCodeInterruptNode_SR2 = 2,  /**< \brief Service request output SR2 selected */
    IfxMsc_TimeFrameManchesterCodeInterruptNode_SR3 = 3   /**< \brief Service request output SR3 selected */
} IfxMsc_TimeFrameManchesterCodeInterruptNode;
...
/** \brief Select the Timer for Alternative Input
 * Definition in Ifx_MSC.DSC.B.ALTSEL
 */
typedef enum
{
    IfxMsc_TriggerSource_gtm  = 0, /**< \brief GTM input is selected */
    IfxMsc_TriggerSource_eGtm = 1  /**< \brief eGTM input is selected */
} IfxMsc_TriggerSource;
...
/** \brief Slow Channel Manchester Code Configuration
 */
typedef struct
{
    IfxMsc_ManchesterCode enable;       /**< \brief Enable/Disable Manchester Coding */
} IfxMsc_ManchesterConfig;

/** \brief PROT and APU Configuration
 */
typedef struct
{
    IfxApProt_ProtConfig proteConfig;        /**< \brief PROTE Config */
    IfxApProt_ProtConfig protseConfig;       /**< \brief PROTSE Config */
...
/** \brief Slow Channel Configuration
 */
typedef struct
{
    IfxMsc_ManchesterConfig              manchesterConfig;              /**< \brief Manchester Code Configuration */
    IfxMsc_SlowChannelCommandFrameLength totalCommandLengthX;           /**< \brief Length of Command Frame for Slave X */
    IfxMsc_SlowChannelCommandFrameLength totalCommandLengthY;           /**< \brief Length of Command Frame for Slave Y */
    IfxMsc_SlowChannelLength             slowChannelFrameLengthX;       /**< \brief Length of Slow Channel for Slave X, must be less than or equal to totalCommandLengthX */
    IfxMsc_SlowChannelLength             slowChannelFrameLengthY;       /**< \brief Length of Slow Channel for Slave Y, must be less than or equal to totalCommandLength */
    IfxMsc_SlowChannelParity             parityX;                       /**< \brief Type of Parity for Slave X */
    IfxMsc_SlowChannelParity             parityY;                       /**< \brief Type of Parity for Slave Y */
    IfxMsc_CommandFrameStopBitLength     stopBitX;                      /**< \brief Length of Stop bits for Command Frame of Slave X */
    IfxMsc_CommandFrameStopBitLength     stopBitY;                      /**< \brief Length of Stop bits for Command Frame of Slave Y */
} IfxMsc_SlowChannelConfig;
...
/** \brief Returns the upstream baudrate. Pre-requisite: Upstream is enabled and URR is non zero.
 * \param msc Pointer to MSC SFR base address
 * \return Returns the upstream baudrate.
 */
IFX_EXTERN float32 IfxMsc_getUpstreamBaudrate(Ifx_MSC *msc);
...
/** \brief Returns the Recieve Data Interrupt Flag Status
 * \param msc pointer to the base of MSC registers
 * \return Status
 */
...
/** \brief Enable Slow Channel in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \return None
 */
IFX_INLINE void IfxMsc_enableSlowChannel(Ifx_MSC *msc);

/** \brief Disable Slow Channel in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \return None
 */
IFX_INLINE void IfxMsc_disableSlowChannel(Ifx_MSC *msc);

/** \brief Configure Slow Channel Command Frame Length for Slave X in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \param length Total Length of Slave X Command Frame
 * \return None
 */
IFX_INLINE void IfxMsc_setSlowChannelCommandFrameLengthSlaveX(Ifx_MSC *msc, IfxMsc_SlowChannelCommandFrameLength length);

/** \brief Configure Slow Channel Command Frame Length for Slave Y in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \param length Total Length of Slave Y Command Frame
 * \return None
 */
IFX_INLINE void IfxMsc_setSlowChannelCommandFrameLengthSlaveY(Ifx_MSC *msc, IfxMsc_SlowChannelCommandFrameLength length);

/** \brief Returns Slow Channel Command Frame Length for Slave X in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \return Length of Slave X Command Frame
 */
IFX_INLINE IfxMsc_SlowChannelCommandFrameLength IfxMsc_getSlowChannelCommandFrameLengthSlaveX(Ifx_MSC *msc);

/** \brief Returns Slow Channel Command Frame Length for Slave Y in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \return Length of Slave Y Command Frame
 */
IFX_INLINE IfxMsc_SlowChannelCommandFrameLength IfxMsc_getSlowChannelCommandFrameLengthSlaveY(Ifx_MSC *msc);

/** \brief Configure Slow Channel Frame Length for Slave X in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \param length Length of Command Bits (Subset of Total Command Length CFLX) per Data Frame for Slave X
 * \return None
 */
IFX_INLINE void IfxMsc_setSlowChannelLengthSlaveX(Ifx_MSC *msc, IfxMsc_SlowChannelLength length);

/** \brief Configure Slow Channel Frame Length for Slave Y in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \param length Length of Command Bits (Subset of Total Command Length CFLY) per Data Frame for Slave Y
 * \return None
 */
IFX_INLINE void IfxMsc_setSlowChannelLengthSlaveY(Ifx_MSC *msc, IfxMsc_SlowChannelLength length);

/** \brief Returns Slow Channel Length for Slave X in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \return Length of Slow Channel Bits for Slave X
 */
IFX_INLINE IfxMsc_SlowChannelLength IfxMsc_getSlowChannelLengthSlaveX(Ifx_MSC *msc);

/** \brief Returns Slow Channel Length for Slave Y in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \return Length of Slow Channel Bits for Slave Y
 */
IFX_INLINE IfxMsc_SlowChannelLength IfxMsc_getSlowChannelLengthSlaveY(Ifx_MSC *msc);

/** \brief Configure Slow Channel Parity for Slave X in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \param parity Type of Parity for Slave X
 * \return None
 */
IFX_INLINE void IfxMsc_setSlowChannelParitySlaveX(Ifx_MSC *msc, IfxMsc_SlowChannelParity parity);

/** \brief Configure Slow Channel Parity for Slave Y in Slow Channel Configuration Register
 * \param msc Pointer to MSC SFR base address
 * \param parity Type of Parity for Slave Y
 * \return None
 */
IFX_INLINE void IfxMsc_setSlowChannelParitySlaveY(Ifx_MSC *msc, IfxMsc_SlowChannelParity parity);

/** \brief Configure Data Frame Passive Phase Length in Downstream Control Register
 * \param msc Pointer to MSC SFR base address
 * \param length Length of Passive Phase in Data Frame
 * \return None
 */
IFX_INLINE void IfxMsc_setDataFramePassivePhaseLength(Ifx_MSC *msc, IfxMsc_DataFramePassivePhaseLength length);

/** \brief Configure Command Frame Passive Phase Length in Downstream Timing Extension Register
 * \param msc Pointer to MSC SFR base address
 * \param length Length of Passive Phase in Command Frame
 * \return None
 */
IFX_INLINE void IfxMsc_setCommandFramePassivePhaseLength(Ifx_MSC *msc, IfxMsc_ControlFrameExtensionPassivePhaseLength length);

/** \brief Clears Command Frame Slow Channel X Interrupt Flag
 * \param msc pointer to the base of MSC registers
 * \return None
 */
IFX_INLINE void IfxMsc_clearSlowChannelXInterruptFlag(Ifx_MSC *msc);

/** \brief Clears Command Frame Slow Channel Y Interrupt Flag
 * \param msc pointer to the base of MSC registers
 * \return None
 */
IFX_INLINE void IfxMsc_clearSlowChannelYInterruptFlag(Ifx_MSC *msc);

/** \brief Time Frame Manchester Code Interrupt Flag
 * \param msc pointer to the base of MSC registers
 * \return None
 */
IFX_INLINE void IfxMsc_clearManchesterCodeInterruptFlag(Ifx_MSC *msc);

/** \brief Returns the Command Frame Slow Channel X Interrupt Flag Status
 * \param msc pointer to the base of MSC registers
 * \return Status
 */
IFX_INLINE boolean IfxMsc_getSlowChannelXInterruptFlag(Ifx_MSC *msc);

/** \brief Returns the Command Frame Slow Channel Y Interrupt Flag Status
 * \param msc pointer to the base of MSC registers
 * \return Status
 */
IFX_INLINE boolean IfxMsc_getSlowChannelYInterruptFlag(Ifx_MSC *msc);

/** \brief Returns the Time Frame Manchester Code Interrupt Flag Status
 * \param msc pointer to the base of MSC registers
 * \return Status
 */
IFX_INLINE boolean IfxMsc_getManchesterCodeInterruptFlag(Ifx_MSC *msc);
...
/** \brief Returns the relevant downstream baudrate based on ABB configuration
 * \param msc Pointer to MSC SFR base address
 * \return Returns the downstream baudrate.
 */
IFX_EXTERN float32 IfxMsc_getDownstreamBaudrate(Ifx_MSC *msc);

/** \brief Configure Manchester Coding
 * \param msc Pointer to MSC SFR base address
 * \param manConfig Pointer to Manchester Configuration Structure
 * \return None
 */
IFX_EXTERN void IfxMsc_setManchesterCoding(Ifx_MSC *msc, IfxMsc_ManchesterConfig *manConfig);

/** \brief Configure Slow Channel
 * Use IfxMsc_manualloadCxModeCommand to load command Frame data after configuring Slow Channel.
 * Writting Command data to DCE and DC registers will initiate slow channel transfer immediately.
 * \param msc Pointer to MSC SFR base address
 * \param slowChannelConfig Pointer to Slow Channel Configuration Structure
 * \return None
 */
IFX_EXTERN void IfxMsc_setSlowChannel(Ifx_MSC *msc, const IfxMsc_SlowChannelConfig *slowChannelConfig);

/** \brief Configure Enable Clock Adjustment for Falling Edge
 * Take care of passive phase if using deassertion
 * \param msc Pointer to MSC SFR base address
 * \param enX Target to be selected (Enable Line)
 * \param adjustment Clock adjustment Value
 * \return None
 */
IFX_EXTERN void IfxMsc_setEnableXDeassertion(Ifx_MSC *msc, IfxMsc_Target enX, IfxMsc_EnableClockAdjustment adjustment);

/** \brief Configure Enable Clock Adjustment for Rising Edge
 * Take care of passive phase if using Assertion
 * \param msc Pointer to MSC SFR base address
 * \param enX Target to be selected (Enable Line)
 * \param adjustment Clock adjustment Value
 * \return None
 */
IFX_EXTERN void IfxMsc_setEnableXAssertion(Ifx_MSC *msc, IfxMsc_Target enX, IfxMsc_EnableClockAdjustment adjustment);

/** \brief Initialize the AP with default config
 * \param config Pointer to the AP config
 * \return None
 */
IFX_EXTERN void IfxMsc_initApConfig(IfxMsc_ApConfig *config);

/** \brief Initialize the AP
 * \param msc MSC module pointer
 * \param config AP config pointer
 * \return None
 */
IFX_EXTERN void IfxMsc_initAp(Ifx_MSC *msc, IfxMsc_ApConfig *config);

/** \brief Configures access to all masters to all the MSCs in the device
 * \param apConfig config pointer to configuration structure.
 * \return None
 */
IFX_EXTERN void IfxMsc_configureAccessToMscs(IfxApApu_ApuConfig *apConfig);
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxMsc_getSrcPointer(Ifx_MSC *msc, IfxMsc_InterruptServiceRequest intRequest)
{
    ...
    src      = &MODULE_SRC.MSC[mscIndex].SR[intRequest];
    return src;
}
...
IFX_INLINE void IfxMsc_setSlowChannelCommandFrameLengthSlaveX(Ifx_MSC *msc, IfxMsc_SlowChannelCommandFrameLength length)
{
    /*Set Total Length of Command Frame in SCC for Slave 0*/
    msc->SCC.B.CFLX = length;
}


IFX_INLINE void IfxMsc_setSlowChannelCommandFrameLengthSlaveY(Ifx_MSC *msc, IfxMsc_SlowChannelCommandFrameLength length)
{
    /*Set Total Length of Command Frame in SCC for Slave 1*/
    msc->SCC.B.CFLY = length;
}


IFX_INLINE IfxMsc_SlowChannelCommandFrameLength IfxMsc_getSlowChannelCommandFrameLengthSlaveX(Ifx_MSC *msc)
{
    /*Get Total Length of Command Frame in SCC for Slave 0*/
    return (IfxMsc_SlowChannelCommandFrameLength)msc->SCC.B.CFLX;
}


IFX_INLINE IfxMsc_SlowChannelCommandFrameLength IfxMsc_getSlowChannelCommandFrameLengthSlaveY(Ifx_MSC *msc)
{
    /*Get Total Length of Command Frame in SCC for Slave 1*/
    return (IfxMsc_SlowChannelCommandFrameLength)msc->SCC.B.CFLY;
}


IFX_INLINE void IfxMsc_setSlowChannelLengthSlaveX(Ifx_MSC *msc, IfxMsc_SlowChannelLength length)
{
    /*Set Slow Channel Length in SCC for Slave 0*/
    msc->SCC.B.SCLX = length;
}


IFX_INLINE void IfxMsc_setSlowChannelLengthSlaveY(Ifx_MSC *msc, IfxMsc_SlowChannelLength length)
{
    /*Set Slow Channel Length in SCC for Slave 1*/
    msc->SCC.B.SCLY = length;
}


IFX_INLINE IfxMsc_SlowChannelLength IfxMsc_getSlowChannelLengthSlaveX(Ifx_MSC *msc)
{
    /*  Return Slow Channel Length for Slave 0*/
    return (IfxMsc_SlowChannelLength)msc->SCC.B.SCLX;
}


IFX_INLINE IfxMsc_SlowChannelLength IfxMsc_getSlowChannelLengthSlaveY(Ifx_MSC *msc)
{
    /*  Return Slow Channel Length for Slave 1*/
    return (IfxMsc_SlowChannelLength)msc->SCC.B.SCLY;
}


IFX_INLINE void IfxMsc_setSlowChannelParitySlaveX(Ifx_MSC *msc, IfxMsc_SlowChannelParity parity)
{
    /*Set Slow Channel Parity in SCC for Slave 0*/
    msc->SCC.B.PCX = parity;
}


IFX_INLINE void IfxMsc_setSlowChannelParitySlaveY(Ifx_MSC *msc, IfxMsc_SlowChannelParity parity)
{
    /*Set Slow Channel Parity in SCC for Slave 1*/
    msc->SCC.B.PCY = parity;
}


IFX_INLINE void IfxMsc_setDataFramePassivePhaseLength(Ifx_MSC *msc, IfxMsc_DataFramePassivePhaseLength length)
{
    /*Set Data Frame Passive Phase Length*/
    msc->DSC.B.PPD = length;
}


IFX_INLINE void IfxMsc_setCommandFramePassivePhaseLength(Ifx_MSC *msc, IfxMsc_ControlFrameExtensionPassivePhaseLength length)
{
    /*Set Command Frame Passive Phase Length*/
    if (length > IfxMsc_ControlFrameExtensionPassivePhaseLength_63)
    {
        //MSB extension is enabled
        msc->DSTE.B.PPCEM = 1;
        msc->DSTE.B.PPCE  = length - 64;
    }
    else
    {
        //MSB extension is disabled
        msc->DSTE.B.PPCEM = 0;
        msc->DSTE.B.PPCE  = length;
    }
}
...
IFX_INLINE boolean IfxMsc_getSlowChannelXInterruptFlag(Ifx_MSC *msc)
{
    return msc->ISR.B.CSXI;
}


IFX_INLINE boolean IfxMsc_getSlowChannelYInterruptFlag(Ifx_MSC *msc)
{
    return msc->ISR.B.CSYI;
}


IFX_INLINE boolean IfxMsc_getManchesterCodeInterruptFlag(Ifx_MSC *msc)
{
    return msc->ISR.B.TFMI;
}
