...
typedef struct
{
    ...
    IfxMsc_TriggerSource                    timerSelection;                        /**< \brief Specifies the Timer used */
    boolean                                 dataFramePriority;                     /**< \brief Disable/Enable Data Frame over Command Frame Prioritization */
...
typedef struct
{
    ...
    IfxMsc_CommandFrameSlowChannelXInterruptNode slowChannelXInterruptNode;                  /**< \brief Specifies the Command Frame Slow Channel X Interrupt Node */
    IfxMsc_CommandFrameSlowChannelInterrupt      slowChannelXInterrupt;                      /**< \brief Specifies the Command Frame Slow Channel X Interrupt Mode */
    IfxMsc_CommandFrameSlowChannelYInterruptNode slowChannelYInterruptNode;                  /**< \brief Specifies the Command Frame Slow Channel Y Interrupt Node */
    IfxMsc_CommandFrameSlowChannelInterrupt      slowChannelYInterrupt;                      /**< \brief Specifies the Command Frame Slow Channel Y Interrupt Mode */
    IfxMsc_TimeFrameManchesterCodeInterruptNode  timeFrameManchesterCodeInterruptNode;       /**< \brief Specifies the Time Frame Manchester Code Interrupt Node */
    IfxMsc_TimeFrameManchesterCodeInterrupt      timeFrameManchesterCodeInterrupt;           /**< \brief Specifies the Time Frame Manchester Code Interrupt Mode */
...
typedef struct
{
    ...
    IfxMsc_SlowChannelConfig                    slowChannelConfig;                            /**< \brief Configuration for Slow Channel */
    boolean                                     enableSlowChannel;                            /**< \brief Specifies if Slow Channel is used */
    IfxMsc_StreamMode                           streamMode;                                   /**< \brief Configuration for Stream mode (upstream or downstream) */
} IfxMsc_Msc_Config;

/** \brief MSC Slow Channel Data and Command Configuration Structure
 */
typedef struct
{
    uint32 commandX;                /**< \brief Specifies the command for Slow Channel X to be written to DCSX */
    uint32 commandY;                /**< \brief Specifies the command for Slow Channel Y to be written to DCSY */
    uint16 dataLow;                 /**< \brief Specifies the Downstream Data for SRL Shift Register - DDL */
    uint16 dataHigh;                /**< \brief Specifies the Downstream Data for SRH Shift Register - DDH (rw) */
    uint16 dataExtensionLow;        /**< \brief Specifies the Downstream Data Extension for SRL Shift Register - DDLE */
    uint16 dataExtensionHigh;       /**< \brief Specifies the Downstream Data Extension for SRH Shift Register - DDHE */
} IfxMsc_Msc_SlowChannelDataConfig;
...
/** \brief send downstream command for Slow Channel X
 * \param msc pointer to the MSC module handle
 * \param command transmit command
 * \return None
 */
IFX_EXTERN void IfxMsc_Msc_sendCommandSlowChannelX(IfxMsc_Msc *msc, uint32 command);

/** \brief send downstream command for Slow Channel Y
 * \param msc pointer to the MSC module handle
 * \param command transmit command
 * \return None
 */
IFX_EXTERN void IfxMsc_Msc_sendCommandSlowChannelY(IfxMsc_Msc *msc, uint32 command);

/** \brief send downstream data and commands through Slow Channel
 * \param msc pointer to the MSC module handle
 * \param config configuration structure pointer containing data for registers DD, DDE, DCSX and DCSY
 * \return None
 */
IFX_EXTERN void IfxMsc_Msc_sendSlowChannelDataAndCommand(IfxMsc_Msc *msc, IfxMsc_Msc_SlowChannelDataConfig *config);
