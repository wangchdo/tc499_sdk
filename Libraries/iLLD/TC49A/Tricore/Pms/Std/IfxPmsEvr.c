...
IFX_CONST IfxPmsEvr_StepDownRegulatorRegConfig IfxPmsEvr_cfgPhase1Default[] = {
    ...
    {&PMS_EVRC_COEFF2.U, (0x23F6FFEFU), (0xFFFFFFFFU)},
    {&PMS_EVRC_COEFF3.U, (0x25F6FFAFU), (0xFFFFFFFFU)},
    {&PMS_EVRC_COEFF4.U, (0x00555845U), (0xFFFFFFFFU)},
    {&PMS_EVRC_COEFF5.U, (0x0000FFFFU), (0xFFFFFFFFU)}
};

IFX_CONST IfxPmsEvr_StepDownRegulatorRegConfig IfxPmsEvr_cfgPhase2Default[] = {
    {&PMS_EVRC_CON1.U,   (0x70A007DU),  (0xFFFFFFFFU)},
    {&PMS_EVRC_COEFF1.U, (0x2400043U),  (0xFFFFFFFFU)},
    {&PMS_EVRC_COEFF0.U, (0x9221C014U), (0xFFFFFFFFU)},
};
...
void IfxPmsEvr_configureSecondaryMonitor(Ifx_PMS *pms, IfxPmsEvr_SecondaryMonitorVoltageSource source, IfxPmsEvr_SecondaryMonitorConfig *config)
{
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddcpua:
        temp.VDDCPUACON.B.UVVAL  = (uint16)(config->underVoltage / IFXPMSEVR_VMONSADC_VDD_VDDSB_PHY012_CPUABC_PPU_PMS012_LSBMV);
        temp.VDDCPUACON.B.UVMOD  = (config->underVoltageMode);
        temp.VDDCPUACON.B.OVVAL  = (uint16)(config->overVoltage / IFXPMSEVR_VMONSADC_VDD_VDDSB_PHY012_CPUABC_PPU_PMS012_LSBMV);
        temp.VDDCPUACON.B.OVMOD  = (config->overVoltageMode);
        temp.VDDCPUACON.B.FILTER = (config->filter);
        pms->VMONS.VDDCPUACON.U  = temp.VDDCPUACON.U;
        break;
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddcpub:
        temp.VDDCPUBCON.B.UVVAL  = (uint16)(config->underVoltage / IFXPMSEVR_VMONSADC_VDD_VDDSB_PHY012_CPUABC_PPU_PMS012_LSBMV);
        temp.VDDCPUBCON.B.UVMOD  = (config->underVoltageMode);
        temp.VDDCPUBCON.B.OVVAL  = (uint16)(config->overVoltage / IFXPMSEVR_VMONSADC_VDD_VDDSB_PHY012_CPUABC_PPU_PMS012_LSBMV);
        temp.VDDCPUBCON.B.OVMOD  = (config->overVoltageMode);
        temp.VDDCPUBCON.B.FILTER = (config->filter);
        pms->VMONS.VDDCPUBCON.U  = temp.VDDCPUBCON.U;
        break;
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        temp.VDDFLEXCON.B.UVVAL  = (uint16)(config->underVoltage / IFXPMSEVR_VMONSADC_VDDEXT_VDDEVRSB_VDDM_HSIF_PHPHY012_FLEX_LSBMV);
        temp.VDDFLEXCON.B.UVMOD  = (config->underVoltageMode);
        temp.VDDFLEXCON.B.OVVAL  = (uint16)(config->overVoltage / IFXPMSEVR_VMONSADC_VDDEXT_VDDEVRSB_VDDM_HSIF_PHPHY012_FLEX_LSBMV);
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddlmu:
        temp.VDDLMUCON.B.UVVAL  = (uint16)(config->underVoltage / IFXPMSEVR_VMONSADC_VDD_VDDSB_PHY012_CPUABC_PPU_PMS012_LSBMV);
        temp.VDDLMUCON.B.UVMOD  = (config->underVoltageMode);
        temp.VDDLMUCON.B.OVVAL  = (uint16)(config->overVoltage / IFXPMSEVR_VMONSADC_VDD_VDDSB_PHY012_CPUABC_PPU_PMS012_LSBMV);
        temp.VDDLMUCON.B.OVMOD  = (config->overVoltageMode);
        temp.VDDLMUCON.B.FILTER = (config->filter);
        pms->VMONS.VDDLMUCON.U  = temp.VDDLMUCON.U;
        break;
...
void IfxPmsEvr_configurePrimaryMonitor(Ifx_PMS *pms, IfxPmsEvr_PrimaryMonitorVoltageSource source, IfxPmsEvr_PrimaryMonitorConfig *config)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddcpua:
        temp.VDDCPUACON.B.UVVAL    = (uint16)(config->underVoltage / IFXPMSEVR_VMONPADC_VDDSB_CPUABC_PPU_PHY012_LSBMV);
        temp.VDDCPUACON.B.UVENABLE = config->underVoltageEnable;
        temp.VDDCPUACON.B.OVVAL    = (uint16)(config->overVoltage / IFXPMSEVR_VMONPADC_VDDSB_CPUABC_PPU_PHY012_LSBMV);
        temp.VDDCPUACON.B.OVENABLE = config->overVoltageEnable;
        temp.VDDCPUACON.B.FILTER   = (config->filter);
        pms->VMONP.VDDCPUACON.U    = temp.VDDCPUACON.U;
        break;
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddcpub:
        temp.VDDCPUBCON.B.UVVAL    = (uint16)(config->underVoltage / IFXPMSEVR_VMONPADC_VDDSB_CPUABC_PPU_PHY012_LSBMV);
        temp.VDDCPUBCON.B.UVENABLE = config->underVoltageEnable;
        temp.VDDCPUBCON.B.OVVAL    = (uint16)(config->overVoltage / IFXPMSEVR_VMONPADC_VDDSB_CPUABC_PPU_PHY012_LSBMV);
        temp.VDDCPUBCON.B.OVENABLE = config->overVoltageEnable;
        temp.VDDCPUBCON.B.FILTER   = (config->filter);
        pms->VMONP.VDDCPUBCON.U    = temp.VDDCPUBCON.U;
        break;
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddlmu:
        temp.VDDLMUCON.B.UVVAL    = (uint16)(config->underVoltage / IFXPMSEVR_VMONPADC_VDDSB_CPUABC_PPU_PHY012_LSBMV);
        temp.VDDLMUCON.B.UVENABLE = config->underVoltageEnable;
        temp.VDDLMUCON.B.OVVAL    = (uint16)(config->overVoltage / IFXPMSEVR_VMONPADC_VDDSB_CPUABC_PPU_PHY012_LSBMV);
        temp.VDDLMUCON.B.OVENABLE = config->overVoltageEnable;
        temp.VDDLMUCON.B.FILTER   = (config->filter);
        pms->VMONP.VDDLMUCON.U    = temp.VDDLMUCON.U;
        break;
...
void IfxPmsEvr_initAp(Ifx_PMS *pms, IfxPmsEvr_ApConfig *config)
{
    /* Initialize the PROTs */
    IfxApProt_init((Ifx_PROT_PROT *)&pms->PROTE, &config->proteConfig);
    IfxApProt_init((Ifx_PROT_PROT *)&pms->PROTSE, &config->protseConfig);

    /* Change the state to CONFIG, Configure APU and set PROT state back to RUN */
    /* Initialize the APU */
    IfxApProt_setState((Ifx_PROT_PROT *)&pms->PROTSE, IfxApProt_State_config);
    IfxApApu_init((Ifx_ACCEN_ACCEN *)&pms->ACCEN, &config->apuConfig);
    IfxApProt_setState((Ifx_PROT_PROT *)&pms->PROTSE, IfxApProt_State_run);
}


void IfxPmsEvr_initApConfig(IfxPmsEvr_ApConfig *config)
{
...
boolean IfxPmsEvr_scaleEvrVoltage(Ifx_PMS *pms, IfxPmsEvr_EvrcVoltScalingConfig *config)
{
    ...
    nominalVoltage = pms->VID.CON.B.VDDNOM;
