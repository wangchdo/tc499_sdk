...
typedef enum
{
    ...
    IfxPmsPm_StandbyRamSupply_cpu0_32Kb             = 1,  /**< \brief Standby RAM (CPU0 dLMU 32kB are supplied.) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_64Kb             = 2,  /**< \brief Standby RAM (CPU0 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_128Kb            = 3,  /**< \brief Standby RAM (CPU0 dLMU 128kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu1_32Kb             = 16, /**< \brief Standby RAM (CPU1 dLMU 32kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_32Kb_cpu1_32Kb   = 17, /**< \brief Standby RAM (CPU0 dLMU 32kB and CPU1 dLMU 32kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_64Kb_cpu1_32Kb   = 18, /**< \brief Standby RAM (CPU0 dLMU 64kB and CPU1 dLMU 32kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_128Kb_cpu1_32Kb  = 19, /**< \brief Standby RAM (CPU0 dLMU 128kB and CPU1 dLMU 32kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu1_64Kb             = 32, /**< \brief Standby RAM (CPU1 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_32Kb_cpu1_64Kb   = 33, /**< \brief Standby RAM (CPU0 dLMU 32kB and CPU1 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_64Kb_cpu1_64Kb   = 34, /**< \brief Standby RAM (CPU0 dLMU 64kB and CPU1 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_128Kb_cpu1_64Kb  = 35, /**< \brief Standby RAM (CPU0 dLMU 128kB and CPU1 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu1_128Kb            = 48, /**< \brief Standby RAM (CPU1 dLMU 128kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_32Kb_cpu1_128Kb  = 49, /**< \brief Standby RAM (CPU0 dLMU 32kB and CPU1 dLMU 128kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_64Kb_cpu1_128Kb  = 50, /**< \brief Standby RAM (CPU0 dLMU 64kB and CPU1 dLMU 128kB are supplied) is supplied */
...
typedef struct
{
    IfxPmsPm_PowerDown cpuA;        /**< \brief Enable/Disable power down of CPUA power domain */
    IfxPmsPm_PowerDown cpuB;        /**< \brief Enable/Disable power down of CPUB power domain */
    IfxPmsPm_PowerDown ppu;         /**< \brief Enable/Disable power down of PPU power domain */
    IfxPmsPm_PowerDown ememA;       /**< \brief Enable/Disable power down of EMEMA power domain. */
    IfxPmsPm_PowerDown ememB;       /**< \brief Enable/Disable power down of EMEMB power domain. */
    IfxPmsPm_PowerDown ememC;       /**< \brief Enable/Disable power down of EMEMC power domain. */
    IfxPmsPm_PowerDown ememD;       /**< \brief Enable/Disable power down of EMEMD power domain. */
...
typedef struct
{
    ...
    IfxPmsPm_PowerSwitchCLockDivider cpuClkDivider;        /**< \brief CPU power switch rate clock divider. */
    IfxPmsPm_PowerSwitchCLockDivider ppuClkDivider;        /**< \brief PPU power switch rate clock divider */
    IfxPmsPm_PowerSwitchCLockDivider ememClkDivider;       /**< \brief EMEM power switch rate clock divider */
...
IFX_INLINE boolean IfxPmsPm_getDtsStatus(Ifx_PMS *pms)
{
    return (boolean)(pms->DTS.STAT.B.READY);
}
