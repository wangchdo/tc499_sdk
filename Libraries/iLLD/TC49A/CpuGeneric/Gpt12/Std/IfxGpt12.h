...
typedef enum
{
    ...
    IfxGpt12_CaptureInput_B0 = 4,  /**< \brief signal CAPINB0 selected */
    IfxGpt12_CaptureInput_B1 = 5,  /**< \brief signal CAPINB1 selected */
    IfxGpt12_CaptureInput_B2 = 6,  /**< \brief signal CAPINB2 selected */
    IfxGpt12_CaptureInput_B3 = 7   /**< \brief signal CAPINB3 selected */
...
typedef enum
{
    ...
    IfxGpt12_Input_D0 = 4,  /**< \brief signal TXIND0 selected */
    IfxGpt12_Input_D1 = 5   /**< \brief signal TXIND1 selected */
} IfxGpt12_Input;
 ...
 * \return None
 */
IFX_INLINE void IfxGpt12_initCapInPin(const IfxGpt12_Capin_In *capIn, IfxPort_InputMode inputMode);
 ...
 * \return None
 */
IFX_INLINE void IfxGpt12_initCapInPinWithPadLevel(const IfxGpt12_Capin_In *capIn, IfxPort_InputMode inputMode, IfxPort_PadDriver padDriver);
...
/** \brief API to get the resource index of the GPT12 specified.
 * \param gpt12 GPT12 Module pointer
 * \return GPT12 resource index
 */
IFX_EXTERN IfxGpt12_Index IfxGpt12_getIndex(Ifx_GPT12 *gpt12);
 ...
 * \return None
 */
IFX_EXTERN void IfxGpt12_initApConfig(IfxGpt12_ApConfig *config);
 ...
 * \return None
 */
IFX_EXTERN void IfxGpt12_initAp(Ifx_GPT12 *gpt12, IfxGpt12_ApConfig *config);

/** \brief Configures access to all masters to all the GTP12s in the device
 * \param apConfig pointer to configuration structure.
 * \return None
 */
IFX_EXTERN void IfxGpt12_configureAccessToGpt12s(IfxApApu_ApuConfig *apConfig);
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T2_getSrc(Ifx_GPT12 *gpt12)
{
    return (volatile Ifx_SRC_SRCR *)(&MODULE_SRC.GPT12[IfxGpt12_getIndex(gpt12)].T2);
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T3_getSrc(Ifx_GPT12 *gpt12)
{
    return (volatile Ifx_SRC_SRCR *)(&MODULE_SRC.GPT12[IfxGpt12_getIndex(gpt12)].T3);
}
...
IFX_INLINE void IfxGpt12_T3_setInput(Ifx_GPT12 *gpt12, IfxGpt12_Input input)
{
    IFX_ASSERT(IFX_VERBOSE_LEVEL_ERROR, input != 3); /* wrong selection  */

    if (input <= IfxGpt12_Input_C)
    {
        gpt12->PISEL.B.IST3IN = input;
    }
    /*configure for Port Input Select Register T3IND, input range T3IND0 to T3IND1 (4 to 5) */
    else
    {
        gpt12->PISEL.B.IST3IN   = 3U;
        gpt12->PISELB.B.IST3IND = input - IfxGpt12_Input_D0;
    }
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T4_getSrc(Ifx_GPT12 *gpt12)
{
    return (volatile Ifx_SRC_SRCR *)(&MODULE_SRC.GPT12[IfxGpt12_getIndex(gpt12)].T4);
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T5_getSrc(Ifx_GPT12 *gpt12)
{
    return (volatile Ifx_SRC_SRCR *)(&MODULE_SRC.GPT12[IfxGpt12_getIndex(gpt12)].T5);
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T6_getSrc(Ifx_GPT12 *gpt12)
{
    return (volatile Ifx_SRC_SRCR *)(&MODULE_SRC.GPT12[IfxGpt12_getIndex(gpt12)].T6);
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_getCaptureSrc(Ifx_GPT12 *gpt12)
{
    return (volatile Ifx_SRC_SRCR *)(&MODULE_SRC.GPT12[IfxGpt12_getIndex(gpt12)].CIRQ);
}
...
IFX_INLINE float32 IfxGpt12_getModuleFrequency(Ifx_GPT12 *gpt12)
{
    ...
    return (float32)IfxClock_getSpbFrequency();
}
...
IFX_INLINE void IfxGpt12_setCaptureInput(Ifx_GPT12 *gpt12, IfxGpt12_CaptureInput input)
{
    if (input <= IfxGpt12_CaptureInput_D)
    {
        gpt12->PISEL.B.ISCAPIN = input;
    }
    /* configure for Port Input Select Register CAPINB, input range CAPINBx ( x = 4 to 7) */
    else
    {
        gpt12->PISEL.B.ISCAPIN   = 1U;
        gpt12->PISELB.B.ISCAPINB = input - 4;
    }
}
