...
void IfxFce_initApConfig(IfxFce_ApConfig *config)
{
...
void IfxFce_initAp(Ifx_FCE *fce, IfxFce_ApConfig *config)
{
    /* Initialize the PROTs */
    IfxApProt_init((Ifx_PROT_PROT *)&fce->PROTE, &config->proteConfig);
    IfxApProt_init((Ifx_PROT_PROT *)&fce->PROTSE, &config->protseConfig);

    /* Change the state to CONFIG, Configure APU and set PROT state back to RUN */
    /* Initialize the APU */
    IfxApProt_setState((Ifx_PROT_PROT *)&fce->PROTSE, IfxApProt_State_config);
    IfxApApu_init((Ifx_ACCEN_ACCEN *)&fce->ACCEN, &config->apuConfig);
    IfxApProt_setState((Ifx_PROT_PROT *)&fce->PROTSE, IfxApProt_State_run);
}
