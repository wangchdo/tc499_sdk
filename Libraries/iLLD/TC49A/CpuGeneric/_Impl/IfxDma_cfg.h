...
/** \brief Error mask for RP source error
 */
#define IFXDMA_ERROR_S      (IFX_DMA_RP_CLRE_CSER_MSK << IFX_DMA_RP_CLRE_CSER_OFF)

/** \brief Error mask for RP destination error
 */
#define IFXDMA_ERROR_D      (IFX_DMA_RP_CLRE_CDER_MSK << IFX_DMA_RP_CLRE_CDER_OFF)

/** \brief Error mask for RP TCS Configuration error
 */
#define IFXDMA_ERROR_TCSC   (IFX_DMA_RP_CLRE_CTCSCER_MSK << IFX_DMA_RP_CLRE_CTCSCER_OFF)

/** \brief Error mask for bus error on SPB
 */
#define IFXDMA_ERROR_SPB    (IFX_DMA_RP_CLRE_CSPBER_MSK << IFX_DMA_RP_CLRE_CSPBER_OFF)

/** \brief Error mask for bus error on SRI
 */
#define IFXDMA_ERROR_SRI    (IFX_DMA_RP_CLRE_CSRIER_MSK << IFX_DMA_RP_CLRE_CSRIER_OFF)

/** \brief Error mask for RAM error
 */
#define IFXDMA_ERROR_RAM    (IFX_DMA_RP_CLRE_CRAMER_MSK << IFX_DMA_RP_CLRE_CRAMER_OFF)

/** \brief Error mask for DLL (failed linked list load) error
 */
#define IFXDMA_ERROR_DLL    (IFX_DMA_RP_CLRE_CDLLER_MSK << IFX_DMA_RP_CLRE_CDLLER_OFF)

/** \brief Error mask for CLL (checked linked list ) error
 */
#define IFXDMA_ERROR_CLL    (IFX_DMA_RP_CLRE_CCLLER_MSK << IFX_DMA_RP_CLRE_CCLLER_OFF)

/** \brief Error mask for CPB error
 */
#define IFXDMA_ERROR_CPB    (IFX_DMA_RP_CLRE_CCPBER_MSK << IFX_DMA_RP_CLRE_CCPBER_OFF)

/** \brief Error mask for Double buffer TRL error
 */
#define IFXDMA_ERROR_DBTRL  (IFX_DMA_RP_CLRE_CDBTRLER_MSK << IFX_DMA_RP_CLRE_CDBTRLER_OFF)

/** \brief Error mask for channel busy TRL
 */
#define IFXDMA_ERROR_CBTRL  (IFX_DMA_RP_CLRE_CCBTRLER_MSK << IFX_DMA_RP_CLRE_CCBTRLER_OFF)

/** \brief Error mask for channel disabled TRL
 */
#define IFXDMA_ERROR_CDTRL  (IFX_DMA_RP_CLRE_CDCDTRLER_MSK << IFX_DMA_RP_CLRE_CDCDTRLER_OFF)

/** \brief Error mask for daisy chain TRLError mask for
 */
#define IFXDMA_ERROR_DCTRL  (IFX_DMA_RP_CLRE_CDCTRLER_MSK << IFX_DMA_RP_CLRE_CDCTRLER_OFF)

/** \brief Error mask for invalid RP TRL
 */
#define IFXDMA_EROR_IRPTRL  (IFX_DMA_RP_CLRE_CIRTRLER_MSK << IFX_DMA_RP_CLRE_CIRTRLER_OFF)

#define IFXDMA_NUM_MODULES  (2)

/** \brief Number of Resource Partition
 */
#define IFXDMA_NUM_RP       (16U)
...
/** \brief List of available DMA resources
 */
typedef enum
{
    IfxDma_Index_none = -1,  /**< \brief Not Selected */
    IfxDma_Index_0    = 0,   /**< \brief DMA Index 0  */
    IfxDma_Index_1           /**< \brief DMA Index 1  */
} IfxDma_Index;

/******************************************************************************/
/*-------------------Global Exported Variables/Constants----------------------*/
/******************************************************************************/
IFX_EXTERN IFX_CONST IfxModule_IndexMap IfxDma_cfg_indexMap[IFXDMA_NUM_MODULES];
