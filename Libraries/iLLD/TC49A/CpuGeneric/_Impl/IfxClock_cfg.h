...
#    define IFX_CFG_CLOCK_SYSPLL_FREQUENCY    400000000  /**< \brief Default PLL frequency */
#endif
...
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(40 - 1), (IfxClock_K2divider)(8 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(40 - 1), (IfxClock_K2divider)(2 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */    
#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(3 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */    
#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */     
#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(32 - 1), (IfxClock_K2divider)(8 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */     
#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(32 - 1), (IfxClock_K2divider)(2 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 10MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(80 - 1), (IfxClock_K2divider)(8 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 10MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(80 - 1), (IfxClock_K2divider)(2 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
/******************************* OSCCON DEFAULT ******************************************/
#ifndef IFX_CLOCK_OSCCON_APREN_VAL
#define IFX_CLOCK_OSCCON_APREN_VAL               (0)
#endif
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/\
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(32 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)0 , (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)3 , (IfxClock_K4divider)(2 - 1), (IfxClock_K4PreDivider)3}
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/\
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(40 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)1, (IfxClock_K4divider)(2 - 1),(IfxClock_K4PreDivider)1}
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/\
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(32 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)1, (IfxClock_K4divider)(2 - 1),(IfxClock_K4PreDivider)1}
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/\
    {(IfxClock_Pdivider)(5 - 1), (IfxClock_Ndivider)(128 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)3, (IfxClock_K4divider)(2 - 1),(IfxClock_K4PreDivider)3}
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/\
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(80 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)1, (2 - 1),(IfxClock_K4PreDivider)1}
...
#define IFXCLOCK_CFG_SYS_PLL_INITIAL_STEP_BASIC_(xtalFreq, pll0Freq) IFXCLOCK_CFG_SYS_PLL_##xtalFreq##_##pll0Freq
#define IFXCLOCK_CFG_SYS_PLL_INITIAL_STEP_BASIC(xtalFreq, pll0Freq)  IFXCLOCK_CFG_SYS_PLL_INITIAL_STEP_BASIC_(xtalFreq, pll0Freq)
#define IFXCLOCK_CFG_SYS_PLL_INITIAL_STEP IFXCLOCK_CFG_SYS_PLL_INITIAL_STEP_BASIC(IFXCLOCK_CFG_XTAL_FREQ, IFXCLOCK_CFG_SYSPLL_FREQ)
...
/************** SYSCCUCON1 : GTMDIV  (Output : fGTM)**************/
/* Target = 200 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_GTMDIV_400MHZ
#define IFXCLOCK_CFG_GTMDIV_400MHZ             (2)
...
#define IFXCLOCK_CFG_I2CDIV_320MHZ_200MHZ             (3)
...
#define IFXCLOCK_CFG_OSCCON_MASK \
    (uint32)( \
        (IFX_CLOCK_OSCCON_APREN_MSK << IFX_CLOCK_OSCCON_APREN_OFF) | \
...
#define IFXCLOCK_CFG_OSCCON_VALUE \
    (uint32)( \
        (IFX_CLOCK_OSCCON_APREN_VAL << IFX_CLOCK_OSCCON_APREN_OFF) | \
...
#define IFXCLOCK_CFG_SYSCCUCON1_MASK \
    (uint32)( \
        ...
        (IFX_CLOCK_SYSCCUCON1_GTMDIV_MSK << IFX_CLOCK_SYSCCUCON1_GTMDIV_OFF) | \
...
#define IFXCLOCK_CFG_SYSCCUCON1_BASIC_(pll0Freq, pll1Freq, pll2Freq) \
    (uint32)( \
        ...
        (IFXCLOCK_CFG_GTMDIV_##pll0Freq << IFX_CLOCK_SYSCCUCON1_GTMDIV_OFF) | \
...
#define IFXCLOCK_CFG_PERCCUCON1_MASK \
    (uint32)( \
		...
		(IFX_CLOCK_PERCCUCON1_CLKSELADC_MSK << IFX_CLOCK_PERCCUCON1_CLKSELADC_OFF) | \
...
#define IFXCLOCK_CFG_PERCCUCON1_BASIC_(pll0Freq, pll1Freq, pll2Freq) \
    (uint32)( \
		...
		(IFXCLOCK_CFG_CLKSELADC_##pll1Freq##_##pll2Freq << IFX_CLOCK_PERCCUCON1_CLKSELADC_OFF)| \
...
#define IFXCLOCK_CFG_DFLASH_WAITSTATE_VAL (4)
#endif

#ifndef IFXCLOCK_CFG_PFLASH_WAITSTATE_VAL
#define IFXCLOCK_CFG_PFLASH_WAITSTATE_VAL (5)
#endif
