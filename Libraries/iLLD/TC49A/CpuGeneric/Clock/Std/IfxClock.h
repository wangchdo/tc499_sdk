 ...
 *     {IfxClock_RampWaitTime_1us,           IfxClock_RampFreqStepSize_40MHz,400},
 * #endif
 ...
 *       // fPLL1 = N * fIN / P * K2 * 1. 6 -> K2PREDIV = 2
 *       // fPLL1 = N * fIN / P * K2 * 1. 2 -> K2PREDIV = 3
 *       //
 *       // fPLL2 = N * fIN / P * K3 * 1. 0 -> K3PREDIV = 0
 *       // fPLL2 = N * fIN / P * K3 * 2. 0 -> K3PREDIV = 1
 *       // fPLL2 = N * fIN / P * K3 * 1. 6 -> K3PREDIV = 2
 *       // fPLL2 = N * fIN / P * K3 * 1. 2 -> K3PREDIV = 3
 *       //
 *       // fPLL3 = N * fIN / P * K4 * 1. 0 -> K4PREDIV = 0
 *       // fPLL3 = N * fIN / P * K4 * 2. 0 -> K4PREDIV = 1
 *       // fPLL3 = N * fIN / P * K4 * 1. 6 -> K4PREDIV = 2
 *       // fPLL3 = N * fIN / P * K4 * 1. 2 -> K4PREDIV = 3
 ...
 *    IfxClock_sampleClockConfig.rampConfig.rampFreqStepSize = IfxClock_RampFreqStepSize_10MHz; //IfxClock_RampFreqStepSize_20MHz, IfxClock_RampFreqStepSize_30MHz, IfxClock_RampFreqStepSize_40MHz
 *   IfxClock_sampleClockConfig.rampConfig.rampOscUpperFreqLimit = 400; // in units of 1MHz, min 100
...
#endif
#if defined(IFX_ILLD_PPU_USAGE)
#include "../ArcEV/Cpu/Std/IfxCpu_Intrinsics.h"
#endif
 ...
 */
#define IFXCLOCK_MODCFG_DEFAULT_VAL               ((uint32)0x3D)
...
typedef enum
{
    ...
    IfxClock_ClkSel0_fCPB   = 9,  /**< \brief Select fSPB as EXTCLK0 */
    ...
    IfxClock_ClkSel0_fGTM   = 15, /**< \brief Select fSTM as EXTCLK0 */
 ...
 *  10B DIVBY1_6 / The 1.6 pre-divider between DCO and K2-Divider is selected for PLL0 . Hence, the resulting divider factor in front of the K2-Divider is fDCO / 1.6.
 *  11B DIVBY1_2 / The 1.2 pre-divider between DCO and K2-Divider is selected for PLL0 . Hence, the resulting divider factor in front of the K2-Divider is fDCO / 1.2
 */
typedef enum
{
...
/** \brief PLL2 Divider Select: defines the pre-dividing factor in front of the K3-Divider
 *  Register : PERPLLCON0.B.K3PREDIV ;
 ...
 *  01B DIVBY2_0 / The 2.0 pre-divider between DCO and K3-Divider is selected for PLL2 . Hence, the resulting divider factor in front of the K3-Divider is fDCO / 2.0.
 *  10B DIVBY1_6 / The 1.6 pre-divider between DCO and K3-Divider is selected for PLL2 . Hence, the resulting divider factor in front of the K3-Divider is fDCO / 1.6.
 *  11B DIVBY1_2 / The 1.2 pre-divider between DCO and K3-Divider is selected for PLL2 . Hence, the resulting divider factor in front of the K3-Divider is fDCO / 1.2
 */
typedef enum
{
    IfxClock_K3PreDivider_divBy1_0 = 0,  /**< \brief The 1.0 pre-divider between DCO and K3-Divider is selected for PLL2 */
    IfxClock_K3PreDivider_divBy2_0 = 1,  /**< \brief The 2.0 pre-divider between DCO and K3-Divider is selected for PLL2 */
    IfxClock_K3PreDivider_divBy1_2 = 2,  /**< \brief The 1.2 pre-divider between DCO and K3-Divider is selected for PLL2 */
    IfxClock_K3PreDivider_divBy1_6 = 3   /**< \brief The 1.6 pre-divider between DCO and K3-Divider is selected for PLL2 */
 ...
 *  10B DIVBY1_6 / The 1.6 pre-divider between DCO and K4-Divider is selected for PLL3 . Hence, the resulting divider factor in front of the K4-Divider is fDCO / 1.6.
 *  11B DIVBY1_2 / The 1.2 pre-divider between DCO and K4-Divider is selected for PLL3 . Hence, the resulting divider factor in front of the K4-Divider is fDCO / 1.2
 */
typedef enum
{
...
/** \brief Frequency step size applied during ramping.
 * Register : RAMPCON.B.SZ ;
 * 00B 10 MHz
 * 01B 20 MHz
 * 10B 30 MHz
 * 11B 40 MHz
...
typedef enum
{
    IfxClock_RampFreqStepSize_10MHz = 0,  /**< \brief RampingFreqStepSize:10 MHZ */
    IfxClock_RampFreqStepSize_20MHz = 1,  /**< \brief RampingFreqStepSize:20 MHZ */
    IfxClock_RampFreqStepSize_30MHz = 2,  /**< \brief RampingFreqStepSize:30 MHZ */
    IfxClock_RampFreqStepSize_40MHz = 3   /**< \brief RampingFreqStepSize:40 MHZ */
} IfxClock_RampFreqStepSize;
...
typedef enum
{
    IfxClock_RampWaitTime_1us = 0,  /**< \brief 1 microsec */
    IfxClock_RampWaitTime_2us = 1,  /**< \brief 2 microsec */
    IfxClock_RampWaitTime_3us = 2,  /**< \brief 3 microsec */
    IfxClock_RampWaitTime_4us = 3   /**< \brief 4 microsec */
} IfxClock_RampWaitTime;
...
typedef struct
{
    IfxClock_RampWaitTime     rampWaitTime;                /**< \brief Wait time for ramping */
    IfxClock_RampFreqStepSize rampFreqStepSize;            /**< \brief Frequency step size for Ramping */
...
/** \brief calculates the Rgain parameters from the oscillator frequency, modulation amplitude.
 ...
 * fPLL2 = (N * fIN) / (P * K3 * 2. 0) if K3PREDIV = 0
 * fPLL2 = (N * fIN) / (P * K3 * 1. 6) if K3PREDIV = 1
 ...
 * fPLL3 = N * fIN / P * K4 * 2. 0 if K4PREDIV = 0
 * fPLL3 = N * fIN / P * K4 * 1. 6 if K4PREDIV = 1
 ...
 * \return None
 */
IFX_EXTERN void IfxClock_initAp(Ifx_CLOCK *clock, IfxClock_ApConfig *config);

/**
 * \return None
 */
IFX_EXTERN void IfxClock_initApConfig(IfxClock_ApConfig *config);
...
IFX_INLINE uint32 IfxClock_getOsc0Frequency(void)
{
    return (uint32)IfxClock_xtalFrequency;
}
