/**
 * \file IfxGpt12_PinMap_LFBGA292_COM.h
 * \brief GPT12  details
 ...
 *
 * \defgroup IfxLld_Gpt12_
 * \ingroup IfxLld_Gpt12
 * \defgroup IfxLld_Gpt12__Pinmap Variables Default
 * \ingroup IfxLld_Gpt12_
 * \defgroup IfxLld_Gpt12__PinTables Default
 * \ingroup IfxLld_Gpt12_
 */

#ifndef IFXGPT12_PINMAP_LFBGA292_COM_H
#define IFXGPT12_PINMAP_LFBGA292_COM_H 1
...
#define IFXGPT12_PINMAP_CAPIN_IN_NUM_ITEMS  2
...
/******************************************************************************/
/** \brief Trigger input to capture value of timer T5 into CAPREL register (input A)
 */
IFX_EXTERN IfxGpt12_Capin_In  IfxGpt120_CAPINA_P13_2_IN;

/** \brief Trigger input to capture value of timer T5 into CAPREL register (input B)
 */
IFX_EXTERN IfxGpt12_Capin_In  IfxGpt120_CAPINB3_P33_2_IN;

/** \brief Count direction control input of timer T2
 */
IFX_EXTERN IfxGpt12_TxEud_In  IfxGpt120_T2EUDA_P00_8_IN;

/** \brief Count direction control input of timer T2
 */
IFX_EXTERN IfxGpt12_TxEud_In  IfxGpt120_T2EUDB_P33_6_IN;

/** \brief Trigger/gate input of timer T2
 */
...
/** \brief Count direction control input of core timer T3
 */
...
/** \brief Trigger/gate input of core timer T3 (input A, B and C)
 */
IFX_EXTERN IfxGpt12_TxIn_In   IfxGpt120_T3INA_P02_6_IN;

/** \brief External output for overflow/underflow detection of core timer T3
 */
...
/** \brief Count direction control input of timer T4
 */
...
/** \brief Trigger/gate input of timer T4
 */
...
/** \brief Count direction control input of timer T5
 */
IFX_EXTERN IfxGpt12_TxEud_In  IfxGpt120_T5EUDA_P21_6_IN;

/** \brief Trigger/gate input of timer T5
 */
...
/** \brief Count direction control input of core timer T6
 */
IFX_EXTERN IfxGpt12_TxEud_In  IfxGpt120_T6EUDA_P20_0_IN;

/** \brief Trigger/gate input of core timer T6
 */
...
/** \brief External output for overflow/underflow detection of core timer T6
 */
...
/** \brief Trigger input to capture value of timer T5 into CAPREL register (input B)
 */
IFX_EXTERN IfxGpt12_Capin_In  IfxGpt121_CAPINB3_P13_3_IN;
...
/** \brief Count direction control input of timer T4
 */
IFX_EXTERN IfxGpt12_TxEud_In  IfxGpt121_T4EUDA_P00_3_IN;
...
#endif /* IFXGPT12_PINMAP_LFBGA292_COM_H */
