 ...
 *      IfxSrc_init((Ifx_SRC_SRCR*)&MODULE_SRC.VADC.G[0], IfxSrc_Tos_dma0, 0);
...
typedef struct
{
    ...
    IfxSrc_VmId                      channelVmId;                                  /**< \brief VM interrupt service provider */
    IfxDma_HardwareResourcePartition hardwareResourcePartition;                    /**< \brief DMA hardware resource partition */
    boolean                          cyberSecurityAsset;                           /**< \brief Determines if DMA resource partition is a CS Asset or not. 0 = not a CS asset, 1 = CS asset */
