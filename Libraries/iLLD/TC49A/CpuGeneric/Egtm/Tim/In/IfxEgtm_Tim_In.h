...
typedef enum
{
    IfxEgtm_Tim_In_Input_currentChannel,   /**< \brief Use the input from the current channel */
    IfxEgtm_Tim_In_Input_adjacentChannel,  /**< \brief Use the input from the adjacent channel */
    IfxEgtm_Tim_In_Input_aux               /**< \brief Use the input from the aux */
} IfxEgtm_Tim_In_Input;
...
typedef struct
{
    ...
    IfxEgtm_Tim_In_Input            input;                       /**< \brief selected input */
    IfxEgtm_Tim_TinMap             *inputPin;                    /**< \brief If defined, this value overwrites the IfxEgtm_Tim_In_Config.filter.input, IfxEgtm_Tim_In_Config.timIndex, IfxEgtm_Tim_In_Config.channelIndex */
...
typedef struct
{
    ...
    IfxEgtm_Cluster      clsIndex;                    /**< \brief Index of the CLS module being used. */
...
typedef struct
{
    ...
    IfxEgtm_Cluster              cluster;            /**< \brief CLS index */
