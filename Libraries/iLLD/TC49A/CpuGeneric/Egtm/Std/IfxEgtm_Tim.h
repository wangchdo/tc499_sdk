 ...
 */
IFX_INLINE Ifx_EGTM_CLS_TIM_CH *IfxEgtm_Tim_getChannel(Ifx_EGTM_CLS_TIM *tim, IfxEgtm_Tim_Ch channel);
...
IFX_INLINE Ifx_EGTM_CLS_TIM_CH *IfxEgtm_Tim_getChannel(Ifx_EGTM_CLS_TIM *tim, IfxEgtm_Tim_Ch channel)
{
    return (Ifx_EGTM_CLS_TIM_CH *)((uint32)&tim->CH[channel].GPR0.U);
}
