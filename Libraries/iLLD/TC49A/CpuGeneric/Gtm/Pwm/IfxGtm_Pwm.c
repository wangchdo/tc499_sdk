 ...
 */
IFX_INLINE Ifx_GTM_CLS_CDTM_DTM *IfxGtm_Pwm_getDtmPtr(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_enableChannelSyncUpdate(volatile Ifx_UReg_32Bit *glbCtrl, uint32 upenMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_disableChannelSyncUpdate(volatile Ifx_UReg_32Bit *glbCtrl, uint32 upenMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_enableChannel(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_enableChannelOutput(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_setClockSource(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel, IfxGtm_Pwm_ClockSource clockSource);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_setCounterResetEvent(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel, IfxGtm_Pwm_ResetEvent event);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_setCounterMode(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel, IfxGtm_Pwm_Alignment alignment);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_generateTrigger(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Pwm_configureTimeBaseTrigger(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel, uint32 compareValue);
...
IFX_INLINE void IfxGtm_Pwm_enableChannel(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel)
{
    ...
    {
        IfxGtm_Tom_Tgc_enableChannel(&clusterSFR->TOM.TGC[IFXGTM_PWM_GET_TGC_INDEX(channel)], (IfxGtm_Tom_Ch)channel, TRUE, FALSE);
    }
}
...
IFX_INLINE void IfxGtm_Pwm_enableChannelOutput(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel)
{
    ...
    {
        IfxGtm_Tom_Tgc_enableChannelOutput(&clusterSFR->TOM.TGC[IFXGTM_PWM_GET_TGC_INDEX(channel)], (IfxGtm_Tom_Ch)channel, TRUE, FALSE);
    }
}
...
IFX_INLINE void IfxGtm_Pwm_configureTimeBaseTrigger(Ifx_GTM_CLS *clusterSFR, IfxGtm_Pwm_SubModule subModule, IfxGtm_Pwm_SubModule_Ch channel, uint32 compareValue)
{
    Ifx_GTM_CLS_ATOM_AGC_ACT_TB actTbReg;
    ...
    {
        clusterSFR->TOM.TGC[IFXGTM_PWM_GET_TGC_INDEX(channel)].ACT_TB.U = actTbReg.U;
    }
}
...
void IfxGtm_Pwm_init(IfxGtm_Pwm *pwm, IfxGtm_Pwm_Channel *channels, IfxGtm_Pwm_Config *config)
{
    ...
    pwm->clusterSFR        = &config->gtmSFR->CLS[(uint32)config->cluster];
...
IFX_STATIC void IfxGtm_Pwm_initChannel(IfxGtm_Pwm *pwm, IfxGtm_Pwm_Config *config, IfxGtm_Pwm_SyncChannelIndex configIndex)
{
    ...
    Ifx_GTM_CLS              *clusterSFR    = pwm->clusterSFR;
    ...
    {
        channel->upenMask = (uint32)((uint32)IFXGTM_ATOM_AGC_CHANNEL_MASK << IFXGTM_ATOM_AGC_CHANNEL_SHIFT(channelIndex, IFX_GTM_CLS_ATOM_AGC_GLB_CTRL_UPEN_CTRL0_OFF));
        ...
        else
        {
            ...
            channel->registers.GLB_CTRL   = (volatile Ifx_UReg_32Bit *)&clusterSFR->TOM.TGC[IFXGTM_PWM_GET_TGC_INDEX(channelIndex)].GLB_CTRL.U;
    ...
    Ifx_ActiveState channelPolarity = (channelConfig->output != NULL_PTR) ? channelConfig->output->polarity : Ifx_ActiveState_high;
    {
        ...
        if (subModule == IfxGtm_Pwm_SubModule_atom)
        {
            ...
            clusterSFR->ATOM.CH[channelIndex].CTRL.B.MODE = (uint8)IfxGtm_Atom_Mode_outputPwm;
        }
    ...
    /* 5. Configure Dead time module */
    {
        ...
        Ifx_GTM_CLS_CDTM_DTM *dtmSFR     = IfxGtm_Pwm_getDtmPtr(pwm->clusterSFR, subModule, channelIndex);
        ...
        if (channelConfig->dtm != NULL_PTR)
        {
            ...
            {
                IfxGtm_Pwm_FastShutoffConfig *fastShutoffConfig = channelConfig->dtm->fastShutOff;

                /* Use individual channel shutoff */
                IfxGtm_Dtm_enableIndividualShutoff(dtmSFR);

                /* Set shutoff input signal */
                IfxGtm_Dtm_setShutoffInput(dtmSFR, dtmChannel, fastShutoffConfig->inputSignal);

                /* Set whether input signal is inverted or not */
                IfxGtm_Dtm_setShutoffInputInverter(dtmSFR, dtmChannel, fastShutoffConfig->invertInputSignal);

                /* Set shutoff update mode: signal sets internal signal SHUTOFF_SYNC_0; internal signal
                 * SHUTOFF_SYNC_0 is cleared depending to bitfield SHUTOFF_RST_0 */
                IfxGtm_Dtm_setShutoffUpdateMode(dtmSFR, dtmChannel, 0x1u);
                ...
                IfxGtm_Dtm_setOutput0ShadowChannelControl(dtmSFR, dtmChannel, IfxGtm_Dtm_ChannelControl_constantOutput);

                /* Generate constant output equal to shadow signal level once shutoff is activated */
                IfxGtm_Dtm_setOutput1ShadowChannelControl(dtmSFR, dtmChannel, IfxGtm_Dtm_ChannelControl_constantOutput);

                /* Define signal level at output 0 once shutoff is activated */
                IfxGtm_Dtm_setOutput0ShadowSignalLevel(dtmSFR, dtmChannel, fastShutoffConfig->offState);

                /* Define signal level at output 1 once shutoff is activated */
                IfxGtm_Dtm_setOutput1ShadowSignalLevel(dtmSFR, dtmChannel, fastShutoffConfig->complementaryOffState);
            }
        }
    ...
    {
        (void)IfxGtm_ConnectToMsc(pwm->cluster, (subModule == IfxGtm_Pwm_SubModule_tom) ? IfxGtm_TrigSource_tom : IfxGtm_TrigSource_atom, (IfxGtm_TrigChannel)channelIndex, channelConfig->mscOut);
    }
...
IFX_STATIC void IfxGtm_Pwm_initInterrupts(IfxGtm_Pwm *pwm, IfxGtm_Pwm_InterruptConfig *interrupt, IfxGtm_Pwm_Channel *channel)
{
    ...
    if (interrupt != NULL_PTR)
    {
        ...
        if (pwm->subModule == IfxGtm_Pwm_SubModule_atom)
        {
            ...
            src = IfxGtm_Atom_Ch_getSrcPointer(NULL_PTR, pwm->cluster, (IfxGtm_Atom_Ch)channelIndex);
        }
        else
        {
            ...
            src = IfxGtm_Tom_Ch_getSrcPointer(NULL_PTR, pwm->cluster, (IfxGtm_Tom_Ch)channelIndex);
        }
...
IFX_STATIC void IfxGtm_Pwm_updateGlobalControlUnitData(IfxGtm_Pwm *pwm)
{
    ...
    if (pwm->subModule == IfxGtm_Pwm_SubModule_atom)
    {
        ...
        pwm->globalControl.upenMask0     = (uint32)((uint32)IFXGTM_PWM_CHANNELS_MASK(firstChannel, lastChannel) << (uint32)IFX_GTM_CLS_ATOM_AGC_GLB_CTRL_UPEN_CTRL0_OFF);
    ...
    else
    {
        ...
        if (IFXGTM_PWM_GET_TGC_INDEX(firstChannel) != IFXGTM_PWM_GET_TGC_INDEX(lastChannel))
        {
            ...
            pwm->globalControl.upenMask0     = (uint32)(IFXGTM_PWM_CHANNELS_MASK(firstChannel, (uint32)IfxGtm_Pwm_SubModule_Ch_7) << (uint32)IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
            pwm->globalControl.upenMask1     = (uint32)(IFXGTM_PWM_CHANNELS_MASK(IfxGtm_Pwm_SubModule_Ch_8, lastChannel) << (uint32)IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
        ...
        {
            pwm->globalControl.upenMask0     = (uint32)(IFXGTM_PWM_CHANNELS_MASK(firstChannel, lastChannel) << (uint32)IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
            pwm->globalControl.reg0          = (volatile Ifx_UReg_32Bit *)&pwm->clusterSFR->TOM.TGC[IFXGTM_PWM_GET_TGC_INDEX(lastChannel)].GLB_CTRL.U;
            pwm->globalControl.endisCtrlReg0 = (volatile Ifx_UReg_32Bit *)&pwm->clusterSFR->TOM.TGC[IFXGTM_PWM_GET_TGC_INDEX(lastChannel)].ENDIS_CTRL.U;
        }
    }
}
...
{
    Ifx_GTM_CLS_TBU *tbuSFR          = &pwm->gtmSFR->CLS[0].TBU;
        ...
        (pwm->state == IfxGtm_Pwm_State_stopped))
    {
        ...
        if (pwm->globalControl.reg1 != NULL_PTR)
        {
            ...
            *pwm->globalControl.endisCtrlReg1 = (~(~IFXGTM_PWM_UPEN_ENABLE_VALUE & pwm->globalControl.upenMask1)) >> 16u;
            ...
            {
                gtmSFR->CLS[0].CMU.CLK_EN.B.EN_CLK0 = (uint8)IfxGtm_FeatureControl_enable;
            ...
            if (cmuClockEnabled == FALSE)
            {
                gtmSFR->CLS[0].CMU.CLK_EN.B.EN_CLK0 = (uint8)IfxGtm_FeatureControl_disable;
            }
        }
...
{
    Ifx_GTM_CLS_TBU *tbuSFR          = &pwm1->gtmSFR->CLS[0].TBU;
...
void IfxGtm_Pwm_updateChannelsDeadTime(IfxGtm_Pwm *pwm, IfxGtm_Pwm_DeadTime *requestDeadTime)
{
    uint8 configIndex = 0;
    ...
    for (configIndex = 0; configIndex < pwm->numChannels; configIndex++)
    {
        IfxGtm_Pwm_updateChannelDeadTime(pwm, (IfxGtm_Pwm_SyncChannelIndex)configIndex, requestDeadTime[configIndex]);
    }
}
...
IfxGtm_Pwm_ChannelState IfxGtm_Pwm_getChannelState(IfxGtm_Pwm *pwm, IfxGtm_Pwm_SubModule_Ch channel)
{
    ...
    {
        Ifx_GTM_CLS_TOM_TGC *tgc = &pwm->clusterSFR->TOM.TGC[IFXGTM_PWM_GET_TGC_INDEX(channel)];
