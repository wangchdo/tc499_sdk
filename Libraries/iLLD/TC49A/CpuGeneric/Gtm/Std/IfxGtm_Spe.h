 ...
 */
#define IFXGTM_SPE_GET_TRIGSEL(x)                                    ((uint32)((uint32)x & (uint32)3u))

/** \brief Macro to get the ETRIG_SEL value in CTRL_STAT register.
 * Input(x): Enum value of IfxGtm_Spe_TriggerSource
 */
#define IFXGTM_SPE_GET_ETRIG(x)                                      ((uint32)(((uint32)x & (uint32)4u) >> 2u))

/** \brief sets a single input pattern into the SPE_PAT register.
 */
#define IFXGTM_SPE_SETSINGLEPATTERN(spepat_temp, pattern, pat_index) ((spepat_temp | ((uint32)0xFu << ((uint32)pat_index * 4U))) & ((uint32)pattern << ((uint32)pat_index * 4U)))
 ...
 */
#define IFXGTM_SPE_SETCHANNELOUTPUT(speoutpat, output, ch)           ((speoutpat | ((uint32)0x3u << (ch * 2u))) & ((uint32)output << (ch * 2u)))
...
typedef struct
{
    ...
    Ifx_UReg_32Bit x : 1;         /**< \brief CHx input Signal */
    Ifx_UReg_32Bit y : 1;         /**< \brief CHy input Signal */
    Ifx_UReg_32Bit z : 1;         /**< \brief CHz input Signal */
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_clearAllInterrupts(Ifx_GTM_CLS_SPE *spe);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_clearInterrupt(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InterruptSignal interrupt);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_disableInterrupt(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InterruptSignal interrupt);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_enableErrorInterrupt(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InterruptSignal interrupt, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_enableInput(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InputSignal inputSignal, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_enableInterrupt(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InterruptSignal interrupt);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_enableModule(Ifx_GTM_CLS_SPE *spe, boolean enabled);

/** \brief returns the actual input pattern as a word format.
 * \param spe pointer to the spe device.
 * \return actual input pattern
 */
IFX_INLINE uint32 IfxGtm_Spe_getActualInputPat(Ifx_GTM_CLS_SPE *spe);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setActualInputPat(Ifx_GTM_CLS_SPE *spe, uint8 pattern);

/** \brief returns the backwards pattern pointer.
 * \param spe pointer to the spe device.
 * \return current pattern pointer
 */
IFX_INLINE uint32 IfxGtm_Spe_getBwdPatternPtr(Ifx_GTM_CLS_SPE *spe);

/** \brief retrieves the Control command used to select Pattern pointer which selects OUT_PAT.
 * \param spe pointer to the spe device.
 * \return control command selection
 */
IFX_INLINE IfxGtm_Spe_ControlCommand IfxGtm_Spe_getControlCommand(Ifx_GTM_CLS_SPE *spe);

/** \brief gets the actual rotation direction of the input signals.
 * \param spe pointer to the spe device.
 * \return Direction
 */
IFX_INLINE IfxGtm_Spe_Direction IfxGtm_Spe_getDir(Ifx_GTM_CLS_SPE *spe);
 ...
 */
IFX_INLINE uint32 IfxGtm_Spe_getFastShutoffLevel(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_OutChannel channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Spe_getInterruptStatus(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InterruptSignal interrupt);

/** \brief gets the new input pattern in word format.
 * \param spe pointer to the spe device.
 * \return new input pattern
 */
IFX_INLINE uint32 IfxGtm_Spe_getNewInputPat(Ifx_GTM_CLS_SPE *spe);
 ...
 */
IFX_INLINE uint32 IfxGtm_Spe_getOutputCtrl(Ifx_GTM_CLS_SPE *spe);
 ...
 */
IFX_INLINE uint32 IfxGtm_Spe_getOutputPattern(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_PatternIndex patIndex);

/** \brief returns the pattern pointer which indicates the currently pointed SPE_OUT_PAT register.
 * \param spe pointer to the spe device.
 * \return current pattern pointer
 */
IFX_INLINE uint32 IfxGtm_Spe_getPatternPtr(Ifx_GTM_CLS_SPE *spe);

/** \brief gets the previous rotation direction.
 * \param spe pointer to the spe device.
 * \return Previous Direction
 */
IFX_INLINE IfxGtm_Spe_Direction IfxGtm_Spe_getPrevDir(Ifx_GTM_CLS_SPE *spe);

/** \brief gets the previous input pattern in word format.
 * \param spe pointer to the spe device.
 * \return previous input pattern
 */
IFX_INLINE uint32 IfxGtm_Spe_getPreviousInputPat(Ifx_GTM_CLS_SPE *spe);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setPreviousInputPat(Ifx_GTM_CLS_SPE *spe, uint8 pattern);

/** \brief returns the step counter compare value as a 32 bit word.
 * \param spe pointer to the spe device
 * \return step counter
 */
IFX_INLINE uint32 IfxGtm_Spe_getRevCompare(Ifx_GTM_CLS_SPE *spe);

/** \brief returns the step counter as a 32 bit word
 * \param spe pointer to the spe device
 * \return step counter
 */
IFX_INLINE uint32 IfxGtm_Spe_getRevCounter(Ifx_GTM_CLS_SPE *spe);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_selectTimInput(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_TimInput timInput);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_selectTrigger(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_TriggerSource trigger);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setAllInputPatterns(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InputPattern *patPtr);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setBwdPatternPtr(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_PatternIndex patIndex);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setControlCommand(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_ControlCommand cmd);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setFastShutoff(Ifx_GTM_CLS_SPE *spe, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setInputPattern(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InputPattern *patPtr, IfxGtm_Spe_PatternIndex patIndex);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setInterrupt(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InterruptSignal interrupt);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setInterruptMode(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InterruptMode mode);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setOutputCtrl(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_OutputPattern *patPtr);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setOutputPattern(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_OutputPattern *patPtr, IfxGtm_Spe_PatternIndex patIndex);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setPatternPtr(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_PatternIndex patIndex);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setRevCompare(Ifx_GTM_CLS_SPE *spe, uint32 count);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_setRevCounter(Ifx_GTM_CLS_SPE *spe, uint32 count);

/** \brief Trigger the update of OUT_CTRL register with the OUT_PAT selected by Control Command.
 * \param spe pointer to the spe device.
 * \return None
 */
IFX_INLINE void IfxGtm_Spe_triggerUpdate(Ifx_GTM_CLS_SPE *spe);
...
IFX_INLINE void IfxGtm_Spe_enableInput(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InputSignal inputSignal, boolean enabled)
{
    if (enabled == TRUE)
    {
        spe->CTRL_STAT.U |= ((uint32)enabled << ((uint32)inputSignal + IFX_GTM_CLS_SPE_CTRL_STAT_SIE0_OFF));
    }
    else
    {
        spe->CTRL_STAT.U &= ((uint32)enabled << ((uint32)inputSignal + IFX_GTM_CLS_SPE_CTRL_STAT_SIE0_OFF));
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGtm_Spe_getSrcPointer(IfxGtm_Spe spe)
{
    return (volatile Ifx_SRC_SRCR *)(&(MODULE_SRC.GTM.SPEIRQ[spe]));
}
...
IFX_INLINE void IfxGtm_Spe_selectTrigger(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_TriggerSource trigger)
{
    Ifx_GTM_CLS_SPE_CTRL_STAT ctrl_stat;
    ctrl_stat.U           = spe->CTRL_STAT.U;

    ctrl_stat.B.TRIG_SEL  = (uint8)IFXGTM_SPE_GET_TRIGSEL(trigger);
    ctrl_stat.B.ETRIG_SEL = (uint8)IFXGTM_SPE_GET_ETRIG(trigger);
