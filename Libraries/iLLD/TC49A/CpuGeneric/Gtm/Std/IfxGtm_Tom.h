...
typedef enum
{
    ...
    IfxGtm_Tom_Ch_ClkSrc_prevTrig  = 13, /**< \brief TRIG[x-1] trigger from previous channel */
    IfxGtm_Tom_Ch_ClkSrc_extTrig   = 14  /**< \brief TIM_EXT_CAPTURE */
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_clearOneNotification(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_clearZeroNotification(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);

/** \brief Returns the base address of selected Tom channel
 * \param tom Pointer to the TOM object
 * \param channel Channel index
 * \return Pointer to channel base address
 */
IFX_INLINE Ifx_GTM_CLS_TOM_CH *IfxGtm_Tom_Ch_getChannelPointer(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE float32 IfxGtm_Tom_Ch_getClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE IfxGtm_Tom_Ch_ClkSrc IfxGtm_Tom_Ch_getClockSource(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE uint16 IfxGtm_Tom_Ch_getCompareOne(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE volatile uint32 *IfxGtm_Tom_Ch_getCompareOnePointer(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE uint16 IfxGtm_Tom_Ch_getCompareZero(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE volatile uint32 *IfxGtm_Tom_Ch_getCompareZeroPointer(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Tom_Ch_getOutputLevel(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGtm_Tom_Ch_getSrcPointer(Ifx_GTM *gtm, IfxGtm_Cluster cluster, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE Ifx_GTM_CLS_TOM_TGC *IfxGtm_Tom_Ch_getTgcPointer(Ifx_GTM_CLS_TOM *tom, uint32 tgcIndex);
 ...
 */
IFX_INLINE volatile uint32 *IfxGtm_Tom_Ch_getTimerPointer(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Tom_Ch_isOneNotification(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Tom_Ch_isZeroNotification(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_raiseInterruptOne(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_raiseInterruptZero(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setClockSource(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, IfxGtm_Tom_Ch_ClkSrc clk);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setCompare(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, uint16 compareZero, uint16 compareOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setCompareOne(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, uint16 compareOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setCompareOneShadow(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, uint16 shadowOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setCompareShadow(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, uint16 shadowZero, uint16 shadowOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setCompareZero(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, uint16 compareZero);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setCompareZeroShadow(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, uint16 shadowZero);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setCounterValue(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, uint32 value);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setGatedCounter(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setNotification(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, IfxGtm_IrqMode mode, boolean interruptOnCompareZero, boolean interruptOnCompareOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setOneShotMode(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setPcm(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setResetSource(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, IfxGtm_Tom_Ch_ResetEvent event);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setSignalLevel(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, Ifx_ActiveState activeState);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setSpe(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Ch_setTriggerOutput(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, IfxGtm_Tom_Ch_OutputTrigger trigger);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannel(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelOutput(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannels(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelsOutput(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelsTrigger(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelsUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_enableTimeTrigger(Ifx_GTM_CLS_TOM_TGC *tgc, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_resetChannels(Ifx_GTM_CLS_TOM_TGC *tgc, uint32 resetMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_setChannelForceUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean resetEnabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_setChannelsForceUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_setTimeTrigger(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tbu_Ts base, uint32 value);

/** \brief Raise the trigger for the channel enable/disable settings,  output enable settings, and force update event (CTRL_TRIG)
 * \param tgc Pointer to the TGC object
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_trigger(Ifx_GTM_CLS_TOM_TGC *tgc);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_writeGlobalControl(Ifx_GTM_CLS_TOM_TGC *tgc, uint32 control);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Tgc_setInternalTrigger(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled);
 ...
 */
IFX_EXTERN float32 IfxGtm_Tom_Ch_getFrequency(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
 ...
 */
IFX_EXTERN float32 IfxGtm_Tom_Ch_getDuty(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel);
...
IFX_INLINE Ifx_GTM_CLS_TOM_CH *IfxGtm_Tom_Ch_getChannelPointer(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel)
{
    return (Ifx_GTM_CLS_TOM_CH *)((uint32)&tom->CH[channel].CTRL.U);
}
...
IFX_INLINE IfxGtm_Tom_Ch_ClkSrc IfxGtm_Tom_Ch_getClockSource(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel)
{
    ...
    clk = (IfxGtm_Tom_Ch_ClkSrc)(tom->CH[channel].CTRL.B.CLK_SRC);
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGtm_Tom_Ch_getSrcPointer(Ifx_GTM *gtm, IfxGtm_Cluster cluster, IfxGtm_Tom_Ch channel)
{
    ...
    return &MODULE_SRC.GTM.TOM[cluster].SR[channel >> 1u];
}


IFX_INLINE Ifx_GTM_CLS_TOM_TGC *IfxGtm_Tom_Ch_getTgcPointer(Ifx_GTM_CLS_TOM *tom, uint32 tgcIndex)
{
    Ifx_GTM_CLS_TOM_TGC *pointer = (Ifx_GTM_CLS_TOM_TGC *)(volatile void *)&tom->TGC[tgcIndex].GLB_CTRL;
    return pointer;
}
...
IFX_INLINE void IfxGtm_Tom_Ch_setNotification(Ifx_GTM_CLS_TOM *tom, IfxGtm_Tom_Ch channel, IfxGtm_IrqMode mode, boolean interruptOnCompareZero, boolean interruptOnCompareOne)
{
    Ifx_GTM_CLS_TOM_CH       *tomCh = &(tom->CH[channel]);

    /* Prepare new values */
    Ifx_GTM_CLS_TOM_CH_IRQ_EN en;
...
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannel(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean immediate)
{
    uint32 shift = IFXGTM_TOM_TGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_TOM_TGC_ENDIS_CTRL_ENDIS_CTRL0_OFF);
...
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelOutput(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean immediate)
{
    uint32 shift = IFXGTM_TOM_TGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_TOM_TGC_OUTEN_CTRL_OUTEN_CTRL0_OFF);
    uint32 value = (uint32)IFXGTM_TOM_TGC_CHANNEL_VALUE(enabled) << shift;
...
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled)
{
    uint32 shift = IFXGTM_TOM_TGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
    uint32 value = (uint32)IFXGTM_TOM_TGC_CHANNEL_VALUE(enabled) << shift;
    uint32 mask  = (uint32)IFXGTM_TOM_TGC_CHANNEL_MASK << shift;
...
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannels(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, boolean immediate)
{
    ...
    value             = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_TOM_TGC_ENDIS_CTRL_ENDIS_CTRL0_OFF);
...
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelsOutput(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, boolean immediate)
{
    ...
    value             = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_TOM_TGC_OUTEN_CTRL_OUTEN_CTRL0_OFF);
...
IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelsTrigger(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask)
{
    tgc->INT_TRIG.U = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_TOM_TGC_INT_TRIG_INT_TRIG0_OFF);
}


IFX_INLINE void IfxGtm_Tom_Tgc_enableChannelsUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask)
{
    tgc->GLB_CTRL.U = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
}
...
IFX_INLINE void IfxGtm_Tom_Tgc_resetChannels(Ifx_GTM_CLS_TOM_TGC *tgc, uint32 resetMask)
{
    ...
    for (i = 0u; i < IFXGTM_TOM_NUM_TGC_CHANNELS; i++)
    {
    ...
    tgc->GLB_CTRL.U = reg << IFX_GTM_CLS_TOM_TGC_GLB_CTRL_RST_CH0_OFF;
}


IFX_INLINE void IfxGtm_Tom_Tgc_setChannelForceUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean resetEnabled)
{
    uint32 shift = IFXGTM_TOM_TGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_TOM_TGC_FUPD_CTRL_FUPD_CTRL0_OFF);
    uint32 value = (uint32)IFXGTM_TOM_TGC_CHANNEL_VALUE(enabled) << shift;
    uint32 mask  = (uint32)IFXGTM_TOM_TGC_CHANNEL_MASK << shift;

    shift = (uint32)IFXGTM_TOM_TGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_TOM_TGC_FUPD_CTRL_RSTCN0_CH0_OFF);
    value = value | (uint32)((uint32)IFXGTM_TOM_TGC_CHANNEL_VALUE(resetEnabled) << shift);
    mask  = mask | (uint32)((uint32)IFXGTM_TOM_TGC_CHANNEL_MASK << shift);
...
IFX_INLINE void IfxGtm_Tom_Tgc_setChannelsForceUpdate(Ifx_GTM_CLS_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask)
{
    ...
    regEnable        = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_TOM_TGC_FUPD_CTRL_FUPD_CTRL0_OFF);
    regReset         = IfxGtm_Tom_Tgc_buildFeature(resetEnableMask, resetDisableMask, IFX_GTM_CLS_TOM_TGC_FUPD_CTRL_RSTCN0_CH0_OFF);
...
IFX_INLINE void IfxGtm_Tom_Tgc_setTimeTrigger(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tbu_Ts base, uint32 value)
{
    Ifx_GTM_CLS_TOM_TGC_ACT_TB act_tb;
...
IFX_INLINE void IfxGtm_Tom_Tgc_setInternalTrigger(Ifx_GTM_CLS_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled)
{
    uint32 shift = IFXGTM_TOM_TGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_TOM_TGC_INT_TRIG_INT_TRIG0_OFF);
    uint32 value = (uint32)IFXGTM_TOM_TGC_CHANNEL_VALUE(enabled) << shift;
    uint32 mask  = (uint32)IFXGTM_TOM_TGC_CHANNEL_MASK << shift;
