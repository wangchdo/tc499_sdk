 ...
 */
#define IFXGTM_ATOM_AGC_CHANNEL_VALUE(enabled)         ((enabled == TRUE) ? IfxGtm_FeatureControl_enable : IfxGtm_FeatureControl_disable)
...
typedef enum
{
    ...
    IfxGtm_Atom_Mode_outputBufferedControl  /**< \brief ATOM Signal Output Mode Buffered Compare (SOMB) */
} IfxGtm_Atom_Mode;
...
typedef enum
{
    IfxGtm_Atom_Ch_ClkSrc_cmuclk0  = 0,   /**< \brief cmu clock0 */
    IfxGtm_Atom_Ch_ClkSrc_cmuclk1  = 1,   /**< \brief cmu clock1 */
    IfxGtm_Atom_Ch_ClkSrc_cmuclk2  = 2,   /**< \brief cmu clock2 */
    IfxGtm_Atom_Ch_ClkSrc_cmuclk3  = 3,   /**< \brief cmu clock3 */
    IfxGtm_Atom_Ch_ClkSrc_cmuclk4  = 4,   /**< \brief cmu clock4 */
    IfxGtm_Atom_Ch_ClkSrc_cmuclk5  = 5,   /**< \brief cmu clock5 */
    IfxGtm_Atom_Ch_ClkSrc_cmuclk6  = 6,   /**< \brief cmu clock6 */
    IfxGtm_Atom_Ch_ClkSrc_cmuclk7  = 7,   /**< \brief cmu clock7 */
    IfxGtm_Atom_Ch_ClkSrc_noClock  = 8,   /**< \brief no clock */
    IfxGtm_Atom_Ch_ClkSrc_prevTrig = 13,  /**< \brief TRIG[x-1] trigger from previous channel */
    IfxGtm_Atom_Ch_ClkSrc_extTrig  = 14   /**< \brief TIM_EXT_CAPTURE */
} IfxGtm_Atom_Ch_ClkSrc;
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_clearOneNotification(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_clearZeroNotification(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_configurePwmMode(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_Ch_ClkSrc clk, Ifx_ActiveState activeState, IfxGtm_Atom_Ch_ResetEvent resetEvent, IfxGtm_Atom_Ch_OutputTrigger trigger);
 ...
 */
IFX_INLINE Ifx_GTM_CLS_ATOM_CH *IfxGtm_Atom_Ch_getChannelPointer(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE float32 IfxGtm_Atom_Ch_getClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE IfxGtm_Atom_Ch_ClkSrc IfxGtm_Atom_Ch_getClockSource(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE uint32 IfxGtm_Atom_Ch_getCompareOne(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE volatile uint32 *IfxGtm_Atom_Ch_getCompareOnePointer(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE uint32 IfxGtm_Atom_Ch_getCompareZero(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE volatile uint32 *IfxGtm_Atom_Ch_getCompareZeroPointer(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Atom_Ch_getOutputLevel(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGtm_Atom_Ch_getSrcPointer(Ifx_GTM *gtm, IfxGtm_Cluster cluster, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE volatile uint32 *IfxGtm_Atom_Ch_getTimerPointer(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Atom_Ch_isOneNotification(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Atom_Ch_isZeroNotification(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_raiseInterruptOne(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_raiseInterruptZero(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setClockSource(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_Ch_ClkSrc clk);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setCompare(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 compareZero, uint32 compareOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setCompareOne(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 compareOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setCompareOneShadow(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 shadowOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setCompareShadow(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 shadowZero, uint32 shadowOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setCompareZero(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 compareZero);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setCompareZeroShadow(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 shadowZero);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setCounterValue(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 value);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setMode(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_Mode mode);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setNotification(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_IrqMode mode, boolean interruptOnCompareZero, boolean interruptOnCompareOne);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setOneShotMode(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setResetSource(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_Ch_ResetEvent event);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setSignalLevel(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, Ifx_ActiveState activeState);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setTriggerOutput(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_Ch_OutputTrigger trigger);
 ...
 */
IFX_INLINE uint32 IfxGtm_Atom_Ch_getCounterValue(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableChannel(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelOutput(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableChannels(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelsOutput(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, boolean immediate);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelsTrigger(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelsUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_enableTimeTrigger(Ifx_GTM_CLS_ATOM_AGC *agc, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_resetChannels(Ifx_GTM_CLS_ATOM_AGC *agc, uint32 resetMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_setChannelForceUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean resetEnabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_setChannelsForceUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_setTimeTrigger(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Tbu_Ts base, uint32 value);

/** \brief Raise the trigger for the channel enable/disable settings,  output enable settings, and force update event (CTRL_TRIG)
 * \param agc Pointer to the AGC object
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_trigger(Ifx_GTM_CLS_ATOM_AGC *agc);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_setChannelsUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, uint32 value);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setAruInput(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setSomcControl(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_SomcControl control);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setSomcSignalLevelControl(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_SomcSignalLevelControl ctrl);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setAruReadAddress0(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 address);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Ch_setAruReadAddress1(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 address);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Atom_Agc_setInternalTrigger(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled);
 ...
 */
IFX_EXTERN float32 IfxGtm_Atom_Ch_getFrequency(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
 ...
 */
IFX_EXTERN float32 IfxGtm_Atom_Ch_getDuty(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel);
...
IFX_INLINE void IfxGtm_Atom_Agc_enableChannel(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean immediate)
{
    uint32 shift = IFXGTM_ATOM_AGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_ATOM_AGC_ENDIS_CTRL_ENDIS_CTRL0_OFF);
    uint32 value = (uint32)IFXGTM_ATOM_AGC_CHANNEL_VALUE(enabled) << shift;
...
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelOutput(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean immediate)
{
    uint32 shift = IFXGTM_ATOM_AGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_ATOM_AGC_OUTEN_CTRL_OUTEN_CTRL0_OFF);
    uint32 value = (uint32)IFXGTM_ATOM_AGC_CHANNEL_VALUE(enabled) << shift;
    uint32 mask  = (uint32)IFXGTM_ATOM_AGC_CHANNEL_MASK << shift;
...
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled)
{
    uint32 shift = IFXGTM_ATOM_AGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_ATOM_AGC_GLB_CTRL_UPEN_CTRL0_OFF);
    uint32 value = (uint32)IFXGTM_ATOM_AGC_CHANNEL_VALUE(enabled) << shift;
    uint32 mask  = (uint32)IFXGTM_ATOM_AGC_CHANNEL_MASK << shift;
...
IFX_INLINE void IfxGtm_Atom_Agc_enableChannels(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, boolean immediate)
{
    ...
    value             = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_ATOM_AGC_ENDIS_CTRL_ENDIS_CTRL0_OFF);
...
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelsOutput(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, boolean immediate)
{
    ...
    value             = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_ATOM_AGC_OUTEN_CTRL_OUTEN_CTRL0_OFF);
...
IFX_INLINE void IfxGtm_Atom_Agc_enableChannelsTrigger(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask)
{
    agc->INT_TRIG.U = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_ATOM_AGC_INT_TRIG_INT_TRIG0_OFF);
}


IFX_INLINE void IfxGtm_Atom_Agc_enableChannelsUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask)
{
    agc->GLB_CTRL.U = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_ATOM_AGC_GLB_CTRL_UPEN_CTRL0_OFF);
}
...
IFX_INLINE void IfxGtm_Atom_Agc_resetChannels(Ifx_GTM_CLS_ATOM_AGC *agc, uint32 resetMask)
{
    ...
    agc->GLB_CTRL.U = reg << IFX_GTM_CLS_ATOM_AGC_GLB_CTRL_RST_CH0_OFF;
}


IFX_INLINE void IfxGtm_Atom_Agc_setChannelForceUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean resetEnabled)
{
    uint32 shift = IFXGTM_ATOM_AGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_ATOM_AGC_FUPD_CTRL_FUPD_CTRL0_OFF);
    uint32 value = (uint32)IFXGTM_ATOM_AGC_CHANNEL_VALUE(enabled) << shift;
    uint32 mask  = (uint32)IFXGTM_ATOM_AGC_CHANNEL_MASK << shift;

    shift = (uint32)IFXGTM_ATOM_AGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_ATOM_AGC_FUPD_CTRL_RSTCN0_CH0_OFF);
    value = (uint32)value | (uint32)((uint32)IFXGTM_ATOM_AGC_CHANNEL_VALUE(resetEnabled) << shift);
    mask  = mask | (uint32)((uint32)IFXGTM_ATOM_AGC_CHANNEL_MASK << shift);
...
IFX_INLINE void IfxGtm_Atom_Agc_setChannelsForceUpdate(Ifx_GTM_CLS_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask)
{
    ...
    regEnable        = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, IFX_GTM_CLS_ATOM_AGC_FUPD_CTRL_FUPD_CTRL0_OFF);
    regReset         = IfxGtm_Atom_Agc_buildFeature(resetEnableMask, resetDisableMask, IFX_GTM_CLS_ATOM_AGC_FUPD_CTRL_RSTCN0_CH0_OFF);
...
IFX_INLINE void IfxGtm_Atom_Agc_setTimeTrigger(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Tbu_Ts base, uint32 value)
{
    Ifx_GTM_CLS_ATOM_AGC_ACT_TB act_tb;
...
IFX_INLINE void IfxGtm_Atom_Ch_configurePwmMode(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Atom_Ch_ClkSrc clk, Ifx_ActiveState activeState, IfxGtm_Atom_Ch_ResetEvent resetEvent, IfxGtm_Atom_Ch_OutputTrigger trigger)
{
    Ifx_GTM_CLS_ATOM_CH     *atomCh = IfxGtm_Atom_Ch_getChannelPointer(atom, channel);
    Ifx_GTM_CLS_ATOM_CH_CTRL ctrl;

    ctrl.U            = 0u;
    ctrl.B.MODE       = (uint8)IfxGtm_Atom_Mode_outputPwm;
...
IFX_INLINE Ifx_GTM_CLS_ATOM_CH *IfxGtm_Atom_Ch_getChannelPointer(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    return (Ifx_GTM_CLS_ATOM_CH *)((uint32)&atom->CH[channel].RDADDR.U);
}


IFX_INLINE float32 IfxGtm_Atom_Ch_getClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    IfxGtm_Atom_Ch_ClkSrc clk;
    float32               result = 0.0f;

    clk = IfxGtm_Atom_Ch_getClockSource(atom, channel);

    if (clk <= IfxGtm_Atom_Ch_ClkSrc_cmuclk7)
    {
        result = IfxGtm_Cmu_getClkFrequency(gtm, (IfxGtm_Cmu_Clk)clk, TRUE);
    }
...
IFX_INLINE IfxGtm_Atom_Ch_ClkSrc IfxGtm_Atom_Ch_getClockSource(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    return (IfxGtm_Atom_Ch_ClkSrc)(atom->CH[channel].CTRL.B.CLK_SRC);
}
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGtm_Atom_Ch_getSrcPointer(Ifx_GTM *gtm, IfxGtm_Cluster cluster, IfxGtm_Atom_Ch channel)
{
    ...
    return &MODULE_SRC.GTM.ATOM[cluster].SR[channel >> 1u];
}


IFX_INLINE volatile uint32 *IfxGtm_Atom_Ch_getTimerPointer(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    return (volatile uint32 *)((uint32)&(atom->CH[channel].CN0.U));
}
...
IFX_INLINE void IfxGtm_Atom_Ch_setNotification(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_IrqMode mode, boolean interruptOnCompareZero, boolean interruptOnCompareOne)
{
    Ifx_GTM_CLS_ATOM_CH       *atomCh = &(atom->CH[channel]);

    /* Prepare new values */
    Ifx_GTM_CLS_ATOM_CH_IRQ_EN en;
...
IFX_INLINE void IfxGtm_Atom_Ch_setAruInput(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, boolean enabled)
{
    atom->CH[channel].CTRL.B.ARU_EN = (uint8)enabled;
}
...
IFX_INLINE void IfxGtm_Atom_Ch_setAruReadAddress0(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 address)
{
    atom->CH[channel].RDADDR.B.RDADDR0 = (uint16)address;
}


IFX_INLINE void IfxGtm_Atom_Ch_setAruReadAddress1(Ifx_GTM_CLS_ATOM *atom, IfxGtm_Atom_Ch channel, uint32 address)
{
    atom->CH[channel].RDADDR.B.RDADDR1 = (uint16)address;
}
...
IFX_INLINE void IfxGtm_Atom_Agc_setInternalTrigger(Ifx_GTM_CLS_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled)
{
    uint32 shift = IFXGTM_ATOM_AGC_CHANNEL_SHIFT(channel, IFX_GTM_CLS_ATOM_AGC_INT_TRIG_INT_TRIG0_OFF);
    uint32 value = (uint32)IFXGTM_ATOM_AGC_CHANNEL_VALUE(enabled) << shift;
    uint32 mask  = (uint32)IFXGTM_ATOM_AGC_CHANNEL_MASK << shift;
