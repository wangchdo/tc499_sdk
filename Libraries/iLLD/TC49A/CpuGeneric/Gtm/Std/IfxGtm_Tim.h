...
typedef enum
{
    ...
    IfxGtm_Tim_Mode_gatedPeriodic,       /**< \brief TGPS */
    IfxGtm_Tim_Mode_serialShift          /**< \brief TSSM */
} IfxGtm_Tim_Mode;
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_clearAuxInputSourceSelection(Ifx_GTM *gtm, IfxGtm_Cluster clsIndex, IfxGtm_Tim_Ch channel);

/** \brief Clears the counter overflow flag
 * \param channel TIM channel pointer
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_clearCntOverflowEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Clears the data lost flag
 * \param channel TIM channel pointer
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_clearDataLostEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Clears the event counter overflow flag
 * \param channel TIM channel pointer
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_clearEcntOverflowEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Clears the glitch flag
 * \param channel TIM channel pointer
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_clearGlitchEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Clears the new value flag
 * \param channel TIM channel pointer
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_clearNewValueEvent(Ifx_GTM_CLS_TIM_CH *channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_clearNotification(Ifx_GTM_CLS_TIM_CH *channel, IfxGtm_Tim_IrqType irqType);
 ...
 */
IFX_INLINE float32 IfxGtm_Tim_Ch_getCaptureClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Returns the capture clock source selected
 * \param channel TIM channel pointer
 * \return capture clock source
 */
IFX_INLINE IfxGtm_Cmu_Clk IfxGtm_Tim_Ch_getCaptureClockSource(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Returns the Filter clock source selected
 * \param channel TIM channel pointer
 * \return Filter clock source
 */
IFX_INLINE IfxGtm_Cmu_Tim_Filter_Clk IfxGtm_Tim_Ch_getFilterClockSource(Ifx_GTM_CLS_TIM_CH *channel);
 ...
 */
IFX_INLINE boolean IfxGtm_Tim_Ch_getNotification(Ifx_GTM_CLS_TIM_CH *channel, IfxGtm_Tim_IrqType irqType);
 ...
 */
IFX_INLINE float32 IfxGtm_Tim_Ch_getTimeoutClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Returns the Timeout clock source selected
 * \param channel TIM channel pointer
 * \return Timeout clock source
 */
IFX_INLINE IfxGtm_Cmu_Clk IfxGtm_Tim_Ch_getTimeoutClockSource(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Test the counter overflow flag
 * \param channel TIM channel pointer
 * \return TRUE if the flag is set, else FALSE
 */
IFX_INLINE boolean IfxGtm_Tim_Ch_isCntOverflowEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Test the data lost flag
 * \param channel TIM channel pointer
 * \return TRUE if the flag is set, else FALSE
 */
IFX_INLINE boolean IfxGtm_Tim_Ch_isDataLostEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Test the event counter overflow flag
 * \param channel TIM channel pointer
 * \return TRUE if the flag is set, else FALSE
 */
IFX_INLINE boolean IfxGtm_Tim_Ch_isEcntOverflowEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Test the glitch flag
 * \param channel TIM channel pointer
 * \return TRUE if the flag is set, else FALSE
 */
IFX_INLINE boolean IfxGtm_Tim_Ch_isGlitchEvent(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Test the new value flag
 * \param channel TIM channel pointer
 * \return TRUE if the flag is set, else FALSE
 */
IFX_INLINE boolean IfxGtm_Tim_Ch_isNewValueEvent(Ifx_GTM_CLS_TIM_CH *channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setAuxInputSourceSelection(Ifx_GTM *gtm, IfxGtm_Cluster clsIndex, IfxGtm_Tim_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setChannelNotification(Ifx_GTM_CLS_TIM_CH *channel, boolean irqOnNewVal, boolean irqOnCntOverflow, boolean irqOnEcntOverflow, boolean irqOnDatalost);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setClockSource(Ifx_GTM_CLS_TIM_CH *channel, IfxGtm_Cmu_Clk clk);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setEdgeCounter(Ifx_GTM_CLS_TIM_CH *channel, uint8 edgeCounter);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setFallingEdgeFilterTime(Ifx_GTM_CLS_TIM_CH *channel, uint32 filterTime);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setFilterNotification(Ifx_GTM_CLS_TIM_CH *channel, boolean irqOnGlitch);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setInputSourceSelection(Ifx_GTM_CLS_TIM *tim, IfxGtm_Tim_Ch channel, IfxGtm_Tim_InputSourceSelect inputSource);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setNotificationMode(Ifx_GTM_CLS_TIM_CH *channel, IfxGtm_IrqMode mode);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setNotification(Ifx_GTM_CLS_TIM_CH *channel, IfxGtm_Tim_IrqType irqType);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setTimeoutNotification(Ifx_GTM_CLS_TIM_CH *channel, boolean irqOnTimeout);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setRisingEdgeFilterTime(Ifx_GTM_CLS_TIM_CH *channel, uint32 filterTime);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_setShadowCounter(Ifx_GTM_CLS_TIM_CH *channel, uint32 shadowCounter);
 ...
 */
IFX_INLINE Ifx_GTM_CLS_TIM_CH *IfxGtm_Tim_getChannel(Ifx_GTM_CLS_TIM *tim, IfxGtm_Tim_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tim_Ch_resetChannel(Ifx_GTM_CLS_TIM *tim, IfxGtm_Tim_Ch channel);
 ...
 */
IFX_EXTERN float32 IfxGtm_Tim_Ch_getFilterClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_TIM_CH *channel);
 ...
 * \return None
 */
IFX_EXTERN void IfxGtm_Tim_Ch_setControl(Ifx_GTM_CLS_TIM_CH *channel, IfxGtm_Tim_ChannelControl control);
 ...
 */
IFX_INLINE uint32 IfxGtm_Tim_Ch_getCountValue(Ifx_GTM_CLS_TIM_CH *channel);

/** \brief Get shadow count of TIM channel
 * \param channel Pointer to TIM channel base
 * \return number of shadow count
 */
IFX_INLINE uint32 IfxGtm_Tim_Ch_getShadowCountValue(Ifx_GTM_CLS_TIM_CH *channel);
...
IFX_INLINE void IfxGtm_Tim_Ch_clearAuxInputSourceSelection(Ifx_GTM *gtm, IfxGtm_Cluster clsIndex, IfxGtm_Tim_Ch channel)
{
    Ifx_GTM_CLS_CCM_TIM_AUX_IN_SRC src;
    src.U                                   = gtm->CLS[clsIndex].CCM.TIM_AUX_IN_SRC.U;
    src.U                                  &= (uint32)(~((uint32)1u << (uint8)channel));
    gtm->CLS[clsIndex].CCM.TIM_AUX_IN_SRC.U = src.U;
}


IFX_INLINE void IfxGtm_Tim_Ch_clearCntOverflowEvent(Ifx_GTM_CLS_TIM_CH *channel)
{
    channel->IRQ_NOTIFY.U = 0x1u << IFX_GTM_CLS_TIM_CH_IRQ_NOTIFY_CNTOFL_OFF;
}


IFX_INLINE void IfxGtm_Tim_Ch_clearDataLostEvent(Ifx_GTM_CLS_TIM_CH *channel)
{
    channel->IRQ_NOTIFY.U = 0x1u << IFX_GTM_CLS_TIM_CH_IRQ_NOTIFY_GPROFL_OFF;
}


IFX_INLINE void IfxGtm_Tim_Ch_clearEcntOverflowEvent(Ifx_GTM_CLS_TIM_CH *channel)
{
    channel->IRQ_NOTIFY.U = 0x1u << IFX_GTM_CLS_TIM_CH_IRQ_NOTIFY_ECNTOFL_OFF;
}


IFX_INLINE void IfxGtm_Tim_Ch_clearGlitchEvent(Ifx_GTM_CLS_TIM_CH *channel)
{
    channel->IRQ_NOTIFY.U = 0x1u << IFX_GTM_CLS_TIM_CH_IRQ_NOTIFY_GLITCHDET_OFF;
}


IFX_INLINE void IfxGtm_Tim_Ch_clearNewValueEvent(Ifx_GTM_CLS_TIM_CH *channel)
{
    channel->IRQ_NOTIFY.U = 0x1u << IFX_GTM_CLS_TIM_CH_IRQ_NOTIFY_NEWVAL_OFF;
}
...
IFX_INLINE float32 IfxGtm_Tim_Ch_getCaptureClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_TIM_CH *channel)
{
    ...
    clk = IfxGtm_Tim_Ch_getCaptureClockSource(channel);
...
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGtm_Tim_Ch_getSrcPointer(Ifx_GTM *gtm, IfxGtm_Tim tim, IfxGtm_Tim_Ch channel)
{
    ...
    return &MODULE_SRC.GTM.TIM[tim].SR[channel];
}
...
IFX_INLINE float32 IfxGtm_Tim_Ch_getTimeoutClockFrequency(Ifx_GTM *gtm, Ifx_GTM_CLS_TIM_CH *channel)
{
    ...
    clk = IfxGtm_Tim_Ch_getTimeoutClockSource(channel);
...
IFX_INLINE Ifx_GTM_CLS_TIM_CH *IfxGtm_Tim_getChannel(Ifx_GTM_CLS_TIM *tim, IfxGtm_Tim_Ch channel)
{
    return (Ifx_GTM_CLS_TIM_CH *)((uint32)&tim->CH[channel].GPR0.U);
}
...
IFX_INLINE void IfxGtm_Tim_Ch_setTimTin(IfxGtm_Tim timIndex, IfxGtm_Tim_Ch channelIndex, uint32 tinSel)
{
    ...
    Ifx__ldmst(&(MODULE_GTM.TIMINSEL[timIndex].U), ((uint32)0xFU << shift), (tinSel) << shift);
}
