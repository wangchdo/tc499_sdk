 ...
 *
 * This interface allows to generate simple PWM signal on a TOM output and can generate interrupts if enabled.
...
typedef struct
{
    ...
    IfxGtm_Cluster           cluster;                        /**< \brief Cluster of TOM channel to be used */
    IfxGtm_Tom_Ch            tomChannel;                     /**< \brief TOM channel to be used for PWM */
    IfxGtm_Tom_Ch_ClkSrc     clock;                          /**< \brief Clock source for selected TOM channel */
