 ...
 *   edge \ref IfxGtm_Tom_Timer_Config "configuration", the CM0 will reset, and the CM1 will set the trigger signal, or vice versa.
 *
 ...
 *   Depending on the trigger signal active edge \ref IfxGtm_Tom_Timer_Config "configuration", the CM0 will reset, and the CM1 will set the trigger signal, or vice versa.
 ...
 *   - The timer counting direction is limited to \ref IfxGtm_Tom_Timer_CountDir_up.
 ...
 * // initialize TOM
 * \code
 * IfxGtm_Tom_Timer_Config tomConfig;      \\configuration structure
 * IfxGtm_Tom_Timer tomHandle;      \\ handle
 *
 * IfxGtm_Tom_Pwm_initConfig(&tomConfig, gtm);
 *
 *     //configuration
 *     tomConfig.gtm                               = gtm;
 *     tomConfig.cluster                           = IfxGtm_Cluster_0;
 *     tomConfig.timerChannel                      = IfxGtm_Tom_Ch_0;
 *     tomConfig.clock                             = IfxGtm_Tom_Ch_ClkSrc_cmuFxclk0;
 *     tomConfig.countDir                          = IfxGtm_Tom_Timer_CountDir_up;
 ...
 *
 * IfxGtm_Tom_Timer_init (&tomHandle, &tomConfig);
 *
 * \endcode
 *
 * During run-time
 * \code
 *  IfxGtm_Tom_Timer_run(&tomHandle);
 *  IfxGtm_Tom_Timer_disableUpdate(&tomHandle);
 *  IfxGtm_Tom_Timer_setPeriod(&tomHandle);
 *  IfxGtm_Tom_Timer_applyUpdate(&tomHandle);
 *
 * \endcode
 *
 ...
 * \ingroup IfxLld_Gtm_Tom_Timer
 * \defgroup IfxLld_Gtm_Tom_Timer_Enumerations Enumerations
 * \ingroup IfxLld_Gtm_Tom_Timer
 */
...
/** \addtogroup IfxLld_Gtm_Tom_Timer_Enumerations
 * \{ */
/** \brief Timer increment direction
 */
typedef enum
{
    IfxGtm_Tom_Timer_CountDir_up,         /**< \brief Timer is counting up */
    IfxGtm_Tom_Timer_CountDir_upAndDown,  /**< \brief Timer is counting up and down */
    IfxGtm_Tom_Timer_CountDir_down        /**< \brief Timer is counting down */
} IfxGtm_Tom_Timer_CountDir;
...
typedef struct
{
    ...
    IfxGtm_Tom_Timer_Interrupt interrupt;                /**< \brief Interrupt configuration */
} IfxGtm_Tom_Timer_Trigger;
...
typedef struct
{
    ...
    Ifx_GTM_CLS_TOM          *tom;                                                     /**< \brief Pointer to the TOM object */
    Ifx_GTM_CLS_TOM_TGC      *tgc[IFXGTM_TOM_NUM_TGC];                                 /**< \brief Pointer to the TGC object */
    ...
    uint16                    channelsMask[IFXGTM_TOM_NUM_TGC];                        /**< \brief Mask for channels to be modified together, The 1st value corresponds to the Timer's TGC, the 2nd value corresponds to the timer's next TGC if any */
    uint32                    offset;                                                  /**< \brief Timer initial offset in ticks */
    uint32                    tgcGlobalControlDisableUpdate[IFXGTM_TOM_NUM_TGC];       /**< \brief Cached value for TGC GLOB_CTR */
    uint32                    tgcGlobalControlApplyUpdate[IFXGTM_TOM_NUM_TGC];         /**< \brief Cached value for TGC GLOB_CTR */
    Ifx_GTM_CLS_CDTM_DTM     *dtm;                                                     /**< \brief Pointer to DTM object used by TOM */
    ...
    IfxGtm_Tom_Timer_CountDir countDir;                                                /**< \brief Timer counting mode */
} IfxGtm_Tom_Timer;
...
typedef struct
{
    ...
    IfxGtm_Tom_Timer_CountDir  countDir;             /**< \brief Timer counting mode */
    IfxGtm_Tom_Timer_Interrupt interrupt;            /**< \brief Interrupt configuration */
    IfxGtm_Tom_Timer_Trigger   trigger;              /**< \brief Interrupt configuration */
 ...
 */
IFX_INLINE uint32 IfxGtm_Tom_Timer_getOffset(IfxGtm_Tom_Timer *driver);

/** \brief Returns the pointer to timer channel
 * \param driver TOM Timer interface Handle
 * \return Pointer
 */
IFX_INLINE volatile uint32 *IfxGtm_Tom_Timer_getPointer(IfxGtm_Tom_Timer *driver);

/** \brief Returns the pointer to trigger channel
 * \param driver TOM Timer interface Handle
 * \return Pointer
 */
IFX_INLINE volatile uint32 *IfxGtm_Tom_Timer_getTriggerPointer(IfxGtm_Tom_Timer *driver);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Timer_addToChannelMask(IfxGtm_Tom_Timer *driver, IfxGtm_Tom_Ch channel);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Timer_applyUpdate(IfxGtm_Tom_Timer *driver);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Timer_disableUpdate(IfxGtm_Tom_Timer *driver);
 ...
 * \return Frequency
 */
IFX_INLINE float32 IfxGtm_Tom_Timer_getFrequency(IfxGtm_Tom_Timer *driver);

/** \brief Returns the Input frequency
 * \param driver TOM Timer interface Handle
 * \return Frequency
 */
IFX_INLINE float32 IfxGtm_Tom_Timer_getInputFrequency(IfxGtm_Tom_Timer *driver);
 ...
 * \return Period
 */
IFX_INLINE uint16 IfxGtm_Tom_Timer_getPeriod(IfxGtm_Tom_Timer *driver);
 ...
 * \return Resolution
 */
IFX_INLINE float32 IfxGtm_Tom_Timer_getResolution(IfxGtm_Tom_Timer *driver);

/** \brief Returns the trigger point
 * \param driver TOM Timer interface Handle
 * \return Trigger point
 */
IFX_INLINE uint16 IfxGtm_Tom_Timer_getTrigger(IfxGtm_Tom_Timer *driver);
 ...
 * \return TRUE on success else FALSE
 */
IFX_INLINE boolean IfxGtm_Tom_Timer_setFrequency(IfxGtm_Tom_Timer *driver, float32 frequency);
 ...
 * \return TRUE on success else FALSE
 */
IFX_INLINE boolean IfxGtm_Tom_Timer_setPeriod(IfxGtm_Tom_Timer *driver, uint16 period);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Timer_setSingleMode(IfxGtm_Tom_Timer *driver, boolean enabled);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Timer_setTrigger(IfxGtm_Tom_Timer *driver, uint16 triggerPoint);
 ...
 * \return None
 */
IFX_INLINE void IfxGtm_Tom_Timer_updateInputFrequency(IfxGtm_Tom_Timer *driver);
...
IFX_INLINE void IfxGtm_Tom_Timer_addToChannelMask(IfxGtm_Tom_Timer *driver, IfxGtm_Tom_Ch channel)
{
    if (driver->timerChannel <= IfxGtm_Tom_Ch_7)
    {
        if (channel <= IfxGtm_Tom_Ch_7)
        {
            ...
            driver->tgcGlobalControlDisableUpdate[0] = IfxGtm_Tom_Tgc_buildFeature(0, driver->channelsMask[0], IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
            driver->tgcGlobalControlApplyUpdate[0]   = IfxGtm_Tom_Tgc_buildFeature(driver->channelsMask[0], 0, IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
        }
        else
        {
            driver->channelsMask[1]                 |= (uint16)((uint16)1u << (uint16)((uint16)channel - (uint16)IfxGtm_Tom_Ch_8));
            driver->tgcGlobalControlDisableUpdate[1] = IfxGtm_Tom_Tgc_buildFeature(0, driver->channelsMask[1], IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
            driver->tgcGlobalControlApplyUpdate[1]   = IfxGtm_Tom_Tgc_buildFeature(driver->channelsMask[1], 0, IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
        }
    }
    else
    {
        driver->channelsMask[0]                 |= (uint16)((uint16)1u << (uint16)((uint16)channel - (uint16)IfxGtm_Tom_Ch_8));
        driver->tgcGlobalControlDisableUpdate[0] = IfxGtm_Tom_Tgc_buildFeature(0, driver->channelsMask[0], IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
        driver->tgcGlobalControlApplyUpdate[0]   = IfxGtm_Tom_Tgc_buildFeature(driver->channelsMask[0], 0, IFX_GTM_CLS_TOM_TGC_GLB_CTRL_UPEN_CTRL0_OFF);
    }
}
...
IFX_INLINE uint16 IfxGtm_Tom_Timer_getTrigger(IfxGtm_Tom_Timer *driver)
{
    return IfxGtm_Tom_Ch_getCompareOne(driver->tom, driver->triggerChannel) - 1u;
}
...
IFX_INLINE boolean IfxGtm_Tom_Timer_setFrequency(IfxGtm_Tom_Timer *driver, float32 frequency)
{
    uint16 period = (uint16)IfxGtm_sToTick(driver->clockFreq, (float32)1.0f / frequency);
...
IFX_INLINE void IfxGtm_Tom_Timer_setTrigger(IfxGtm_Tom_Timer *driver, uint16 triggerPoint)
{
    IfxGtm_Tom_Ch_setCompareOneShadow(driver->tom, driver->triggerChannel, triggerPoint + 1u);
}


IFX_INLINE void IfxGtm_Tom_Timer_updateInputFrequency(IfxGtm_Tom_Timer *driver)
{
    driver->clockFreq = IfxGtm_Tom_Ch_getClockFrequency(driver->gtm, driver->tom, driver->timerChannel);
}
