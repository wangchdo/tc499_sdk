 ...
 *      IfxAdc_Cdsp_Trigger srvtrigger    = {IfxAdc_CdspTriggerSel_0, IfxAdc_CdspTriggerMode_risingEdge, 100};
 ...
 *      IfxAdc_Cdsp_MemoryConfig memoryCfg = {&cdspFgaIccmImage, &cdspFc0Dccm, cdspFgaIccmImageSize, cdspFc0DccmSize};
 *
...
typedef struct
{
    IfxAdc_CdspIntegratorWindowControl windowSizeControl;       /**< \brief Configuration for integrator window control */
    boolean                            enableIntegrator;        /**< \brief Enable/Disable integrator */
} IfxAdc_Cdsp_IntegratorConfig;
...
typedef struct
{
    IfxAdc_Cdsp_Trigger *serviceReqTrig;       /**< \brief Service trigger Configuration. Trigger Mode will be ignored for service request configuration */
    ...
    IfxAdc_Cdsp_Trigger *integratorTrig;       /**< \brief Integrator trigger Configuration */
...
typedef struct
{
    ...
    IfxAdc_Cdsp_IntegratorConfig *integratorCfg;        /**< \brief Integrator configuration */
...
typedef struct
{
    ...
    sint16 result;          /**< \brief result value */
} IfxAdc_Cdsp_Result;
