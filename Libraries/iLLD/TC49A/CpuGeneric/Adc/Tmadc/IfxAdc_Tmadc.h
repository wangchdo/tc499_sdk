...
typedef struct
{
    ...
    IfxAdc_TmadcEmuxChannel     emuxChannel;           /**< \brief Emux channel number */
    IfxAdc_TmadcEmuxMode        mode;                  /**< \brief External multiplexer mode */
    boolean                     emuxCi0;               /**< \brief True --> Control interface 0 enabled */
    boolean                     emuxCi1;               /**< \brief True --> Control interface 1 enabled */
    boolean                     chnlUpdate;            /**< \brief True --> Shadow update for channel number */
    boolean                     exmuxCodeScheme;       /**< \brief True --> EMUX channel selection lines are gray coded */
    IfxAdc_Tmadc_TriggerConfig *trigger;               /**< \brief Emux trigger configuration */
...
typedef struct
{
    ...
    IfxAdc_TmadcEmuxChannel  emuxChannel;       /**< \brief ID of channel connected to external multiplexer */
...
typedef struct
{
    ...
    volatile Ifx_ADC_TMADCRES_RESAXI *rsltAXI;                /**< \brief Pointer to the result register from LLI view */
    volatile Ifx_ADC_TMADCRES_TSAXI  *tmstmpAXI;              /**< \brief Pointer to the timestamp register from LLI view */
...
typedef struct
{
    ...
    volatile Ifx_ADC_TMADCRES_MRESAXI *rsltAXI;        /**< \brief Pointer to the result register from LLI view */
