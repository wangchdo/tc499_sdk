 ...
 *  \endcode
 *
 * \defgroup IfxLld_ScrPort_Std_Enumerations Enum
 * \ingroup IfxLld_ScrPort_Std
 * \defgroup IfxLld_ScrPort_Std_DataStructures Data structures
 * \ingroup IfxLld_ScrPort_Std
 * \defgroup IfxLld_ScrPort_Std_init Port Functionality
 * \ingroup IfxLld_ScrPort_Std
 */
...
/*-------------------------------Enumerations---------------------------------*/
/******************************************************************************/
/** \addtogroup IfxLld_ScrPort_Std_Enumerations
 * \{ */
/** \brief Port Number
 */
typedef enum
...
/*-----------------------------Data Structures--------------------------------*/
/******************************************************************************/
/** \addtogroup IfxLld_ScrPort_Std_DataStructures
 * \{ */
...
/** \addtogroup IfxLld_ScrPort_Std_init
 * \{ */
/******************************************************************************/
...
IFX_INLINE void IfxScrPort_setPinHigh(IfxScrPort_Index portIndex, IfxScrPort_PinIndex pinIndex)
{
    ...
    {
        IFX_ASSERT(IFX_VERBOSE_LEVEL_ERROR, (pinIndex < IfxScrPort_PinIndex_5));

        if (pinIndex < IfxScrPort_PinIndex_5)
        {
...
IFX_INLINE IfxScrPort_PinState IfxScrPort_getPinState(IfxScrPort_Index portIndex, IfxScrPort_PinIndex pinIndex)
{
    ...
    {
        IFX_ASSERT(IFX_VERBOSE_LEVEL_ERROR, (pinIndex > IfxScrPort_PinIndex_4));
