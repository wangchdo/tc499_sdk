...
/** \brief Length for Ifx_SCR_SCU_IRAMCTRL_Bits.IRAMECCEN */
#define IFX_SCR_SCU_IRAMCTRL_IRAMECCEN_LEN (1u)

/** \brief Mask for Ifx_SCR_SCU_IRAMCTRL_Bits.IRAMECCEN */
#define IFX_SCR_SCU_IRAMCTRL_IRAMECCEN_MSK (0x1u)

/** \brief Offset for Ifx_SCR_SCU_IRAMCTRL_Bits.IRAMECCEN */
#define IFX_SCR_SCU_IRAMCTRL_IRAMECCEN_OFF (0u)
