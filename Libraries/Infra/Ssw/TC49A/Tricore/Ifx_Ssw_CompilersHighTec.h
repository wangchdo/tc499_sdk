 ...
 * \brief Startup Software for HighTec compiler options
 *
...
#define Ifx_Ssw_Barrier() __asm__ volatile("":::"memory");

#if (__TRICORE_CORE__ == 0x162)
...
#else
#define Ifx_Ssw_HVCALL(hvcno) __asm__ volatile ("hvcall "STRINGIFY(hvcno) : : : "memory")

#define Ifx_Ssw_RFH() __asm__ volatile ("rfh "STRINGIFY() : : : "memory")
#endif
...
{
    unsigned int var;
    __asm__ volatile (" mov\t %0, %%d15" : "=d" (var));
    return var;
}

IFX_SSW_INLINE void Ifx_Ssw_setA11(void *Addr)
{
    __asm__ volatile ("mov.aa %%a11, %0": : "a" (Addr) :"a11");
}
