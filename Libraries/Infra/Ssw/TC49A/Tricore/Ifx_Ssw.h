...
#define IFX_CFG_SSW_ENABLE_TRICORE0 1   /* control if core 0 should be started*/
#define IFX_CFG_SSW_ENABLE_TRICORE1 0   /* control if core 1 should be started*/
#define IFX_CFG_SSW_ENABLE_TRICORE2 0   /* control if core 2 should be started*/
#define IFX_CFG_SSW_ENABLE_TRICORE3 0   /* control if core 3 should be started*/
#define IFX_CFG_SSW_ENABLE_TRICORE4 0   /* control if core 4 should be started*/
#define IFX_CFG_SSW_ENABLE_TRICORE5 0   /* control if core 5 should be started*/
 ...
 *    stad   = 0xA0000000
 * CRC calculation:
 *    Input        = 0xB359000EA0000000
 *    CRC value    = 0x442D2C9DU
 *    CRC Inverted = 0xBBD2D362U
 */
typedef struct
{
...
typedef struct
{
    ...
    unsigned int reserved0;             /**< \brief 0x004: Reserved */
    unsigned int oscCfg;                /**< \brief 0x008: User Selection for CLK_OSCCON*/
    ...
    unsigned int lockstepEna;           /**< \brief 0x01C: User selection for LOCKSTEP activation*/
