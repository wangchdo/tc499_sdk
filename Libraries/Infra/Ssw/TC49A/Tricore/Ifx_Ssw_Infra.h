...
/** \brief Disable the HW virtualization feature
 *
 * This API will Disable the HW virtualization feature
 */
extern void Ifx_Ssw_disableVirtualization(void);
