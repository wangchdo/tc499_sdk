...
typedef struct _Ifx_INT_GPSRG_SWC_Bits
{
    ...
    __I  Ifx_UReg_32Bit LOCKSTAT:1;        /**< \brief [18:18] Status of DATA lock (r) */
...
{
    __IO Ifx_UReg_32Bit TOS0:4;            /**< \brief [3:0] Type of Service Request TOS encoding for Observation on OTGB0 (rw) */
    __I  Ifx_UReg_32Bit :3;                /**< \brief [6:4] \internal Reserved */
    __IO Ifx_UReg_32Bit OE0:1;             /**< \brief [7:7] Output Enable for OTGB0 (rw) */
    __IO Ifx_UReg_32Bit TOS1:4;            /**< \brief [11:8] Type of Service Request TOS encoding for Observation on OTGB1 (rw) */
