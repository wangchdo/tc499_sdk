...
typedef struct _Ifx_MSC_UD_Bits
{
    ...
    __I  Ifx_UReg_32Bit PERR:1;            /**< \brief [22:22] Parity Error - PERR (rh) */
...
typedef volatile struct _Ifx_MSC
{
       ...
       __IO Ifx_MSC_DSCE                        DSCE;                   /**< \brief 98, Downstream Control Enhanced Register 1*/
       __IO Ifx_MSC_USCE                        USCE;                   /**< \brief 9C, Upstream Control Enhanced Register 1*/
