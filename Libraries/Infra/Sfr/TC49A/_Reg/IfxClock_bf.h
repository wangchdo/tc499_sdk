...
/** \brief Length for Ifx_CLOCK_OSCCON_Bits.APREN */
#define IFX_CLOCK_OSCCON_APREN_LEN (1u)

/** \brief Mask for Ifx_CLOCK_OSCCON_Bits.APREN */
#define IFX_CLOCK_OSCCON_APREN_MSK (0x1u)

/** \brief Offset for Ifx_CLOCK_OSCCON_Bits.APREN */
#define IFX_CLOCK_OSCCON_APREN_OFF (4u)
...
/** \brief Length for Ifx_CLOCK_OSCCON_Bits.CLKSELPHY */
#define IFX_CLOCK_OSCCON_CLKSELPHY_LEN (1u)

/** \brief Mask for Ifx_CLOCK_OSCCON_Bits.CLKSELPHY */
#define IFX_CLOCK_OSCCON_CLKSELPHY_MSK (0x1u)

/** \brief Offset for Ifx_CLOCK_OSCCON_Bits.CLKSELPHY */
#define IFX_CLOCK_OSCCON_CLKSELPHY_OFF (28u)
...
/** \brief Length for Ifx_CLOCK_RAMPCON0_Bits.SZ */
#define IFX_CLOCK_RAMPCON0_SZ_LEN (2u)

/** \brief Mask for Ifx_CLOCK_RAMPCON0_Bits.SZ */
#define IFX_CLOCK_RAMPCON0_SZ_MSK (0x3u)

/** \brief Offset for Ifx_CLOCK_RAMPCON0_Bits.SZ */
#define IFX_CLOCK_RAMPCON0_SZ_OFF (20u)

/** \brief Length for Ifx_CLOCK_RAMPCON0_Bits.WAIT */
#define IFX_CLOCK_RAMPCON0_WAIT_LEN (2u)

/** \brief Mask for Ifx_CLOCK_RAMPCON0_Bits.WAIT */
#define IFX_CLOCK_RAMPCON0_WAIT_MSK (0x3u)

/** \brief Offset for Ifx_CLOCK_RAMPCON0_Bits.WAIT */
#define IFX_CLOCK_RAMPCON0_WAIT_OFF (22u)
...
#define IFX_CLOCK_PERPLLCON1_K3PREDIV_LEN (2u)

/** \brief Mask for Ifx_CLOCK_PERPLLCON1_Bits.K3PREDIV */
#define IFX_CLOCK_PERPLLCON1_K3PREDIV_MSK (0x3u)
...
/** \brief Length for Ifx_CLOCK_SYSCCUCON1_Bits.GTMDIV */
#define IFX_CLOCK_SYSCCUCON1_GTMDIV_LEN (4u)

/** \brief Mask for Ifx_CLOCK_SYSCCUCON1_Bits.GTMDIV */
#define IFX_CLOCK_SYSCCUCON1_GTMDIV_MSK (0xfu)

/** \brief Offset for Ifx_CLOCK_SYSCCUCON1_Bits.GTMDIV */
#define IFX_CLOCK_SYSCCUCON1_GTMDIV_OFF (8u)
...
/** \brief Length for Ifx_CLOCK_PERCCUCON1_Bits.CLKSELADC */
#define IFX_CLOCK_PERCCUCON1_CLKSELADC_LEN (2u)

/** \brief Mask for Ifx_CLOCK_PERCCUCON1_Bits.CLKSELADC */
#define IFX_CLOCK_PERCCUCON1_CLKSELADC_MSK (0x3u)

/** \brief Offset for Ifx_CLOCK_PERCCUCON1_Bits.CLKSELADC */
#define IFX_CLOCK_PERCCUCON1_CLKSELADC_OFF (20u)
...
/** \brief Length for Ifx_CLOCK_RAMPMON_Bits.FLLLDTST */
#define IFX_CLOCK_RAMPMON_FLLLDTST_LEN (1u)

/** \brief Mask for Ifx_CLOCK_RAMPMON_Bits.FLLLDTST */
#define IFX_CLOCK_RAMPMON_FLLLDTST_MSK (0x1u)

/** \brief Offset for Ifx_CLOCK_RAMPMON_Bits.FLLLDTST */
#define IFX_CLOCK_RAMPMON_FLLLDTST_OFF (29u)
