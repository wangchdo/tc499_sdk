...
/** \brief SMU FSP partitions register */
typedef struct _Ifx_WTU_SMUFSP_Bits
{
    __IO Ifx_UReg_32Bit PART0:1;           /**< \brief [0:0] Consider signals from SMU FSP partition 0 (rw) */
    __IO Ifx_UReg_32Bit PART1:1;           /**< \brief [1:1] Consider signals from SMU FSP partition 1 (rw) */
    __IO Ifx_UReg_32Bit PART2:1;           /**< \brief [2:2] Consider signals from SMU FSP partition 2 (rw) */
    __IO Ifx_UReg_32Bit PART3:1;           /**< \brief [3:3] Consider signals from SMU FSP partition 3 (rw) */
...
typedef struct _Ifx_WTU_STAT_Bits
{
    ...
    __I  Ifx_UReg_32Bit TO:1;              /**< \brief [1:1] Watchdog Time-Out Mode Flag - TO (rh) */
    ...
    __I  Ifx_UReg_32Bit IFS:2;             /**< \brief [5:4] Watchdog Internal Frequency Selection Statu Flag - IFS (rh) */
...
{
       __IO Ifx_WTU_ACCEN_WRA_CS                WRA;                    /**< \brief 0, CPU0 WDT write access enable register A*/
       ...
       __I  Ifx_WTU_ACCEN_RDB_NONE              RDB;                    /**< \brief C, CPU0 WDT read access enable register B*/
...
typedef volatile struct _Ifx_WTU_WDTCPU
{
       ...
       __IO Ifx_WTU_SMUFSP                      SMUFSP;                 /**< \brief 20, CPU0 WDT SMU FSP partitions register*/
...
typedef volatile struct _Ifx_WTU_WDTSEC_ACCEN
{
       ...
       __I  Ifx_WTU_ACCEN_RDB_NONE              RDB;                    /**< \brief C, Security WDT read access enable register B*/
...
typedef volatile struct _Ifx_WTU_WDTSEC
{
       ...
       __I  Ifx_UReg_8Bit                       reserved_1C[4];         /**< \brief 1C, \internal Reserved */
       __IO Ifx_WTU_SMUFSP                      SMUFSP;                 /**< \brief 20, Security WDT SMU FSP partitions register*/
...
typedef volatile struct _Ifx_WTU_WDTSYS
{
       ...
       __I  Ifx_UReg_8Bit                       reserved_1C[4];         /**< \brief 1C, \internal Reserved */
       __IO Ifx_WTU_SMUFSP                      SMUFSP;                 /**< \brief 20, System WDT SMU FSP partitions register*/
