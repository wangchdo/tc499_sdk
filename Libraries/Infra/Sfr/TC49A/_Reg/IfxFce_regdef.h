...
{
    __IO Ifx_UReg_32Bit CMF:1;             /**< \brief [0:0] CRC Mismatch Flag - CMF (rwh) */
    __IO Ifx_UReg_32Bit CEF:1;             /**< \brief [1:1] Configuration Error Flag - CEF (rwh) */
    __IO Ifx_UReg_32Bit LEF:1;             /**< \brief [2:2] Length Error Flag - LEF (rwh) */
    __IO Ifx_UReg_32Bit BEF:1;             /**< \brief [3:3] Bus Error Flag - BEF (rwh) */
    __I  Ifx_UReg_32Bit :28;               /**< \brief [31:4] \internal Reserved */
} Ifx_FCE_IN_STS_Bits;
...
{
       __IO Ifx_FCE_ACCEN_WRA                   WRA;                    /**< \brief 0, Write access enable register A*/
       __IO Ifx_FCE_ACCEN_WRB_FPI               WRB;                    /**< \brief 4, Write access enable register B*/
       __IO Ifx_FCE_ACCEN_RDA                   RDA;                    /**< \brief 8, Read access enable register A*/
       __IO Ifx_FCE_ACCEN_RDB_FPI               RDB;                    /**< \brief C, Read access enable register B*/
       __IO Ifx_FCE_ACCEN_VM                    VM;                     /**< \brief 10, VM access enable register*/
       __IO Ifx_FCE_ACCEN_PRS                   PRS;                    /**< \brief 14, PRS access enable register*/
...
typedef volatile struct _Ifx_FCE_IN
{
       ...
       __IO Ifx_FCE_IN_CRC                      CRC;                    /**< \brief 18, CRC Regsister 0*/
...
typedef volatile struct _Ifx_FCE
{
       ...
       __IO Ifx_FCE_ACCEN                       ACCEN;                  /**< \brief 40, */
       __I  Ifx_UReg_8Bit                       reserved_60[32];        /**< \brief 60, \internal Reserved */
       __I  Ifx_FCE_CHSTS                       CHSTS;                  /**< \brief 80, Channels Status Register*/
       __I  Ifx_UReg_8Bit                       reserved_84[124];       /**< \brief 84, \internal Reserved */
