...
/** \brief Length for Ifx_CPU_STM_ABS_Bits.ABS */
#define IFX_CPU_STM_ABS_ABS_LEN (64u)

/** \brief Mask for Ifx_CPU_STM_ABS_Bits.ABS */
#define IFX_CPU_STM_ABS_ABS_MSK (0xffffffffffffffffu)

/** \brief Offset for Ifx_CPU_STM_ABS_Bits.ABS */
#define IFX_CPU_STM_ABS_ABS_OFF (0u)
...
/** \brief Length for Ifx_CPU_TCCON_Bits.OVL */
#define IFX_CPU_TCCON_OVL_LEN (1u)

/** \brief Mask for Ifx_CPU_TCCON_Bits.OVL */
#define IFX_CPU_TCCON_OVL_MSK (0x1u)

/** \brief Offset for Ifx_CPU_TCCON_Bits.OVL */
#define IFX_CPU_TCCON_OVL_OFF (2u)
