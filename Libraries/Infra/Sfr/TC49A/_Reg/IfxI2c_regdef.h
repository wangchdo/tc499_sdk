...
typedef struct _Ifx_I2C_CLC1_Bits
{
    ...
    __IO Ifx_UReg_32Bit RESERVED:8;        /**< \brief [23:16] Reserved (rw) */
    __I  Ifx_UReg_32Bit :8;                /**< \brief [31:24] \internal Reserved */
} Ifx_I2C_CLC1_Bits;
...
typedef struct _Ifx_I2C_TIMCFG_Bits
{
    ...
    __IO Ifx_UReg_32Bit EN_SCL_LOW_LEN:1;    /**< \brief [14:14] Enable Direct Configuration of SCL Low Period Length in Fast Mode - EN_SCL_LOW_LEN (rw) */
...
typedef volatile struct _Ifx_I2C
{
       ...
       __O  Ifx_I2C_ISR                         ISR;                    /**< \brief 90, Interrupt Set Register*/
