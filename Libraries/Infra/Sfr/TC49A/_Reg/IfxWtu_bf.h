...
/** \brief Length for Ifx_WTU_STAT_Bits.TO */
#define IFX_WTU_STAT_TO_LEN (1u)

/** \brief Mask for Ifx_WTU_STAT_Bits.TO */
#define IFX_WTU_STAT_TO_MSK (0x1u)

/** \brief Offset for Ifx_WTU_STAT_Bits.TO */
#define IFX_WTU_STAT_TO_OFF (1u)
