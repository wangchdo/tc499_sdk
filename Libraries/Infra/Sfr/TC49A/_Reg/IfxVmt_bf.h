...
#define IFX_VMT_MC_ECCD_VAL_LEN (5u)

/** \brief Mask for Ifx_VMT_MC_ECCD_Bits.VAL */
#define IFX_VMT_MC_ECCD_VAL_MSK (0x1fu)

/** \brief Offset for Ifx_VMT_MC_ECCD_Bits.VAL */
#define IFX_VMT_MC_ECCD_VAL_OFF (5u)

/** \brief Length for Ifx_VMT_MC_ECCD_Bits.PERMERR */
#define IFX_VMT_MC_ECCD_PERMERR_LEN (5u)

/** \brief Mask for Ifx_VMT_MC_ECCD_Bits.PERMERR */
#define IFX_VMT_MC_ECCD_PERMERR_MSK (0x1fu)

/** \brief Offset for Ifx_VMT_MC_ECCD_Bits.PERMERR */
#define IFX_VMT_MC_ECCD_PERMERR_OFF (10u)

/** \brief Length for Ifx_VMT_MC_ECCD_Bits.EOV */
#define IFX_VMT_MC_ECCD_EOV_LEN (1u)

/** \brief Mask for Ifx_VMT_MC_ECCD_Bits.EOV */
#define IFX_VMT_MC_ECCD_EOV_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MC_ECCD_Bits.EOV */
#define IFX_VMT_MC_ECCD_EOV_OFF (15u)
...
/** \brief Length for Ifx_VMT_MC_ALMSRCS_Bits.OVFE */
#define IFX_VMT_MC_ALMSRCS_OVFE_LEN (1u)

/** \brief Mask for Ifx_VMT_MC_ALMSRCS_Bits.OVFE */
#define IFX_VMT_MC_ALMSRCS_OVFE_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MC_ALMSRCS_Bits.OVFE */
#define IFX_VMT_MC_ALMSRCS_OVFE_OFF (3u)
...
/** \brief Length for Ifx_VMT_MC_ERRINFO_Bits.SBERR */
#define IFX_VMT_MC_ERRINFO_SBERR_LEN (1u)

/** \brief Mask for Ifx_VMT_MC_ERRINFO_Bits.SBERR */
#define IFX_VMT_MC_ERRINFO_SBERR_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MC_ERRINFO_Bits.SBERR */
#define IFX_VMT_MC_ERRINFO_SBERR_OFF (0u)
...
/** \brief Length for Ifx_VMT_MC_ERRINFO_Bits.BLERR */
#define IFX_VMT_MC_ERRINFO_BLERR_LEN (1u)

/** \brief Mask for Ifx_VMT_MC_ERRINFO_Bits.BLERR */
#define IFX_VMT_MC_ERRINFO_BLERR_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MC_ERRINFO_Bits.BLERR */
#define IFX_VMT_MC_ERRINFO_BLERR_OFF (3u)
...
#define IFX_VMT_MCCS_ECCD_VAL_LEN (5u)

/** \brief Mask for Ifx_VMT_MCCS_ECCD_Bits.VAL */
#define IFX_VMT_MCCS_ECCD_VAL_MSK (0x1fu)

/** \brief Offset for Ifx_VMT_MCCS_ECCD_Bits.VAL */
#define IFX_VMT_MCCS_ECCD_VAL_OFF (5u)

/** \brief Length for Ifx_VMT_MCCS_ECCD_Bits.PERMERR */
#define IFX_VMT_MCCS_ECCD_PERMERR_LEN (5u)

/** \brief Mask for Ifx_VMT_MCCS_ECCD_Bits.PERMERR */
#define IFX_VMT_MCCS_ECCD_PERMERR_MSK (0x1fu)

/** \brief Offset for Ifx_VMT_MCCS_ECCD_Bits.PERMERR */
#define IFX_VMT_MCCS_ECCD_PERMERR_OFF (10u)

/** \brief Length for Ifx_VMT_MCCS_ECCD_Bits.EOV */
#define IFX_VMT_MCCS_ECCD_EOV_LEN (1u)

/** \brief Mask for Ifx_VMT_MCCS_ECCD_Bits.EOV */
#define IFX_VMT_MCCS_ECCD_EOV_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MCCS_ECCD_Bits.EOV */
#define IFX_VMT_MCCS_ECCD_EOV_OFF (15u)
...
/** \brief Length for Ifx_VMT_MCCS_ALMSRCS_Bits.OVFE */
#define IFX_VMT_MCCS_ALMSRCS_OVFE_LEN (1u)

/** \brief Mask for Ifx_VMT_MCCS_ALMSRCS_Bits.OVFE */
#define IFX_VMT_MCCS_ALMSRCS_OVFE_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MCCS_ALMSRCS_Bits.OVFE */
#define IFX_VMT_MCCS_ALMSRCS_OVFE_OFF (3u)
...
/** \brief Length for Ifx_VMT_MCCS_ERRINFO_Bits.SBERR */
#define IFX_VMT_MCCS_ERRINFO_SBERR_LEN (1u)

/** \brief Mask for Ifx_VMT_MCCS_ERRINFO_Bits.SBERR */
#define IFX_VMT_MCCS_ERRINFO_SBERR_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MCCS_ERRINFO_Bits.SBERR */
#define IFX_VMT_MCCS_ERRINFO_SBERR_OFF (0u)
...
/** \brief Length for Ifx_VMT_MCCS_ERRINFO_Bits.BLERR */
#define IFX_VMT_MCCS_ERRINFO_BLERR_LEN (1u)

/** \brief Mask for Ifx_VMT_MCCS_ERRINFO_Bits.BLERR */
#define IFX_VMT_MCCS_ERRINFO_BLERR_MSK (0x1u)

/** \brief Offset for Ifx_VMT_MCCS_ERRINFO_Bits.BLERR */
#define IFX_VMT_MCCS_ERRINFO_BLERR_OFF (3u)
