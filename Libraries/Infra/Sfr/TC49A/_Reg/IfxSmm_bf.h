 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_SMM/V0.1.1.1.9
 * Specification: latest @ 2021-10-12 instance sheet @ MC_A3G_TC49x : V9.1.6.2.0 
...
/** \brief Length for Ifx_SMM_PMSTAT0_Bits.CSRMLS */
#define IFX_SMM_PMSTAT0_CSRMLS_LEN (1u)

/** \brief Mask for Ifx_SMM_PMSTAT0_Bits.CSRMLS */
#define IFX_SMM_PMSTAT0_CSRMLS_MSK (0x1u)

/** \brief Offset for Ifx_SMM_PMSTAT0_Bits.CSRMLS */
#define IFX_SMM_PMSTAT0_CSRMLS_OFF (22u)
...
/** \brief Length for Ifx_SMM_STCON_Bits.PINIT_DONE */
#define IFX_SMM_STCON_PINIT_DONE_LEN (1u)

/** \brief Mask for Ifx_SMM_STCON_Bits.PINIT_DONE */
#define IFX_SMM_STCON_PINIT_DONE_MSK (0x1u)

/** \brief Offset for Ifx_SMM_STCON_Bits.PINIT_DONE */
#define IFX_SMM_STCON_PINIT_DONE_OFF (16u)
...
/** \brief Length for Ifx_SMM_STMEM1_Bits.BCP */
#define IFX_SMM_STMEM1_BCP_LEN (1u)

/** \brief Mask for Ifx_SMM_STMEM1_Bits.BCP */
#define IFX_SMM_STMEM1_BCP_MSK (0x1u)

/** \brief Offset for Ifx_SMM_STMEM1_Bits.BCP */
#define IFX_SMM_STMEM1_BCP_OFF (10u)
...
#define IFX_SMM_STMEM1_SIDX_LEN (5u)

/** \brief Mask for Ifx_SMM_STMEM1_Bits.SIDX */
#define IFX_SMM_STMEM1_SIDX_MSK (0x1fu)
...
/** \brief Length for Ifx_SMM_STMEM1_Bits.QM */
#define IFX_SMM_STMEM1_QM_LEN (1u)

/** \brief Mask for Ifx_SMM_STMEM1_Bits.QM */
#define IFX_SMM_STMEM1_QM_MSK (0x1u)

/** \brief Offset for Ifx_SMM_STMEM1_Bits.QM */
#define IFX_SMM_STMEM1_QM_OFF (31u)
...
/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.LVDBFW */
#define IFX_SMM_RSTSTATBFW_LVDBFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.LVDBFW */
#define IFX_SMM_RSTSTATBFW_LVDBFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.LVDBFW */
#define IFX_SMM_RSTSTATBFW_LVDBFW_OFF (0u)

/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.CLDPORBFW */
#define IFX_SMM_RSTSTATBFW_CLDPORBFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.CLDPORBFW */
#define IFX_SMM_RSTSTATBFW_CLDPORBFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.CLDPORBFW */
#define IFX_SMM_RSTSTATBFW_CLDPORBFW_OFF (1u)

/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.PDCLDBFW */
#define IFX_SMM_RSTSTATBFW_PDCLDBFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.PDCLDBFW */
#define IFX_SMM_RSTSTATBFW_PDCLDBFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.PDCLDBFW */
#define IFX_SMM_RSTSTATBFW_PDCLDBFW_OFF (2u)

/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.PORSTBFW */
#define IFX_SMM_RSTSTATBFW_PORSTBFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.PORSTBFW */
#define IFX_SMM_RSTSTATBFW_PORSTBFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.PORSTBFW */
#define IFX_SMM_RSTSTATBFW_PORSTBFW_OFF (3u)

/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.SYSRSTBFW */
#define IFX_SMM_RSTSTATBFW_SYSRSTBFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.SYSRSTBFW */
#define IFX_SMM_RSTSTATBFW_SYSRSTBFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.SYSRSTBFW */
#define IFX_SMM_RSTSTATBFW_SYSRSTBFW_OFF (4u)

/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.APPRSTBFW */
#define IFX_SMM_RSTSTATBFW_APPRSTBFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.APPRSTBFW */
#define IFX_SMM_RSTSTATBFW_APPRSTBFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.APPRSTBFW */
#define IFX_SMM_RSTSTATBFW_APPRSTBFW_OFF (5u)

/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.LBTRIGFW */
#define IFX_SMM_RSTSTATBFW_LBTRIGFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.LBTRIGFW */
#define IFX_SMM_RSTSTATBFW_LBTRIGFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.LBTRIGFW */
#define IFX_SMM_RSTSTATBFW_LBTRIGFW_OFF (8u)

/** \brief Length for Ifx_SMM_RSTSTATBFW_Bits.LBTERMFW */
#define IFX_SMM_RSTSTATBFW_LBTERMFW_LEN (1u)

/** \brief Mask for Ifx_SMM_RSTSTATBFW_Bits.LBTERMFW */
#define IFX_SMM_RSTSTATBFW_LBTERMFW_MSK (0x1u)

/** \brief Offset for Ifx_SMM_RSTSTATBFW_Bits.LBTERMFW */
#define IFX_SMM_RSTSTATBFW_LBTERMFW_OFF (9u)

/** \brief Length for Ifx_SMM_SHSEQCTRLA_Bits.FRTO */
#define IFX_SMM_SHSEQCTRLA_FRTO_LEN (1u)

/** \brief Mask for Ifx_SMM_SHSEQCTRLA_Bits.FRTO */
#define IFX_SMM_SHSEQCTRLA_FRTO_MSK (0x1u)

/** \brief Offset for Ifx_SMM_SHSEQCTRLA_Bits.FRTO */
#define IFX_SMM_SHSEQCTRLA_FRTO_OFF (0u)
...
/** \brief Length for Ifx_SMM_RSTTRIGCTRLA_Bits.SMUSEC */
#define IFX_SMM_RSTTRIGCTRLA_SMUSEC_LEN (3u)

/** \brief Mask for Ifx_SMM_RSTTRIGCTRLA_Bits.SMUSEC */
#define IFX_SMM_RSTTRIGCTRLA_SMUSEC_MSK (0x7u)

/** \brief Offset for Ifx_SMM_RSTTRIGCTRLA_Bits.SMUSEC */
#define IFX_SMM_RSTTRIGCTRLA_SMUSEC_OFF (21u)
...
/** \brief Length for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE0AR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE0AR_LEN (3u)

/** \brief Mask for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE0AR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE0AR_MSK (0x7u)

/** \brief Offset for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE0AR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE0AR_OFF (18u)

/** \brief Length for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE0SR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE0SR_LEN (3u)

/** \brief Mask for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE0SR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE0SR_MSK (0x7u)

/** \brief Offset for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE0SR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE0SR_OFF (21u)

/** \brief Length for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE1AR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE1AR_LEN (3u)

/** \brief Mask for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE1AR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE1AR_MSK (0x7u)

/** \brief Offset for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE1AR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE1AR_OFF (24u)

/** \brief Length for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE1SR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE1SR_LEN (3u)

/** \brief Mask for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE1SR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE1SR_MSK (0x7u)

/** \brief Offset for Ifx_SMM_RSTTRIGCTRLB_Bits.SMUSAFE1SR */
#define IFX_SMM_RSTTRIGCTRLB_SMUSAFE1SR_OFF (27u)
